...
MAX_PLAYER_LEVEL_TABLE[LE_EXPANSION_7_0] = 110;

NPE_TUTORIAL_COMPLETE_LEVEL = 10;

-- TODO_MT:  We'll want the server to tell us this.
MAX_PRESTIGE = 4;
...
QUEST_TAG_WORLD_QUEST = 109;
QUEST_TAG_RARE_WORLD_QUEST = 110;
QUEST_TAG_ELITE_WORLD_QUEST = 111;
QUEST_TAG_RARE_ELITE_WORLD_QUEST = 112;
QUEST_TAG_PVP_WORLD_QUEST = 113;
QUEST_TAG_TRADESKILL_WORLD_QUEST = 114;
