...
EXPANSION_LEVEL_BURNING_CRUSADE = 1;
EXPANSION_LEVEL_WRATH_OF_THE_LICH_KING = 2;
EXPANSION_LEVEL_CATACLYSM = 3;
EXPANSION_LEVEL_MISTS_OF_PANDARIA = 4;
EXPANSION_LEVEL_WARLORDS_OF_DRAENOR = 5;
