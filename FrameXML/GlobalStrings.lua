...
ERR_MATCHMAKING_PARTY_KICKED_FROM_QUEUE = "Party member removed from group - party removed from the matchmaking system.";
...
INSTANCE_UNAVAILABLE_OTHER_EXPANSION_TOO_LOW = "%s does not have a recent enough expansion.";
...
INSTANCE_UNAVAILABLE_OTHER_OTHER = "%s does not meet the requirements for this instance.";
INSTANCE_UNAVAILABLE_OTHER_RAID_LOCKED = "%s is already locked to this instance.";
INSTANCE_UNAVAILABLE_SELF_EXPANSION_TOO_LOW = "You do not have a recent enough expansion.";
...
INSTANCE_UNAVAILABLE_SELF_OTHER = "You do not meet the requirements for this instance.";
...
LFD_RANDOM_EXPLANATION = "Using the Dungeons panel to do a Random Dungeon will earn you extra rewards.";
LFD_RANDOM_REWARD_EXPLANATION1 = "The first random dungeon that you complete each day will earn you:";
LFD_RANDOM_REWARD_PUG_EXPLANATION = "For every random player included in your group, you will get:";
LFD_REWARDS = "Rewards";
...
OPTION_TOOLTIP_UNIT_NAMEPLATES_SHOW_ENEMY_TOTEMS = "Turn this on to display Unit Nameplates for enemy totems (friendly totems are never shown).";
...
TUTORIAL3 = "You can look around by clicking the Left Mouse Button and moving the mouse. You can turn your character by clicking the Right Mouse Button and moving the mouse.";
...
TUTORIAL9 = "Some items can be used. Right Click on an item to use it. You can drag items onto your action bar if you want to use it without opening your backpack.";
...
TUTORIAL12 = "You can drink to regain your mana faster. Right Click on a beverage to drink it.";
...
TUTORIAL_TITLE55 = "[Temp] GRATZ!  You leveled for the first time!";
TUTORIAL_TITLE56 = "Health and Mana Bars";
TUTORIAL_TITLE57 = "Enemy Health Bars";
