...
BATTLENET_FRIEND_INFO = "This is a person you know and trust in real life. You can chat with this person across World of Warcraft servers and across Blizzard games.";
BATTLENET_FRIEND_LABEL = "Enter email address";
BATTLENET_NAME_FORMAT = "%1$s %2$s";
BATTLENET_OPTIONS_LABEL = "Battle.net";
BATTLENET_OPTIONS_SUBTEXT = "[PH]Battle.net options";
BATTLENET_UNAVAILABLE = "Battle.net is unavailable";
BATTLENET_UNAVAILABLE_ALERT = "The Battle.net service is currently unavailable.|n|nYour Real ID friends will not show up. You will also not be able to send or receive new Real ID friend requests.";
...
BLOCK_COMMUNICATION_CONFIRMATION = "Are you sure you want to block any further communication from %s?";
...
BN_INLINE_TOAST_BROADCAST_INFORM = "\124TInterface\\FriendsFrame\\UI-Toast-ToastIcons.tga:16:16:0:0:128:64:2:29:2:29\124tYour broadcast has been set to: %s";
...
BN_TOAST_OLD_INVITES = "You have |cff82c5ff%d|r friend |4request:requests;.";
...
CHAT_WHOLE_WINDOW_CLICKABLE = "Click Window For Focus";
...
OPTION_CONVERSATION_MODE_INLINE = "Real ID Conversations will be displayed similarly to channels. They may be popped-out into their own window by right-clicking on the Conversation name in chat.";
...
OPTION_TOOLTIP_SHOW_TOAST_FRIEND_REQUEST = "Displays a Battle.net message when you receive a new Real ID friend request.";
...
SHOW_TOAST_FRIEND_REQUEST_TEXT = "New Real ID Friend Requests";
...
SPELL_FAILED_CURRENCY_WEIGHT_NOT_ENOUGH = "You don't have enough pieces to solve this puzzle";
...
SPELL_FAILED_CUSTOM_ERROR_89 = "You have already defeated enough Oomlot Warriors.";
