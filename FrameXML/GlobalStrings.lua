...
BLIZZARD_STORE_LICENSE_ACK_TEXT_ARS = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase.  <<Placeholder ARS TOU link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_AUD = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase. <<Placeholder AUD TOU Link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_BRL = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase. <<Placeholder BRL TOU Link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_CLP = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase.  <<Placeholder CLP TOU link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_CN = "You are purchasing the virtual items with Battle Coins. Your Battle Coins will be deducted immediately by clicking the \"Buy Now\" button and won't be refunded under any circumstances. Are you sure you want to purchase this?";
BLIZZARD_STORE_LICENSE_ACK_TEXT_EUR = "User Acknowledgment:  By clicking the Pay Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase.  <<Placeholder Euro TOU link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_GBP = "User Acknowledgment:  By clicking the Pay Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase. <<Placeholder GBP TOU link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_MXN = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase.  <<Placeholder MXN TOU Link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_RUB = "User Acknowledgment:  By clicking the Pay Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase. <<Placeholder RUB TOU link>>";
BLIZZARD_STORE_LICENSE_ACK_TEXT_TW = "You are purchasing the virtual items with Balance. If you do not have enough Balance, please visit the Battle.net Account Management site. By clicking \"Buy Now\", you agree to the |HurlIndex:10|h|cff71d5ffTerms of Sale|r|h";
BLIZZARD_STORE_LICENSE_ACK_TEXT_USD = "User Acknowledgment:  By clicking the Buy Now button below, I acknowledge that I have read and agree to the terms and conditions regarding this transaction (including the Terms of Sale, Refund Policy, and Privacy Policy) and confirm this purchase.  <<Placeholder USD TOU link>>";
