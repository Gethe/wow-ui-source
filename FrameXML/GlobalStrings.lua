...
ACTION_SPELL_AURA_BROKEN_SPELL_BUFF_FULL_TEXT = "%1$s %5$ broke %4$s %2$s.";
...
CHI_COST_PER_TIME_NO_BASE = "%d Energy per sec";
CHI_POWER = "Chi";
...
LIGHT_FORCE_COST_PER_TIME_NO_BASE = "%d Chi per sec";
...
MONK_MIST_CORE_ABILITY_5 = "Use when you have 60 Energy to allow allies to heal themselves.";
...
POWER_GAINS_COMBATLOG_TOOLTIP = "Show messages when a spell or ability restores mana, energy, rage, or focus.";
