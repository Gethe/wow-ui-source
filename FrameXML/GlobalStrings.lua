...
ACHIEVEMENT_TOOLTIP_COMPLETE = "Achievement completed by %s on %d/%d/20%02d";
ACHIEVEMENT_TOOLTIP_IN_PROGRESS = "Achievement in progress by %s";
ACHIEVEMENT_UNLOCKED = "Achievement Unlocked";
ACHIEVEMENT_UNLOCKED_CHAT_MSG = "Achievement Unlocked: %s"; -- Chat message that shows up when you have over the max achievement toasts trying to display
...
ACTION_ENVIRONMENTAL_DAMAGE_LAVA_FULL_TEXT = "%4$s loses %9$s health from swimming in lava.";
...
ACTION_ENVIRONMENTAL_DAMAGE_SLIME_FULL_TEXT = "%4$s loses %9$s health for swimming in slime.";
...
ACTION_SPELL_AURA_APPLIED_BUFF_FULL_TEXT = "%4$s gains %2$s.";
...
ACTION_SPELL_AURA_APPLIED_DEBUFF_FULL_TEXT = "%4$s is afflicted by %2$s.";
...
ACTION_SPELL_AURA_APPLIED_DOSE_BUFF_FULL_TEXT = "%4$s gains %2$s (%9$s).";
ACTION_SPELL_AURA_APPLIED_DOSE_BUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_APPLIED_DOSE_DEBUFF = "afflicted";
ACTION_SPELL_AURA_APPLIED_DOSE_DEBUFF_FULL_TEXT = "%4$s is afflicted by %2$s (%9$s).";
...
ACTION_SPELL_AURA_BROKEN_SPELL_BUFF_FULL_TEXT = "%1$s %2$s was broken by %4$s %5$s.";
ACTION_SPELL_AURA_BROKEN_SPELL_BUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_BROKEN_SPELL_DEBUFF = "broke";
ACTION_SPELL_AURA_BROKEN_SPELL_DEBUFF_FULL_TEXT = "%1$s %2$s was broken by %4$s %5$s";
...
ACTION_SPELL_AURA_REMOVED_BUFF_FULL_TEXT = "%2$s fades from %4$s.";
ACTION_SPELL_AURA_REMOVED_BUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_REMOVED_DEBUFF = "dissipated";
ACTION_SPELL_AURA_REMOVED_DEBUFF_FULL_TEXT = "%2$s dissipates from %4$s.";
...
ACTION_SPELL_AURA_REMOVED_FULL_TEXT = "%2$s was removed from %4$s.";
ACTION_SPELL_AURA_REMOVED_POSSESSIVE = "1";
ACTION_SPELL_AURA_STOLEN = "stole";
ACTION_SPELL_AURA_STOLEN_BUFF = "stole";
ACTION_SPELL_AURA_STOLEN_BUFF_FULL_TEXT = "%1$s %2$s steals %4$s %5$s.";
ACTION_SPELL_AURA_STOLEN_BUFF_FULL_TEXT_NO_SOURCE = "%2$s steals %4$s %5$s.";
...
ACTION_SPELL_AURA_STOLEN_DEBUFF_FULL_TEXT = "%1$s %2$s transfers %4$s $extraSpell to %1$s.";
ACTION_SPELL_AURA_STOLEN_DEBUFF_FULL_TEXT_NO_SOURCE = "%2$s transfers %4$s $extraSpell.";
ACTION_SPELL_AURA_STOLEN_DEBUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_STOLEN_FULL_TEXT = "%1$s %2$s steals %4$s %5$s.";
ACTION_SPELL_AURA_STOLEN_FULL_TEXT_NO_SOURCE = "%2$s steals %4$s %5$s.";
...
ACTION_SPELL_LEECH_FULL_TEXT = "%1$s %2$s drains %9$s %8$s from %4$s. %1$s gains $extraAmount %8$s.";
ACTION_SPELL_LEECH_FULL_TEXT_NO_SOURCE = "%2$s drains %9$s %8$s from %4$s.";
ACTION_SPELL_LEECH_POSSESSIVE = "1";
ACTION_SPELL_LEECH_RESULT = "$extraAmount %8$s Gained";
...
ACTION_SPELL_PERIODIC_LEECH_FULL_TEXT = "%1$s %2$s drains %9$s %8$s from %4$s. %1$s gains $extraAmount %8$s.";
ACTION_SPELL_PERIODIC_LEECH_FULL_TEXT_NO_SOURCE = "%2$s drains %9$s %8$s from %4$s. %1$s gains $extraAmount %8$s.";
ACTION_SPELL_PERIODIC_LEECH_POSSESSIVE = "1";
ACTION_SPELL_PERIODIC_LEECH_RESULT = "($extraAmount %8$s Gained)";
...
BINDING_NAME_TOGGLECHARACTER4 = "Toggle Token Pane";
...
CALENDAR_ANNOUNCEMENT_DESCRIPTION = "Announcement description";
CALENDAR_ANNOUNCEMENT_NAME = "Announcement Name";
CALENDAR_AUTO_APPROVE = "Auto Approve Members";
CALENDAR_COPY_EVENT = "Copy Event";
...
CALENDAR_DUNGEON_PICKER_TITLE = "Select a Dungeon";
CALENDAR_EDIT_ANNOUNCEMENT = "Edit Announcement";
CALENDAR_EDIT_EVENT = "Edit Event";
CALENDAR_ERROR = "%s";
CALENDAR_ERROR_ALREADY_INVITED_TO_EVENT_S = "%s has already been invited."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_ARENA_EVENTS_EXCEEDED = "Your arena team has reached the limit of created events."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_CREATEDATE_AFTER_MAX = "You cannot create events after %2$s %3$d %4$d."; -- 1=weekdayName 2=monthName 3=day 4=year 5=month
CALENDAR_ERROR_CREATEDATE_BEFORE_TODAY = "You cannot create events before today."; -- 1=weekdayName 2=monthName 3=day 4=year 5=month
CALENDAR_ERROR_DATE_OUT_OF_RANGE = "You may only create events today through %1$s, %2$s %3$d %4$d."; -- 1=weekdayName 2=monthName 3=day 4=year 5=month
CALENDAR_ERROR_DELETE_CREATOR_FAILED = "You cannot remove the creator of the event."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_EVENTS_EXCEEDED = "You have reached your limit of created events."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_EVENT_INVALID = "Event not found."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_EVENT_LOCKED = "This event is locked!"; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_EVENT_PASSED = "This event has already occured."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
...
CALENDAR_ERROR_EVENT_TIME_PASSED = "The time for this event has already passed."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_INTERNAL = "Internal Calendar Error.";
CALENDAR_ERROR_INVALID_DATE = "Enter a valid date."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_INVALID_TIME = "Enter a valid time."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_INVITES_DISABLED = "You cannot invite players to this event."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_INVITES_EXCEEDED = "You cannot invite any more players to this event."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
...
CALENDAR_ERROR_NEEDS_TITLE = "Enter a title."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_NOT_ALLIED = "You cannot invite players from the opposing alliance.";
CALENDAR_ERROR_NOT_INVITED = "You are not invited to this event."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR_NO_INVITE = "Invite not found."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
...
CALENDAR_EVENTNAME_FORMAT_END = "%s - End"; -- %s = Event Name
CALENDAR_EVENTNAME_FORMAT_START = "%s - Start"; -- %s = Event Name
...
CALENDAR_PASTE_EVENT = "Paste Event";
...
CALENDAR_SET_INVITE_STATUS = "Set Invite Status";
...
CALENDAR_TOOLTIP_INVITE_TOTALS = "Confirmed/Accepted Invites";
...
EMPTY_SOCKET_NO_COLOR = "Colorless socket";
...
FEAT_OF_STRENGTH_DESCRIPTION = "A feat of Strength is an accomplishment that players will find either very difficult if not impossible to earn.  Worth no points, Feats of Strength are a collection of past glories on Azeroth.";
...
LATEST_UPDATED_STATS = "Latest Updated Stats"; -- Title for the summary page of the achievement frame
LAUGH_WORD1 = "lol";
LAUGH_WORD2 = "rofl";
LAUGH_WORD3 = "hehe";
LAUGH_WORD4 = "haha";
...
NO_BIDS = "No Bids";
NO_COMPLETED_ACHIEVEMENTS = "You have not completed any achievements recently";
...
OPTION_TOOLTIP_AUTO_LOOT_DEFAULT = "Sets Auto Looting as the default action when clicking on a lootable things. (Looting when this is checked, or Auto Looting when it is not, is performed by holding the Loot Key / Auto Loot Key)";
...
SPELL_FAILED_CUSTOM_ERROR_25 = "Requires the magmawyrm resurrection chamber in the back of the Neltharion's Maw.";
...
SPELL_FAILED_CUSTOM_ERROR_9 = "You cannot summon another ghoul yet."; -- Fires whenever the player has the summoned ghoul debuff on.
...
SPELL_FAILED_INVALID_GLYPH = "Glyph cannot go into that socket.";
...
SPELL_FAILED_UNIQUE_GLYPH = "Glyph already in use: %d";
...
TOGGLEINSCRIPTION = "Toggle Spell Glyphs";
...
TOKENS = "Tokens";
TOKEN_MOVE_TO_UNUSED = "Moves this token to the bottom of your list under the unused heading. Useful for tokens you are no longer interested in tracking.";
TOKEN_OPTIONS = "Token Options";
TOKEN_SHOW_ON_BACKPACK = "Checking this option will allow you to track this token type on your backpack.\n\nYou can also Shift-click a token to add or remove it from your backpack.";
...
TOO_MANY_WATCHED_TOKENS = "You may only watch %d tokens at a time";
