...
BOOST2_HUNTERBEAST_MULTISHOT = "Use |cFFFFFFFFMulti-Shot|r to deal AoE damage and cause your pet to Cleave.";
...
BOOST2_ROGUEASSN_GARROTE = "Use |cFFFFFFFFGarrote|r from stealth on the target dummy.|cFFFFFFFFMutilate|r generates 1 |cFFFFFFFFcombo point|r.";
...
EJ_ITEM_SETS = "Item Sets";
EJ_LEGENDARIES = "Legendaries";
ELITE = "Elite";
