...
ENCOUNTER_JOURNAL_SECTION_FLAG13 = "Mythic Difficulty";
...
ITEM_MOD_CR_UNUSED_9_SHORT = "Unused 9";
...
PVP_ITEM_LEVEL_TOOLTIP = "This item has an item level of %d in PvP combat";
