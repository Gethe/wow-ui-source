...
BURNING_EMBERS_COST = "%d Burning Embers";
BURNING_EMBERS_COST_PER_TIME = "%d Burning Embers, plus %d per sec";
BURNING_EMBERS_TOOLTIP = "Generated by casting Incinerate on an Immolated target, Burning Embers can be consumed to deal an extra powerful Soul Fire.\nYou take 1% of your maximum health every 3 seconds for each full Burning Ember you hold.";
...
DEMONIC_FURY_TOOLTIP = "Your basic damaging spells and pet abilities generate Demonic Fury. You can transform into a Demon at will, but all abilities used consume Demonic Fury.";
DEMOTE = "Demote";
DEPOSIT = "Deposit";
...
HELPFRAME_SUBMIT_SUGGESTION_LEGAL = "By clicking |cffffd200Submit|r, you confirm that this is your own idea, and that it is not confidential. By submitting this suggestion, you permit Blizzard Entertainment to use this idea publicly with no obligation to compensate you.";
...
MANA_COST_LARGE_PER_TIME = "%d Mana, plus %d per sec";
...
POWER_TYPE_DEMONIC_ENERGY = "Demonic Fury";
...
SHADOW_ORBS_COST = "%d Shadow Orbs";
SHADOW_ORBS_COST_PER_TIME = "%d Shadow Orbs, plus %d per sec";
SHADOW_ORBS_TOOLTIP = "Used to cast Mind Blast.";
...
STAT_HIT_MELEE_TOOLTIP = "Hit rating %s (+%.2f%% hit chance)";
STAT_HIT_NORMAL_ATTACKS = "Normal Attacks";
STAT_HIT_RANGED_TOOLTIP = "Hit rating %s (+%.2f%% hit chance)";
STAT_HIT_SPECIAL_ATTACKS = "Special Attacks";
STAT_HIT_SPELL_TOOLTIP = "Hit rating %s (+%.2f%% hit chance)";
...
TALENT_MICRO_BUTTON_TUTORIAL = "You can now pick a class specialization. Click here to choose your specialization.";
