...
BINDING_NAME_TOGGLEINSCRIPTION = "Toggle Spell Glyphs";
...
FLOOR = "Floor"; -- Dungeon Map Level
FLOOR_NUMBER = "Floor %d"; -- Dungeon Map Level
...
INSTANCE_LOCK_TIMER = "You have entered an instance that you will be locked to in %d %s.";
...
OBJECTIVES_IGNORE_CURSOR_TEXT = "Ignore Mouse Input";
...
OPTION_TOOLTIP_FARCLIP = "Changes how far you can see. Decrease to improve performance.";
...
OPTION_TOOLTIP_PARTICLE_DENSITY = "Controls the number of particles used in effects caused by spells, fires, ect. Decrease to improve performance.";
...
OPTION_TOOLTIP_PLAYER_DETAIL = "Controls the resolution of player textures.  Decrease to improve performance.";
OPTION_TOOLTIP_PREVIEW_TALENT_CHANGES = "If enabled, you will be able to change talents in the Talent Interface before spending your talent points.";
OPTION_TOOLTIP_PROFANITY_FILTER = "Enable mature language filtering.";
OPTION_TOOLTIP_PROJECTED_TEXTURES = "Enables the projecting of textures to the environment. Disable this to improve performance.";
...
OPTION_TOOLTIP_TRIPLE_BUFFER = "Enables triple buffering of frames when vertical sync is enabled. Selecting triple buffering may improve your framerate.";
...
OPTION_TOOLTIP_USE_EQUIPMENT_MANAGER = "Enables access to the Equipment Manager interface from the character frame.";
...
REFUND_TIME_REMAINING = "Sell this item to a vendor within %s for a full refund"; -- Time remaining to get a refund on an item. Example: "Sell this item to a vendor within 1 hour 30 minutes for a full refund."
RELICSLOT = "Relic";
REMOVE = "Remove";
