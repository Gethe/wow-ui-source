...
BLIZZARD_STORE_CONNECTING = "Connecting to Store";
...
COMBAT_LABEL = "Combat|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SHOW_TARGET_CASTBAR_IN_V_KEY = "On Nameplates|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
