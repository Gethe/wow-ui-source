...
CAPACITANCE_SHIPMENT_READY = "Shipment ready for pickup!";
...
DEATH_RECAP_LINK = "|cff71d5ff|Hdeath:%i|h[%s %s.]|h";
DEATH_RECAP_TEXT = "|cffffffff%s %s.";
...
DUNGEON_FLOOR_FROSTFIRERIDGE1 = "Bladespire Fortress";
...
ERR_PETITION_RESTRICTED_TRIAL = "Starter Edition accounts may not sign guild charters. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
ERR_PETITION_RESTRICTED_VETERAN = "Veteran Edition accounts may not sign guild charters. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
GARRISON_MISSION_AVAILABILITY = "Mission Availability";
...
GARRISON_SHIPMENT_IN_PROGRESS = "Shipment In-Progress";
...
HEIRLOOMS_CATEGORY_TRINKETS_AND_RINGS = "Trinkets & Rings";
...
HEIRLOOMS_JOURNAL_TUTORIAL_UPGRADE = "This is the max level of the heirloom. You can raise this level by upgrading the heirloom using special tokens.";
...
SPELL_FAILED_CUSTOM_ERROR_257 = "Can't place trap near existing trap.";
...
SPELL_FAILED_SHIPMENTS_FULL = "Can't create any more shipments of that type.";
...
TOGGLECOLLECTIONSHEIRLOOM = "Toggle Heirlooms Journal";
...
VIDEO_OPTIONS_HBAO = "nVidia HBAO+";
