...
ADVANCED_WORLD_MAP_TEXT = "Movable World Map|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
AFK = "AFK";
...
ERR_PARTY_LFG_BOOT_COOLDOWN = "You must wait before initiating another player kick.";
...
ERR_PARTY_LFG_BOOT_NOT_ELIGIBLE = "That player can not be kicked yet.";
...
ERR_TOO_FAR_TO_INTERACT = "You need to be closer to that character to interact with it";
...
LFG_STATISTIC_AVERAGE_WAIT = "The average wait time for %1$s is:\n%2$s";
...
VOLUME = "Volume";
VOTE_BOOT_PLAYER = "A vote has been initiated to remove %1$s from the group. Do you want to kick %1$s?";
