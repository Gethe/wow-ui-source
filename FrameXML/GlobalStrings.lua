...
ACTION_ENCHANT_REMOVED_FULL_TEXT = "$extraSpell fades from $dest $item.";
...
ACTION_SPELL_CAST_FAILED_FULL_TEXT = "$source $spell failed to cast.$result";
...
ACTION_SPELL_PERIODIC_MISSED = "misses";
...
BG_ALLIANCE = "Battleground Alliance";
BG_HORDE = "Battleground Horde";
BG_NEUTRAL = "Battleground Neutral";
BID = "Bid";
BIDS = "Bids";
...
COMBATLOG_FILTER_FRIENDLY_UNITS = "Friends";
COMBATLOG_FILTER_HOSTILE_UNITS = "Enemies";
COMBATLOG_FILTER_ME = "Me";
COMBATLOG_FILTER_MY_PET = "Pet";
COMBATLOG_FILTER_NEUTRAL_UNITS = "Neutral";
COMBATLOG_FILTER_UNKNOWN_UNITS = "Unknown";
COMBATLOG_HIGHLIGHT_ABILITY = "Ability Highlighting";
COMBATLOG_HIGHLIGHT_DAMAGE = "Damage Highlighting";
COMBATLOG_HIGHLIGHT_LINE = "Line Highlighting";
COMBATLOG_HIGHLIGHT_SCHOOL = "School Highlighting";
...
COMBAT_LOG_MENU_SPELL_HIDE = "Hide messages like this one. [%s]";
...
DAILY = "Daily";
DAILY_QUESTS_REMAINING = "You can only complete %d more daily quests today."; -- Appears in chat for daily reset quests
...
ERR_GUILD_ENTER_NAME = "Please enter a name.";
...
ERR_GUILD_NAME_INVALID_SPACE = "Names cannot start or end with a space.  Enter a new name.";
...
ERR_GUILD_NAME_NAME_RUSSIAN_CONSECUTIVE_SILENT_CHARACTERS = "Consecutive silent characters are not allowed. Create a new name."; -- This error only displays in Russian, so the english version doesn't matter. RUSSION LOCALIZATION - should rewrite as appropriate
ERR_GUILD_NAME_NAME_RUSSIAN_SILENT_CHARACTER_AT_BEGINNING_OR_END = "Silent characters are now allowed at the beginning or end of a name. Create a new name."; -- This error only displays in Russian, so the english version doesn't matter. RUSSION LOCALIZATION - should rewrite as appropriate
ERR_GUILD_NAME_PROFANE = "That name contains mature language.  Enter a new name.";
...
ERR_GUILD_WITHDRAW_LIMIT = "You have withdrawn too much today";
...
ERR_INVITE_RESTRICTED = "Trial accounts cannot invite high level characters into groups.";
...
FACTION_STANDING_INCREASED_BONUS = "Reputation with %s increased by %d. (+%.1f Bonus)";
...
FILTER = "Filter";
FILTERS = "Filters";
FILTER_BY_ENEMIES_COMBATLOG_TOOLTIP = "Actions performed by hostile players, pets, and creatures.";
...
FILTER_TO_HOSTILE_COMBATLOG_TOOLTIP = "Actions performed on hostile players, pets, and creatures.";
...
FILTER_TO_UNKNOWN_COMBATLOG_TOOLTIP = "Actions perfomed on invisible targets";
...
FORMATED_HOURS = "%d Hour";
FORMATED_HOURS_P1 = "%d Hours";
...
HIGHLIGHT_LINE_COMBATLOG_TOOLTIP = "";
...
ICON_TAG_RAID_TARGET_CIRCLE = "rt2"; -- Shortcut icon tag for Raid Target 2 (Circle)
ICON_TAG_RAID_TARGET_CROSS = "rt7"; -- Shortcut icon tag for Raid Target 7 (cross)
ICON_TAG_RAID_TARGET_DIAMOND = "rt3"; -- Shortcut icon tag for Raid Target 3 (Diamond)
ICON_TAG_RAID_TARGET_MOON = "rt5"; -- Shortcut icon tag for Raid Target 5 (Moon)
ICON_TAG_RAID_TARGET_SKULL = "rt8"; -- Shortcut icon tag for Raid Target 8 (Skull)
ICON_TAG_RAID_TARGET_SQUARE = "rt6"; -- Shortcut icon tag for Raid Target 6 (Square)
ICON_TAG_RAID_TARGET_STAR = "rt1"; -- Shortcut icon tag for Raid Target 1 (Star)
ICON_TAG_RAID_TARGET_TRIANGLE = "rt4"; -- Shortcut icon tag for Raid Target 4 (Triangle)
ID = "ID";
...
INT_GENERAL_DURATION_DAYS_P1 = "%d days";
INT_GENERAL_DURATION_HOURS = "%d hour";
INT_GENERAL_DURATION_HOURS_P1 = "%d hours";
INT_GENERAL_DURATION_MIN = "%d minute";
INT_GENERAL_DURATION_MIN_P1 = "%d minutes";
INT_GENERAL_DURATION_SEC = "%d second";
INT_GENERAL_DURATION_SEC_P1 = "%d seconds";
...
ITEM_COOLDOWN_TOTAL_DAYS = "(%d Day Cooldown)";
ITEM_COOLDOWN_TOTAL_DAYS_P1 = "(%d Days Cooldown)";
ITEM_COOLDOWN_TOTAL_HOURS = "(%d Hour Cooldown)";
ITEM_COOLDOWN_TOTAL_HOURS_P1 = "(%d Hours Cooldown)";
...
NUM_FREE_SLOTS = "%d Empty Slots (Total)";
...
ONE_DAILY_QUEST_REMAINING = "You can only complete one more daily quest today."; -- Same as DAILY_QUESTS_REMAINING, used when only one remains
...
SHOW_ENEMY_CAST = "Enemy Cast Bars"; -- Label for the group of UI options related to showing the Enemy Cast Bars
...
SHOW_TARGET_CASTBAR = "On Portraits"; -- CVar text for the current target castbar
...
USE_FULL_TEXT_MODE = "Use Full-Text Mode";
