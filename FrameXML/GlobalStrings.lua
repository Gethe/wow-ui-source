...
PARTY_LFG_BOOT_COOLDOWN = "You must wait before initiating another player boot.";
PARTY_LFG_BOOT_IN_PROGRESS = "Another boot vote is already in progress.";
PARTY_LFG_BOOT_LIMIT = "You can not initiate any more party boots.";
...
TUTORIAL_TITLE56 = "[Temp] You have health and mana!";
TUTORIAL_TITLE57 = "[Temp] NPC's have health and mana too!";
TUTORIAL_TITLE58 = "[Temp] Your bag is full :(";
