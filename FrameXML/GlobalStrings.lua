...
CR_BLOCK_TOOLTIP = "Increases chance to Block by %.2f%%\nA successful Block stops %d damage";
CR_CRIT_MELEE_TOOLTIP = "Crit rating %d (+%.2f%% crit chance)";
CR_CRIT_RANGED_TOOLTIP = "Crit rating %d (+%.2f%% crit chance)";
CR_DODGE_TOOLTIP = "Increases your chance to Dodge by %.2f%%";
CR_EXPERTISE_TOOLTIP = "Reduces chance to be dodged or parried by %.2f%%\nExpertise rating %d (+%d expertise)";
...
CR_PARRY_TOOLTIP = "Increases your chance to Parry by %.2f%%";
CTRL_KEY = "CTRL key";
...
ERR_CANT_EQUIP_RATING = "Your personal arena rating is too low for that item";
...
GUILDCONROL_OPTION14_TOOLTIP = "Can only use guild funds for repairs, cannot withdraw funds directly";
...
GUILDCONTROL_OPTION14 = " Repair Only";
...
GUILDCONTROL_WITHDRAW_GOLD = "Withdraw Gold(gold/day):";
...
HONOR_ESTIMATED_TOOLTIP = "Today's Estimated Honor";
...
ITEM_REQ_ARENA_RATING = "Requires personal arena rating of %d"; -- %d is the rating number required
...
LOOT_ROLL_PASSED_AUTO = "%s automatically passed on: %s because he cannot use that item";
LOOT_ROLL_PASSED_AUTO_FEMALE = "%s automatically passed on: %s because she cannot use that item";
LOOT_ROLL_PASSED_SELF = "You passed on: %s";
LOOT_ROLL_PASSED_SELF_AUTO = "You automatically passed on: %s because you cannot use that item";
...
OPTION_TOOLTIP_SHOW_FULLSCREEN_STATUS = "Shows a screen edge flash when you take damage while you have a fullscreen UI up.";
...
QUEST_LOG_DAILY_TOOLTIP = "You can only complete %d Daily quests each day.  The new day starts in %s.";
...
SHOW_COMBAT_HEALING = "Show Healing";
...
SHOW_ENEMY_CAST = "Show Enemy Cast Bars"; -- Label for the group of UI options related to showing the Enemy Cast Bars
...
SHOW_NEWBIE_TIPS_TEXT = "Show Beginner Tooltips";
...
SHOW_TARGET_CASTBAR_IN_V_KEY = "On Name Plates"; -- CVar text for the current target castbar
...
SPELL_PENETRATION_TOOLTIP = "Reduces the target's resistance to your spells";
...
USE_UBERTOOLTIPS = "Show Enhanced Tooltips";
