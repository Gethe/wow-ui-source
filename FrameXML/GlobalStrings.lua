...
REPAIR_ALL_ITEMS = "Repair All Equipped Items";
...
SPELLPOWERLEECHOTHEROTHER = "%s drains %d %s from %s and gains %d.";
SPELLPOWERLEECHOTHERSELF = "%s drains %d %s from you and gains %d.";
SPELLPOWERLEECHSELFOTHER = "You drain %d %s from %s and gain %d.";
