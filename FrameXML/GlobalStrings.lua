...
PET_NEXT_TALENT_LEVEL = "Next talent point at level %d";
...
STAT_MASTERY_TOOLTIP = "Increases bonus effects granted by talents (NYI - this will eventually show the specific bonus for your spec).\nMastery rating %d (+%.2f mastery).";
STAT_PARRY = "Parry";
