...
ARTIFACTS_APPEARANCE_TAB_TITLE = "Reforge Appearance";
ARTIFACTS_KNOWLEDGE_TOOLTIP_DESC = "You have purchased %d/%d traits. Increase your knowledge level to purchase more traits.";
ARTIFACTS_KNOWLEDGE_TOOLTIP_LEVEL = "Level %d";
ARTIFACTS_PERK_TAB = "Spend Power";
ARTIFACT_POWER = "Artifact Power";
ARTIFACT_POWER_BAR = "Artifact Power %d / %d";
ARTIFACT_POWER_COST_TOOLTIP = "Cost: %s%d Artifact Power|r";
...
ARTIFACT_POWER_RELIC_BONUS = "(+%d Rank) |c%s%s|r";
...
ARTIFACT_XP_GAIN = "%s gains %d Artifact Power.";
...
BATTLE_PETS_TOTAL_PETS_TOOLTIP = "Total number of pets owned.  You can have up to 1000 total pets and three of the same pet.";
...
BLIZZARD_STORE_DISCLAIMER_APPEARANCE_CHANGE = "|HurlIndex:25|h|cff71d5ffFrequently Asked Questions|r|h";
BLIZZARD_STORE_DISCLAIMER_APPEARANCE_CHANGE_CN = "|HurlIndex:29|h|cff006995Frequently Asked Questions|r|h";
BLIZZARD_STORE_DISCLAIMER_FACTION_CHANGE = "This process may take several minutes to complete.  |HurlIndex:23|h|cff71d5ffFrequently Asked Questions|r|h";
...
BLIZZARD_STORE_DISCLAIMER_NAME_CHANGE = "|HurlIndex:26|h|cff71d5ffFrequently Asked Questions|r|h";
BLIZZARD_STORE_DISCLAIMER_NAME_CHANGE_CN = "|HurlIndex:30|h|cff006995Frequently Asked Questions|r|h";
BLIZZARD_STORE_DISCLAIMER_RACE_CHANGE = "|HurlIndex:24|h|cff71d5ffFrequently Asked Questions|r|h";
...
BOOST2_MAGEFIRE_ADVANCEDCOMBAT_FIREBALL = "Use |cFFFFFFFFFireball|r to land your first critical strike, then use |cFFFFFFFFInferno Blast|r to get a second.";
BOOST2_MAGEFIRE_ADVANCEDCOMBAT_INFERNOBLAST = "Now use |cFFFFFFFFInferno Blast|r to get a second critical strike.";
BOOST2_MAGEFIRE_ADVANCEDCOMBAT_PYROBLAST = "Use |cFFFFFFFFPyroblast|r with your Hot Streak to instantly cast it.";
BOOST2_MAGEFIRE_AOE_FLAMESTRIKE = "Use |cFFFFFFFFFlame Strike|r to eliminate all the oozes at once.";
BOOST2_MAGEFIRE_BASICCOMBAT_FIREBALL = "Use |cFFFFFFFFFireball|r on the Target Dummy.";
BOOST2_MAGEFIRE_BASICCOMBAT_INFERNOBLAST = "Use |cFFFFFFFFInferno Blast|r on the Ooze.\n\nYou can cast this while moving.";
BOOST2_MAGEFIRE_COMBAT_FROSTNOVA = "Use |cFFFFFFFFFrost Nova|r to freeze the Yeti in place and get away.";
BOOST2_MAGEFROST_ADVANCEDCOMBAT_ICELANCE = "Use |cFFFFFFFFIce Lance|r while under the effect of |cFFFFFFFFFingers of Frost|r";
BOOST2_MAGEFROST_BASICCOMBAT_FROSTBOLT = "Use |cFFFFFFFFFrostbolt|r on the Target Dummy.";
BOOST2_MAGEFROST_BASICCOMBAT_ICELANCE = "Use |cFFFFFFFFIce Lance|r on the Ooze.\n\nYou can cast this while moving.";
BOOST2_MAGE_CONTROL_FROSTNOVA = "Use |cFFFFFFFFFrost Nova|r to freeze the Charged Spark in place.";
BOOST2_MAGE_MOBILITY_BLINK = "Use |cFFFFFFFFBlink|r to teleport forward.";
...
CONFIRM_ARTIFACT_CHOICE = "Are you sure you wish to pursue this artifact? It may be some time before you can obtain the others.";
...
DH_HAVOC_CORE_ABILITY_1 = "Use Fel Rush to close distance or damage multiple enemies.";
DH_HAVOC_CORE_ABILITY_2 = "Use Eye Beam when available, and you have Fury. Try to damage multiple targets.";
DH_HAVOC_CORE_ABILITY_3 = "Use Chaos Strike when you still have Fury to spend.";
DH_HAVOC_CORE_ABILITY_4 = "Use Demon's Bite to build up Fury.";
...
DK_BLOOD_CORE_ABILITY_3 = "Use when you have 1 Blood Rune to spread your diseases.";
DK_BLOOD_CORE_ABILITY_4 = "Use when you have available Runic Power.";
DK_BLOOD_CORE_ABILITY_5 = "Use when you have 1 Unholy Rune and 1 Frost Rune to heal yourself.";
DK_BLOOD_CORE_ABILITY_6 = "Use when you have 1 Blood Rune for defense.";
DK_FROST_CORE_ABILITY_1 = "Use when you have 1 Unholy Rune.";
DK_FROST_CORE_ABILITY_2 = "Use when you have 1 Frost Rune.";
DK_FROST_CORE_ABILITY_3 = "Use when you have 1 Unholy Rune and 1 Frost Rune.";
DK_FROST_CORE_ABILITY_4 = "Use when you have available Runic Power.";
DK_FROST_CORE_ABILITY_5 = "Use when you have 1 Frost Rune and the target is near death.";
DK_UNHOLY_CORE_ABILITY_1 = "Use when you have 1 Unholy Rune.";
DK_UNHOLY_CORE_ABILITY_2 = "Use when you have 1 Blood Rune and 1 Frost Rune to extend your diseases on the target.";
DK_UNHOLY_CORE_ABILITY_3 = "Use when you have available Runic Power.";
DK_UNHOLY_CORE_ABILITY_4 = "Use when you have 1 Frost Rune and the target is near death.";
DK_UNHOLY_CORE_ABILITY_5 = "Keep a ghoul summoned at all times.";
DK_UNHOLY_CORE_ABILITY_6 = "Transform your ghoul when available.";
DMG = "Dmg";
DND = "Busy";
DODGE = "Dodge";
...
DRUID_BALANCE_CORE_ABILITY_1 = "Keep applied to the target when available.";
DRUID_BALANCE_CORE_ABILITY_2 = "Keep applied to the target when available.";
DRUID_BALANCE_CORE_ABILITY_3 = "Cast while Solar is stronger.";
DRUID_BALANCE_CORE_ABILITY_4 = "Cast while Lunar is stronger.";
DRUID_BALANCE_CORE_ABILITY_5 = "Cast when available to amplify Wrath or Starfire damage.";
DRUID_BALANCE_CORE_ABILITY_6 = "Passive.  Cycle between Lunar and Solar spells being more powerful.";
DRUID_FERAL_CORE_ABILITY_1 = "Keep applied to the target.";
DRUID_FERAL_CORE_ABILITY_2 = "Use to build combo points.";
DRUID_FERAL_CORE_ABILITY_3 = "Keep applied to yourself when you have 5 combo points.";
DRUID_FERAL_CORE_ABILITY_4 = "Keep applied to the target when you have 5 combo points.";
DRUID_FERAL_CORE_ABILITY_5 = "Use when you have 5 combo points and other finishers are still active.";
DRUID_GUARDIAN_CORE_ABILITY_1 = "Use when available to generate Rage.";
DRUID_GUARDIAN_CORE_ABILITY_2 = "Keep applied to the target.";
DRUID_GUARDIAN_CORE_ABILITY_3 = "Keep applied to the target.";
DRUID_GUARDIAN_CORE_ABILITY_4 = "Use Rage to deal increased damage.";
DRUID_GUARDIAN_CORE_ABILITY_5 = "Use as needed when you have 60 Rage for defense.";
DRUID_GUARDIAN_CORE_ABILITY_6 = "Use Rage to heal yourself.";
...
DRUID_RESTO_CORE_ABILITY_1 = "Keep applied to the primary healing target.";
DRUID_RESTO_CORE_ABILITY_2 = "Use on multiple injured targets.";
DRUID_RESTO_CORE_ABILITY_3 = "A slow, cheaper heal.";
DRUID_RESTO_CORE_ABILITY_4 = "A fast, expensive heal.";
DRUID_RESTO_CORE_ABILITY_5 = "Use when many party members are injured.";
DRUID_RESTO_CORE_ABILITY_6 = "Use frequently to heal quickly.";
...
ERR_LEARN_TRANSMOG_S = "%s has been added to your transmog collection.";
...
ERR_REVOKE_TRANSMOG_S = "%s has been removed from your transmog collection.";
...
FLASH_LOW_HEALTH_WARNING = "|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t Flash Screen at Low Health";
...
GUILD_CHALLENGE_TOOLTIP1 = "Complete any level-appropriate Normal or Heroic dungeon via the Dungeon Finder while in a guild group.";
...
HUNTER_BM_CORE_ABILITY_1 = "Use when nothing else is available.";
HUNTER_BM_CORE_ABILITY_2 = "Use when you are low on Focus.";
HUNTER_BM_CORE_ABILITY_3 = "Use when you have 5 Frenzy stacks.";
HUNTER_BM_CORE_ABILITY_4 = "Use when available.";
HUNTER_BM_CORE_ABILITY_5 = "Use when the target is near death.";
HUNTER_INTELLECT_TOOLTIP = "Increases mana points and chance to score a critical hit with spells.\nIncreases the rate at which weapon skills improve.";
HUNTER_MM_CORE_ABILITY_1 = "Use to when nothing else is available.";
HUNTER_MM_CORE_ABILITY_2 = "Use when available, especially to hit 2 targets.";
HUNTER_MM_CORE_ABILITY_3 = "Use when you are low on Focus.";
HUNTER_MM_CORE_ABILITY_4 = "Use when the target is near death.";
HUNTER_SV_CORE_ABILITY_1 = "Keep applied to the target.";
HUNTER_SV_CORE_ABILITY_2 = "Use when available.";
HUNTER_SV_CORE_ABILITY_3 = "Use when you are low on Focus.";
...
LFG_LIST_HONOR_LEVEL_CURRENT_PVP = "PvP Honor Level: %d";
LFG_LIST_HONOR_LEVEL_INSTR_PVP_SHORT = "PvP Honor Level";
...
LFG_LIST_ITEM_LEVEL_HONOR_LEVEL_REQ = "Minimum Honor Level";
...
MAGE_ARCANE_CORE_ABILITY_1 = "Primary damage spell.  Arcane charge generator.";
MAGE_ARCANE_CORE_ABILITY_2 = "Cast when you have 4 Arcane Charges or when spells are too expensive.";
MAGE_ARCANE_CORE_ABILITY_3 = "Cast when available.";
MAGE_ARCANE_CORE_ABILITY_4 = "Passive.  Increases your damage and the mana cost of your spells.";
MAGE_ARCANE_CORE_ABILITY_5 = "Use to recover mana when below 40%.";
MAGE_FIRE_CORE_ABILITY_1 = "Primary damage spell.";
MAGE_FIRE_CORE_ABILITY_2 = "Use when instant.";
...
MAGE_FIRE_CORE_ABILITY_4 = "Use for damage while moving.";
MAGE_FIRE_CORE_ABILITY_5 = "Use after Pyroblast to increase Fire damage over time.";
MAGE_FROST_CORE_ABILITY_1 = "Primary damage spell.";
MAGE_FROST_CORE_ABILITY_2 = "Use when the target is frozen.";
MAGE_FROST_CORE_ABILITY_3 = "Use when Brain Freeze occurs.";
MAGE_FROST_CORE_ABILITY_4 = "Keep a Water Elemental summoned at all times.";
MAGE_FROST_CORE_ABILITY_5 = "Passive. Sometimes causes Frostfire Bolt to become instant and deal more damage.";
MAGE_FROST_CORE_ABILITY_6 = "Passive. Sometimes causes your Ice Lance to deal more damage.";
...
MANA_REGEN_TOOLTIP = "Amount of mana regenerated every 5 seconds.\n\nWhen out of combat, mana regeneration is increased to %s every 5 seconds.";
...
MONK_BREW_CORE_ABILITY_1 = "Use when available to generate Chi.";
MONK_BREW_CORE_ABILITY_2 = "Use to generate Chi.";
MONK_BREW_CORE_ABILITY_3 = "Use when you have 2 Chi to reduce damage.";
MONK_BREW_CORE_ABILITY_4 = "Use when nothing else is available.";
MONK_BREW_CORE_ABILITY_5 = "Use after taking a lot of damage.  Primary Chi consumer.";
MONK_BREW_CORE_ABILITY_6 = "Use when needed for defense.";
MONK_MIST_CORE_ABILITY_1 = "A slow, cheaper heal.";
MONK_MIST_CORE_ABILITY_2 = "A fast, expensive heal that can be layered with Soothing Mist.";
MONK_MIST_CORE_ABILITY_3 = "A powerful heal that can be layered with Soothing Mist.";
MONK_MIST_CORE_ABILITY_4 = "Use to heal yourself and deal damage to a nearby enemy.";
MONK_MIST_CORE_ABILITY_5 = "Use when multiple party members are injured.";
MONK_MIST_CORE_ABILITY_6 = "Use when you have Renewing Mist on many injured targets.";
MONK_WIND_CORE_ABILITY_1 = "Use to generate Chi.";
MONK_WIND_CORE_ABILITY_2 = "Keep applied to yourself.";
MONK_WIND_CORE_ABILITY_3 = "Use when you have 2 Chi.";
MONK_WIND_CORE_ABILITY_4 = "Use when available.";
MONK_WIND_CORE_ABILITY_5 = "Use when available.";
MONK_WIND_CORE_ABILITY_6 = "Use when you have 10 Stacks of Tigereye Brew.";
...
OPTION_TOOLTIP_FLASH_LOW_HEALTH_WARNING = "Your screen flashes red when you're low on health.";
...
PALADIN_HOLY_CORE_ABILITY_2 = "Use to heal when you have 3 Holy Power.";
PALADIN_HOLY_CORE_ABILITY_3 = "A slow, cheaper heal.";
PALADIN_HOLY_CORE_ABILITY_4 = "A fast, expensive heal.";
PALADIN_HOLY_CORE_ABILITY_5 = "Use to heal 2 targets at once.";
PALADIN_HOLY_CORE_ABILITY_6 = "Use when many party members are injured.";
...
PALADIN_PROT_CORE_ABILITY_4 = "Use when you have Holy Power to heal.";
PALADIN_PROT_CORE_ABILITY_5 = "Use when you have 3 Holy Power for defense and to increase Word of Glory.";
PALADIN_PROT_CORE_ABILITY_6 = "Keep active at all times when fighting a single enemy.";
...
PALADIN_RET_CORE_ABILITY_3 = "Use when you have 3 Holy Power.";
PALADIN_RET_CORE_ABILITY_4 = "Use when available.";
PALADIN_RET_CORE_ABILITY_5 = "Use when the target is near death.";
PALADIN_RET_CORE_ABILITY_6 = "Keep active at all times when fighting a single enemy.";
...
PRESS_TAB = "Press Tab";
PRESTIGE_LEVEL_1 = "Squirrel";
PRESTIGE_LEVEL_2 = "Uncommon Squirrel";
PRESTIGE_LEVEL_3 = "Rare Squirrel";
PRESTIGE_LEVEL_4 = "Epic Squirrel";
PRESTIGE_LEVEL_LABEL = "Prestige Level %d";
PRESTIGE_RANK_TOOLTIP_LINE = "\124T%s:14\124t %s";
PRESTIGE_RANK_TOOLTIP_TEXT = "|cffffffffPrestige Rank %d: %s|r";
PREV = "Prev";
PREVIEW = "Preview";
PREVIEW_TALENT_CHANGES = "Preview Talent Changes";
PREVIOUS = "Previous";
PRIEST_DISC_CORE_ABILITY_1 = "Use when available to heal a single target.";
PRIEST_DISC_CORE_ABILITY_2 = "An instant, expensive damage absorb.";
PRIEST_DISC_CORE_ABILITY_3 = "A slow, cheaper heal.";
PRIEST_DISC_CORE_ABILITY_4 = "A fast, expensive heal.";
PRIEST_DISC_CORE_ABILITY_5 = "An instant small heal when many targets near you are injured.";
PRIEST_DISC_CORE_ABILITY_6 = "A slow heal when many targets are injured.";
PRIEST_HOLY_CORE_ABILITY_1 = "A slow, cheaper heal.";
PRIEST_HOLY_CORE_ABILITY_2 = "A fast, expensive heal.";
PRIEST_HOLY_CORE_ABILITY_3 = "Use on multiple injured targets.";
PRIEST_HOLY_CORE_ABILITY_4 = "Use when multiple party members are taking damage.";
PRIEST_HOLY_CORE_ABILITY_5 = "An instant cooldown heal when many targets are injured.";
PRIEST_HOLY_CORE_ABILITY_6 = "A slow heal when many targets are injured.";
...
PRIEST_SHADOW_CORE_ABILITY_6 = "Use when the target is near death.";
PRIMARY = "Primary";
...
PVP_HONOR_XP_BAR_CANNOT_PRESTIGE_HERE = "Open your PvP Talents frame to prestige!";
...
PVP_PRESTIGE_RANK_UP_WARNING = "Your Honor Level will be reset to 1.  You will lose access to all of your PvP talents until you earn them again.";
...
ROGUE_ASS_CORE_ABILITY_1 = "Use to start combat from Stealth.";
ROGUE_ASS_CORE_ABILITY_2 = "Use when available.";
ROGUE_ASS_CORE_ABILITY_3 = "Use to build combo points.";
ROGUE_ASS_CORE_ABILITY_4 = "Keep applied to yourself when you have 5 combo points.";
ROGUE_ASS_CORE_ABILITY_5 = "Keep applied to the target when you have 5 combo points.";
ROGUE_ASS_CORE_ABILITY_6 = "Use when you have 5 combo points and other finishers are still active.";
ROGUE_COMBAT_CORE_ABILITY_1 = "Use to start combat from Stealth.";
ROGUE_COMBAT_CORE_ABILITY_2 = "Keep applied to the target.";
ROGUE_COMBAT_CORE_ABILITY_3 = "Use to build combo points.";
ROGUE_COMBAT_CORE_ABILITY_4 = "Keep applied to yourself when you have 5 combo points.";
ROGUE_COMBAT_CORE_ABILITY_5 = "Use when you have 5 combo points and other finishers are still active.";
ROGUE_SUB_CORE_ABILITY_1 = "Use to start combat from Stealth.";
ROGUE_SUB_CORE_ABILITY_2 = "Keep applied to the target, and use to build combo points when attacking the target from the front.";
ROGUE_SUB_CORE_ABILITY_3 = "Use to build combo points anytime you are not attacking from the front.";
ROGUE_SUB_CORE_ABILITY_4 = "Keep applied to yourself when you have 5 combo points.";
ROGUE_SUB_CORE_ABILITY_5 = "Keep applied to the target when you have 5 combo points.";
ROGUE_SUB_CORE_ABILITY_6 = "Use when you have 5 combo points and other finishers are still active.";
ROLE = "Role";
...
SCENARIO_DEMON_INVASION = "Demon Invasion";
...
SHAMAN_ELE_CORE_ABILITY_2 = "Use when available.";
SHAMAN_ELE_CORE_ABILITY_3 = "Use when nothing else is available.";
SHAMAN_ELE_CORE_ABILITY_4 = "Cast when you have 15 charges of Lightning Shield.";
SHAMAN_ELE_CORE_ABILITY_5 = "Keep active at all times.";
SHAMAN_ENHANCE_CORE_ABILITY_1 = "Keep applied to the target.";
SHAMAN_ENHANCE_CORE_ABILITY_2 = "Use when available.";
SHAMAN_ENHANCE_CORE_ABILITY_3 = "Use when available and to spread Flame Shock.";
SHAMAN_ENHANCE_CORE_ABILITY_4 = "Cast when Maelstrom Weapon makes it instant.";
SHAMAN_ENHANCE_CORE_ABILITY_5 = "Use when available to increase damage.";
SHAMAN_ENHANCE_CORE_ABILITY_6 = "Passive. Melee attacks reduce the cast time of your Nature spells.";
SHAMAN_INTELLECT_TOOLTIP = "Increases mana points and chance to score a critical hit with spells.\nIncreases the rate at which weapon skills improve.";
SHAMAN_RESTO_CORE_ABILITY_1 = "Keep applied to the primary healing target.";
SHAMAN_RESTO_CORE_ABILITY_2 = "A slow, cheaper heal.";
SHAMAN_RESTO_CORE_ABILITY_3 = "A fast, expensive heal.";
SHAMAN_RESTO_CORE_ABILITY_4 = "Cast when available, especially when using Chain Heal.";
SHAMAN_RESTO_CORE_ABILITY_5 = "Use when many party members are injured in a small area.";
SHAMAN_RESTO_CORE_ABILITY_6 = "Use when multiple party members near each other are injured.";
...
SHOW_ADVENTURE_JOURNAL_ALERTS = "Show Adventure Guide Alerts";
...
TRADE_POTENTIAL_REMOVE_TRANSMOG = "Trading %s will remove it from your transmog collection.";
...
TRANSMOGRIFY_TOOLTIP_APPEARANCE_KNOWN = "You've collected this transmog";
TRANSMOGRIFY_TOOLTIP_APPEARANCE_UNKNOWN = "You haven't collected this transmog";
TRANSMOGRIFY_TOOLTIP_ITEM_UNKNOWN_APPEARANCE_KNOWN = "You've collected this transmog, but not from this item";
...
TRANSMOG_OUTFIT_RENAME = "Rename";
TRANSMOG_OUTFIT_SAVE = "Save As";
...
UNIT_NAMEPLATES_AUTOMODE = "|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t Show All Nameplates.";
...
VIEW_IN_WARDROBE = "View in Wardrobe";
VIEW_LOG = "View Log";
...
WAISTSLOT = "Waist";
WARDROBE = "Wardrobe";
WARDROBE_TOOLTIP_CYCLE = "Press Tab or Shift-Tab to cycle through items.";
WARGAME = "War Game";
WARGAMES = "War Games";
...
WARLOCK_AFFLICTION_CORE_ABILITY_4 = "Use when your damage over time effects are active on the target.";
WARLOCK_AFFLICTION_CORE_ABILITY_5 = "Use when nothing else is available.";
WARLOCK_AFFLICTION_CORE_ABILITY_6 = "Use to enhance various abilities.";
WARLOCK_DEMO_CORE_ABILITY_1 = "Keep applied to the target.";
WARLOCK_DEMO_CORE_ABILITY_2 = "Use when nothing else is available.";
WARLOCK_DEMO_CORE_ABILITY_3 = "Use when Molten Core occurs.";
WARLOCK_DEMO_CORE_ABILITY_4 = "Keep applied to the target, especially when there are multiple targets.";
WARLOCK_DEMO_CORE_ABILITY_5 = "Transform into a demon when your Demonic Fury is full.";
WARLOCK_DEMO_CORE_ABILITY_6 = "Passive. Sometimes causes Soul Fire to cast faster.";
WARLOCK_DESTRO_CORE_ABILITY_1 = "Keep applied to the target.";
WARLOCK_DESTRO_CORE_ABILITY_2 = "Use when available to generate Burning Embers.";
WARLOCK_DESTRO_CORE_ABILITY_3 = "Use to spend Burning Embers.";
WARLOCK_DESTRO_CORE_ABILITY_4 = "Use when nothing else is available.";
WARLOCK_DESTRO_CORE_ABILITY_5 = "Use when the target is near death and you have a Burning Ember.";
WARLOCK_INTELLECT_TOOLTIP = "Increases mana points and chance to score a critical hit with spells.\nIncreases the rate at which weapon skills improve.";
WARRIOR_ARMS_CORE_ABILITY_1 = "Use to initiate combat for maximum Rage.";
WARRIOR_ARMS_CORE_ABILITY_2 = "Use when available so the target takes more damage.";
WARRIOR_ARMS_CORE_ABILITY_3 = "Use when available. Hardest hitting ability.";
WARRIOR_ARMS_CORE_ABILITY_4 = "Keep applied to the target.";
WARRIOR_ARMS_CORE_ABILITY_5 = "Use when you need to spend Rage and nothing else is available.";
WARRIOR_ARMS_CORE_ABILITY_6 = "Use when the target is near death.";
WARRIOR_FURY_CORE_ABILITY_1 = "Use to initiate combat for maximum Rage.";
WARRIOR_FURY_CORE_ABILITY_2 = "Use when available. Primary Rage generator.";
WARRIOR_FURY_CORE_ABILITY_3 = "Use when available.";
WARRIOR_FURY_CORE_ABILITY_4 = "Use when free or you need to spend Rage.";
WARRIOR_FURY_CORE_ABILITY_5 = "Use when the target is near death.";
WARRIOR_PROT_CORE_ABILITY_1 = "Use to initiate combat for maximum Rage.";
WARRIOR_PROT_CORE_ABILITY_2 = "Use when available. Primary Rage generator.";
WARRIOR_PROT_CORE_ABILITY_3 = "Use when nothing else is available.";
WARRIOR_PROT_CORE_ABILITY_4 = "Use when available.";
WARRIOR_PROT_CORE_ABILITY_5 = "Use Rage to absorb damage.";
WARRIOR_PROT_CORE_ABILITY_6 = "Use when you have 60 Rage for defense.";
