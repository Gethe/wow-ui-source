...
BONUS_OBJECTIVE_EXPERIENCE_FORMAT = "|TInterface\\Icons\\XP_Icon:16:16|t %s";
...
CANNOT_DO_THIS_IN_BATTLEGROUND = "You can't do this while queued for or in a Battleground or Arena.";
...
CR_CRIT_TOOLTIP = "Chance for attacks and spells to do extra damage. \nCrit %s (+%.2f%% crit chance)";
...
CR_LIFESTEAL_TOOLTIP = "Returns damage and healing you deal as healing to you.\n\nLeech %s (+%.2f%% Leech)";
CR_MULTISTRIKE_TOOLTIP = "Grants two %.2f%% chances to deliver extra attacks or heals for %.2f%% of normal value on each target. \nMultistrike: %s (%.2f%% multistrike)";
...
CR_VERSATILITY_TOOLTIP = "Increases damage and healing done by %s%% and decreases damage taken by %s%%.";
CTRL_KEY = "CTRL key";
CTRL_KEY_TEXT = "CTRL";
...
DUNGEON_FLOOR_FOUNDRYRAID1 = "Dread Grotto";
DUNGEON_FLOOR_FOUNDRYRAID2 = "Heart of the Mountain";
DUNGEON_FLOOR_FOUNDRYRAID3 = "The Workshop";
DUNGEON_FLOOR_FOUNDRYRAID4 = "Foundry Terminus";
DUNGEON_FLOOR_FOUNDRYRAID5 = "The Iron Crucible";
...
GARRISON_MISSION_TUTORIAL5 = "Drag a Follower here to add them to the party.";
...
GARRISON_TOWN_HALL_ALLIANCE_UPGRADE_TIER2_TOOLTIP = "%sRequires:%s Level 98.";
...
GARRISON_TOWN_HALL_HORDE_UPGRADE_TIER2_TOOLTIP = "%sRequires:%s Level 98.";
GARRISON_TOWN_HALL_LEVEL1_DESCRIPTION = "Unlocks access to a large and small building plot.";
GARRISON_TOWN_HALL_LEVEL2_DESCRIPTION = "Unlocks access to a medium and additional small building plot. Also unlocks access to Small and Medium buildings.";
...
ITEM_COMPARISON_SWAP_ITEM_MAINHAND_DESCRIPTION = "Cycle through your main-hand items by pressing %s.";
ITEM_COMPARISON_SWAP_ITEM_OFFHAND_DESCRIPTION = "Cycle through your off-hand items by pressing %s.";
...
MANA_REGEN_FROM_SPIRIT = "Increases mana regeneration in combat by %d";
MANA_REGEN_TOOLTIP = "Amount of mana returned to you every 5 seconds.\n\nIncreases to %s when out of combat.";
...
SPELL_FAILED_CANT_OVERRIDE_ENCHANT_VISUAL = "That item cannot be modified.";
