...
GUILD_NEWS_FORMAT4 = "%s created %s";
...
HELPFRAME_STUCK_GRAVEYARD = "This will kill your character, putting your spirit in the nearest graveyard.  You can then either resurrect at the Spirit Healer, suffering durability loss, or retrieve your corpse.";
...
TUTORIAL10_HUMAN = "You recieved a quest to kill |cffffd200Blackrock Battle Worgs|r. They are North of the abby (where you are now).|nUse the mini-map in the upper right corner to guide you.";
...
TUTORIAL57_SCOURGE = "Remember to visit |cffffd200Shadow Priest Sarvis|r. He has a quest for you! |cffffd200Right Click|r on him when your cursor is a |cffffd200Yellow Question Mark|r.";
...
TUTORIAL61_SPELLID_WARLOCK = "697";
