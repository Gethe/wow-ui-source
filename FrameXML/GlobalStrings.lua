...
BOOSTED_CHAR_SPELL_TEMPLOCK = "Temporary Locked";
BOSS = "Boss";
BOSSES = "Bosses:";
...
VAS_NAME_CHANGE_TOOLTIP = "- 2 to 12 letters|n- Can't contain numbers or special|ncharacters|n- Can't contain any character which|nare not supported in your region";
