...
CR_STURDINESS_TOOLTIP = "Reduces durability loss from death on your items.\n\nSturdiness %s (+%.2f%% Sturdiness)";
...
ERR_MOUNT_NO_FAVORITES = "You have selected no favorite mounts appropriate for this area.\nRight-Click to set Favorites.";
...
GARRISON_MISSION_TIME_TOTAL = "Total: %s";
...
GARRISON_TOWN_HALL_UPGRADE_TIER1_TOOLTIP = "%sRequires:%s Level 93";
GARRISON_TOWN_HALL_UPGRADE_TIER2_TOOLTIP = "%sRequires:%s Level 98";
...
ITEM_MOD_CR_STURDINESS_SHORT = "Sturdiness";
...
ITEM_MOD_CR_UNUSED_6_SHORT = "Sturdiness";
...
OBJECT_NPC_OUTLINE_MODE_ONE = "Only Quests and Tracking";
OBJECT_NPC_OUTLINE_MODE_THREE = "All (variation 2)";
OBJECT_NPC_OUTLINE_MODE_TWO = "All (variation 1)";
OFF = "Off";
OFFICER = "Officer";
...
OPTION_TOOLTIP_OBJECT_NPC_OUTLINE = "This sets the mode for seeing outlines around objects and creatures.";
...
SPLASH_BOOST2_RIGHT_DESC = "Head to the Blasted Lands and talk to Archmage Khadgar.";
