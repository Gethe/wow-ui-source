...
BOOST2_ROGUE_ADVANCEDCOMBAT_EVISCERATE = "Use |cFFFFFFFFEviscerate|r on the Target Dummy.";
BOOST2_ROGUE_ADVANCEDCOMBAT_SHADOWSTRIKE = "Use |cFFFFFFFFShadowstrike|r on the Target Dummy.";
...
TRANSMOGRIFY_INVALID_REASON4 = "This type of item cannot be transmogrified.";
TRANSMOGRIFY_INVALID_REASON5 = "This item cannot be transmogrified.";
TRANSMOGRIFY_INVALID_REASON6 = "This armor type isn't compatible with this transmog.";
