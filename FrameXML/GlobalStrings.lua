...
CHAT_RAID_BOSS_EMOTE = "[Raid Boss] %s:\32";
...
OPTION_TOOLTIP_CAMERA_MODE = "Lets you free look when the camera is on the ground.";
...
OPTION_TOOLTIP_PARTY_CHAT_BUBBLES_TEXT = "Shows party chat text in speech bubbles above party members' heads.";
...
OPTION_TOOLTIP_SHOW_TARGET_OF_TARGET = "Toggles whether you see the target of your target in a party or raid.";
