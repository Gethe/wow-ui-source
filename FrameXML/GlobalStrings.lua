...
BATTLEFIELD_QUEUE_CONFIRM = "You are elibigle to enter %s\nYou will be removed from the queue in %s";
...
COMBATLOG_HONORGAIN = "%s dies, honorable kill.(Rank: %s)";
...
DEATH_CORPSE_SKINNED = "Your corpse has been skinned to the bone and is no longer useable.";
...
OPTION_TOOLTIP_CHAT_BUBBLES_TEXT = "Shows /say and /yell text in speech bubbles above characters' heads.";
...
OPTION_TOOLTIP_PARTY_CHAT_BUBBLES_TEXT = "Shows party chat text in speech bubbles above party member's heads.";
...
OPTION_TOOLTIP_SHOW_MULTIBAR2 = "Toggles an option actionbar in the bottom right area of the screen";
...
SLASH_SPLIT2 = "/split"; -- Split Money
