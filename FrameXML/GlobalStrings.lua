...
BLIZZARD_STORE_CONFIRMATION_TITLE = "In-Game Store Confirmation";
BLIZZARD_STORE_CONNECTING = "Connecting to In-Game Store";
...
BLIZZARD_STORE_ERROR_TITLE_BATTLEPAY_DISABLED = "In-Game Store Error";
BLIZZARD_STORE_ERROR_TITLE_INSUFFICIENT_BALANCE = "Insufficient Balance";
BLIZZARD_STORE_ERROR_TITLE_OTHER = "In-Game Store Error";
...
BLIZZARD_STORE_INTERNAL_ERROR_SUBTEXT = "The In-Game Store has encountered an error. Please try again later.";
...
BLIZZARD_STORE_NOT_AVAILABLE = "In-Game Store Unavailable";
BLIZZARD_STORE_NOT_AVAILABLE_SUBTEXT = "The In-Game Store is temporarily unavailable. Please try again later.";
...
BLIZZARD_STORE_PURCHASE_COMPLETE = "Purchase Delivered!";
...
PVP_RATEDBG_NEED_LESS = "Your group needs %d less players to join a rated battleground.";
PVP_RATEDBG_NEED_MORE = "Your group needs %d more players to join a rated battleground.";
