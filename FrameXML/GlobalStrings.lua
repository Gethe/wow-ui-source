...
ERR_LFG_TOO_MANY_MEMBERS = "You can not use dungeons with more than 5 party members.";
...
ERR_PARTY_LFG_BOOT_NOT_ELIGIBLE = "That player can not be booted yet.";
...
MAP_QUEST_DIFFICULTY_TEXT = "Quest Difficulty Color|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
TUTORIAL51 = "You can enter dungeons or find groups for dungeons by using the |cffffd200Dungeons tool|r. The Dungeons tool is accessed from the eye button near the middle of your action bar.";
...
TUTORIAL59 = "To free up bag space or make some money you can sell some of the items you have collected.|n|nLocate a vendor and |cffffd200Right Click|r them. Then open your bags and |cffffd200Right Click|r on any items you want to sell.|n|nAny vendor will buy any kind of item from you.";
