...
ACHIEVEMENT_TOOLTIP_COMPLETE = "Achievement earned by %s on %d/%d/20%02d";
...
CALENDAR_INVITEDBY_PLAYER = "Invited by %s"; -- %s=player name
...
FEAT_OF_STRENGTH_DESCRIPTION = "A feat of Strength is an accomplishment that players will find very difficult if not impossible to earn.  Worth no points, Feats of Strength are a collection of past glories on Azeroth.";
...
MAIN_MENU = "Game Menu"; -- The main menu
MAIN_TANK = "Main Tank";
...
SPELL_FAILED_CUSTOM_ERROR_45 = "Requires a nearby diseased target.";
...
VIDEO_QUALITY_SUBTEXT4 = "High texture detail, farthest draw distance, high spell effect detail. These settings provide the highest quality.";
VIDEO_QUALITY_SUBTEXT5 = "Allows you to customize individual draw distances, detail levels, and effects. Performance and quality will vary by setting.";
VOICE = "Voice";
