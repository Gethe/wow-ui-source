...
BINDING_NAME_TOGGLEENCOUNTERJOURNAL = "Toggle Adventure Journal";
...
ERR_GUILD_TRIAL_ACCOUNT_VETERAN = "Starter Edition accounts cannot join guilds without an existing character in the guild.";
...
GARRISON_BONUS_AREA_TITLE = "Bonus Area";
...
GARRISON_FOLLOWER_SHIP_DESTROYED = "%s has been destroyed.";
...
GARRISON_SHIPYARD_MISSION_COMPLETE_SIEGEBREAKER_TOOLTIP = "Complete the Siegebreaker mission to start";
...
GUILD_ACHIEVEMENTS_ELIGIBLE_MINXP = "At least %1$d out of %2$d players in your group are members of %3$s.  Your entire group is composed of guild members of %1$s. Guild achievements can be earned.";
...
SPELL_FAILED_CUSTOM_ERROR_262 = "You already have the max number of ships your shipyard can support.";
