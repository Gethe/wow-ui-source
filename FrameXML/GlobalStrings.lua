...
BN_CHAT_CLICK_INVISIBLE_OFF = "|cffffd200[|Huiaction:confirmbninvisibleoff|hClick here|h]|r to go online.";
BN_CHAT_CONNECTED = "You are now connected to Battle.net.";
BN_CHAT_DISCONNECTED = "You have been disconnected from Battle.net.";
BN_CHAT_INVISIBLE_OFF = "You are no longer appearing offline.";
BN_CHAT_INVISIBLE_ON = "You are now appearing offline.";
...
BN_NO_BROADCAST_WHILE_INVISIBLE = "You cannot change your Broadcast message while appearing offline.";
BN_NO_CHAT_WHILE_INVISIBLE = "This message could not be sent because you are appearing offline.";
...
CONFIRM_BN_INVISIBLE_OFF = "Are you sure you want to turn off appearing offline?";
...
FRIENDS_LIST_INVISIBLE = "Appear Offline";
...
OPTION_TOOLTIP_LOSS_OF_CONTROL = "[PH] Tooltip here";
...
PVP_POWER_TOOLTIP = "Increases damage done to players and their pets or minions, and increases healing done in PvP zones";
PVP_RANK_0_0 = "Scout";
