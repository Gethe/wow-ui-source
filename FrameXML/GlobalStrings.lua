...
BATTLEGROUND_ENEMY_AVERAGE_RATING = "Enemy Team Average Rating: |cffffffff%d|r";
...
BATTLEGROUND_YOUR_AVERAGE_RATING = "Your Team Average Rating: |cffffffff%d|r";
...
CR_BLOCK_TOOLTIP = "Block Rating of %d adds a %.2f%% chance to Block.\nYour block stops %d%% of incoming damage.";
...
DEFAULT_STAT4_TOOLTIP = "Increases Mana by %d|nIncreases Spell Power by %d|nIncreases Spell Critical Hit by %.2f%%";
...
DISPLAY_SPELL_ALERTS = "Show Spell Alerts|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
EMPHASIZE_MY_SPELLS_TEXT = "Emphasize My Spell Effects|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
EMPTY = "Empty";
...
ERR_INSUFF_TRACKED_CURRENCY_IS = "You must earn %d more %s in order to purchase that item.";
...
ERR_SOCKETING_ITEM_TOO_LOW_LEVEL = "The item is too lowel level to accept that gem";
...
FLOATING_COMBAT_SELF_LABEL = "My Floating Combat Text";
FLOATING_COMBAT_TARGET_LABEL = "Target's Floating Combat Text";
FLOOR = "Areas";
FLOOR_NUMBER = "Area %d";
FOCUS = "Focus";
...
GUILD_EXPERIENCE_TOOLTIP = "Guild experience can be earned by completing quests, earning guild achievements or killing bosses and winning rated battlegrounds with your guild.";
...
ITEM_MOD_CRIT_RATING = "Increases your critical strike rating by %d.";
...
ITEM_MOD_RESILIENCE_RATING = "Increases your resilience rating by %d.";
...
LEVEL_UP_DUALSPEC = "Dual Talent Specialization";
LEVEL_UP_DUAL_SPEC_LINK = " |cffFF4E00|Htalentpane:|h[Dual Talent Specialization]|h|r";
...
LEVEL_UP_TALENTPOINT_LINK = "New |cffFF4E00|Htalentpane:|h[Talent Point]|h|r Available!";
LEVEL_UP_TALENTS_LINK = " |cffFF4E00|Htalentpane:|h[Talents]|h|r";
LEVEL_UP_TALENT_MAIN = "New Talent Point Available";
...
LOOK_FOR_GUILD_TAB = "Look for Guild";
...
MANA_COLON = "Mana:";
MANA_COMBAT_REGEN_TOOLTIP = "%d mana regenerated every 5 seconds while in combat.";
MANA_COST = "%d Mana";
...
MANA_REGEN_TOOLTIP = "%d mana regenerated every 5 seconds while not in combat.";
...
NEXT_TALENT_LEVEL = "Next talent point at |cffffd200Level %d|r";
NO = "No";
NONE = "None";
...
NPC_NAMES_DROPDOWN_TRACKED_TOOLTIP = "Display names for NPC's involved with quests, as well as tracked NPCs using the minimap tracker.";
...
PARTY_PHASED_MESSAGE = "This player is in a different phase. You cannot see nor interact with this player.";
...
PET_LEVEL_UP_TALENTPOINT_LINK = "New |cffFF4E00|Hpettalentpane:|h[Pet Talent Point]|h|r Available!";
PET_LEVEL_UP_TALENT_MAIN = "New Pet Talent Point";
...
PET_TYPE_PET = "Pet";
PET_UNSPENT_TALENT_POINTS = "Your pet has|cffffd200 %s |runspent talent |4point:points;";
PET_WAIT = "Stay";
...
PICKUP_ACTION_KEY_TEXT = "Pick Up Action Key|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
PLAYER_UNSPENT_TALENT_POINTS = "You have|cffffd200 %s |runspent talent |4point:points;";
...
RAID_FRAMES_LABEL = "Raid Frames|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
RAID_SUMMON_FAILED_OFFLINE = "%s if offline and will not be summoned.";
...
SHOW_NPC_NAMES = "NPC Names|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SHOW_POINTS_AS_AVG = "Display Points as Average|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SPELL_FAILED_CUSTOM_ERROR_122 = "You must select a talent specialization first.";
...
SPELL_FAILED_CUSTOM_ERROR_34 = "Must be in Cat Form or Bear Form";
...
STAT_HIT_MELEE_TOOLTIP = "Hit rating %d (+%.2f%% hit chance)";
STAT_HIT_NORMAL_ATTACKS = "Normal Attacks";
STAT_HIT_RANGED_TOOLTIP = "Hit rating %d (+%.2f%% hit chance)";
STAT_HIT_SPECIAL_ATTACKS = "Special Attacks";
STAT_HIT_SPELL_TOOLTIP = "Hit rating %d (+%.2f%% hit chance)";
STAT_MANA_TOOLTIP = "Maximum mana.  Mana is used to cast spells.";
STAT_MASTERY = "Mastery";
STAT_MASTERY_TOOLTIP = "Mastery rating %d (+%.2f mastery).";
STAT_MASTERY_TOOLTIP_NOT_KNOWN = "You must learn Mastery from your trainer before this will have an effect.";
STAT_MASTERY_TOOLTIP_NO_TALENT_SPEC = "You must select a talent specialization in order to activate Mastery.";
...
STAT_TOOLTIP_BONUS_AP = "Increases Attack Power by %d\n";
...
TALENTS_CHOOSE_SPEC_SUBHEADER = "You will immediately receive powerful bonuses.";
...
TALENTS_UNAVAILABLE_TOOLTIP = "This feature becomes available once you earn a Talent Point.";
...
TALENT_MICRO_BUTTON_TUTORIAL = "You have earned your first Talent Point!  Click here to choose your talents.";
...
TALENT_TREE_PREVIEW_TUTORIAL = "When you are finished spending points, click Learn.  You can always reset your talent choices by visiting your class trainer.";
TALL = "Tall";
TAMEABLE = "Tameable";
...
TUTORIAL10_DWARF = "You recieved a quest to kill |cffffd200Rockjaw Invaders|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_GNOME = "You recieved a quest to kill |cffffd200Crazed Leper Gnomes|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_HUMAN = "You recieved a quest to kill |cffffd200Blackrock Battle Worgs|r. They are North of the Abbey (where you are now).|nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_NIGHTELF = "You recieved a quest to kill |cffffd200Young Nightsabers|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_ORC = "You recieved a quest to kill |cffffd200Mottled Boar|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_SCOURGE = "You recieved a quest to kill |cffffd200Mindless Zombies|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_TAUREN = "You recieved a quest to kill |cffffd200Bristleback Invaders|r. |nUse the mini-map in the upper right corner to guide you.";
TUTORIAL10_TROLL = "You recieved a quest to kill |cffffd200Tiki Targets|r. |nUse the mini-map in the upper right corner to guide you.";
...
TUTORIAL1_NIGHTELF = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over their heads. You can get a quest by talking to |cffffd200Conservator Ilthalaine|r.|n|nTo talk to  |cffffd200Conservator Ilthalaine|r you need to |cffffd200Right Click|r on him.";
...
TUTORIAL55_NIGHTELF = "Congratulations! You have killed enough |cffffd200Young Nightsabers|r to complete your quest|n|nReturn to |cffffd200Conservator Ilthalaine|r to claim your reward.";
...
UNITFRAME_LABEL = "Unit Frames|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
UNIT_NAMEPLATES_TYPE_1 = "Overlaping Nameplates";
...
UNIT_NAMEPLATES_TYPE_TOOLTIP_2 = "This method avoids overlaping nameplates by stacking them vertically.";
UNIT_NAMEPLATES_TYPE_TOOLTIP_3 = "This method avoids overlaping nameplates by spreading them out horizontally and vertically.";
...
UNIT_NAME_GUILD_TITLE = "Guild Titles|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
USE_RAID_STYLE_PARTY_FRAMES = "Use Raid-Style Party Frames|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
WARGAME_TOOLTIP = "War Games allow you to challenge groups of other players to a showdown in a battleground of your choice.  To start a War Game you must be the party leader, select a battleground, target an opposing party leader and click the War Game button.";
...
WORLD_PVP_PENDING = "You are queued for %s but have not yet been called to battle yet. You will be ported out in a few moments.";
WORLD_PVP_PENDING_REMOTE = "You are queued for %s but have not yet been called to battle yet.";
