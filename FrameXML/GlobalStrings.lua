...
CR_SPEED_TOOLTIP = "Increases run speed.\n\nSpeed %s (+%.2f%%)";
...
DUNGEON_FLOOR_FROSTFIRERIDGE7 = "The Savage Crag";
...
ERR_LEARN_TOY_S = "You have added the toy %s to your collection.";
...
GARRISON_CURRENT_LEVEL = "Level %d";
...
GARRISON_FINALIZE_BUILDING_TOOLTIP = "Return to your building to finalize contruction.";
...
GARRISON_FOLLOWER_EXHAUSTED = "Recovering";
...
GARRISON_LANDING_SHIPMENT_STARTED_ALERT = "Shipment Started";
...
GARRISON_TOWN_HALL_ALLIANCE_UPGRADE_TIER1_TOOLTIP = "%sRequires:%s Quest progress within Shadowmoon Valley or Level 93.";
GARRISON_TOWN_HALL_ALLIANCE_UPGRADE_TIER2_TOOLTIP = "%sRequires:%s Level 100.";
...
GARRISON_TOWN_HALL_HORDE_UPGRADE_TIER1_TOOLTIP = "%sRequires:%s Quest progress within Frostfire Ridge or Level 93.";
GARRISON_TOWN_HALL_HORDE_UPGRADE_TIER2_TOOLTIP = "%sRequires:%s Level 100.";
GARRISON_TOWN_HALL_LEVEL1_DESCRIPTION = "Unlocks access to a large and small building plot.";
GARRISON_TOWN_HALL_LEVEL2_DESCRIPTION = "Unlocks access to a medium and additional small building plot. Also unlocks access to Small, Medium and Large buildings.";
...
ITEM_COMPARISON_CYCLING_DISABLED_MSG_MAINHAND = "Visit the Key Bindings menu to enable cycling through your main-hand items.";
ITEM_COMPARISON_CYCLING_DISABLED_MSG_OFFHAND = "Visit the Key Bindings menu to enable cycling through your off-hand items.";
...
MANA_REGEN_FROM_SPIRIT = "Mana regeneration in combat %d";
...
NPE_CLICKLOOT = "|cFF00FFFFRight-Click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t on loot to put it in your bag.";
...
NPE_EQUIPITEM = "|cFF00FFFFRight-Click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t to equip this item.";
NPE_EQUIPPEDITEM = "Here is the item you equipped!";
NPE_FINDCORPSE = "Press |cFF00FFFFM|r to open your map and find your corpse.";
...
NPE_LOOTCORPSE = "|cFF00FFFFRight-click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t on sparkling corpses to loot them.";
NPE_LOOTCORPSEQUEST = "|cFF00FFFFRight-click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t on sparkling corpses to loot quest items.";
NPE_MAPCALLOUT = "|TInterface\\WorldMap\\WorldMapArrow:28:28|t marks your location.\n\nGo to the |cff2982fcblue|r area to find your quest objectives.";
NPE_MOREQUESTS = "Another quest is available nearby. Look for the |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\ExclamationPoint:16:16|t";
NPE_MOVE = "Move";
NPE_MOVEMENTCANCELSSPELL = "Moving while casting a spell interrupts it.";
NPE_OPENBAG = "You have a new item! Press |cFF00FFFFB|r to open your bag.";
NPE_OPENCHARACTERSHEET = "Press |cFF00FFFFC|r to view your equipped items.";
NPE_OPENMAP = "Open the map by pressing |cFF00FFFFM|r.";
NPE_QUESTCOMPELTELOCATION = "Go to the |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\TurnIn:0:0:0:0:32:32:0:20:0:20|t to turn in the quest.";
NPE_QUESTCOMPLETE = "Quest Complete! Press |cFF00FFFFM|r to open the map.";
NPE_QUESTCOMPLETEBREADCRUMB = "Press |cFF00FFFFM|r to open the map.";
NPE_QUESTGIVER = "|cFF00FFFFRight-Click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t on the |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\ExclamationPoint:16:16|t to get your first quest.";
...
NPE_USEHEARTHSTONE = "|cFF00FFFFRight-Click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t the Hearthstone |TInterface\\Icons\\inv_misc_rune_01:16|t in your bag to teleport back to your home location.";
NPE_USEQUESTITEM = "|cFF00FFFFRight-Click|r |TInterface\\AddOns\\NewPlayerExperience\\Media\\Textures\\Icons\\RightClick:16|t here to use the item for your quest.";
...
OBJECT_NPC_OUTLINE_MODE_ONE = "None";
OBJECT_NPC_OUTLINE_MODE_THREE = "Mouseover and Target";
OBJECT_NPC_OUTLINE_MODE_TWO = "Mouseover Only (Default)";
OFF = "Off";
OFFICER = "Officer";
...
OPTION_TOOLTIP_COMBAT_TARGET_MODE_OLD = "Not recomended due to very slow performance";
...
OPTION_TOOLTIP_SHOW_HD_MODELS = "Check this to show new higher definition character models.";
...
SHAMAN_ELE_CORE_ABILITY_4 = "Cast when you have 7 charges of Lightning Shield.";
...
SPELL_FAILED_CUSTOM_ERROR_211 = "Nothing to loot.";
...
SPLASH_NEW_RIGHT_DESC = "Head to the Blasted Lands.\nA new world of adventure awaits beyond the Dark Portal.";
...
WARRIOR_FURY_CORE_ABILITY_3 = "Use when available so the target takes more damage.";
WARRIOR_FURY_CORE_ABILITY_4 = "Use when available.";
WARRIOR_FURY_CORE_ABILITY_5 = "Use when free or you need to spend Rage.";
WARRIOR_FURY_CORE_ABILITY_6 = "Use when the target is near death.";
