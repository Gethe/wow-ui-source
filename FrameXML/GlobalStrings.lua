...
BOOST2_MAGEFROST_ADVANCEDCOMBAT_FROSTBOLT = "Use |cFFFFFFFFFrostbolt|r to gain |cFFFFFFFFFingers of Frost|r or |cFFFFFFFFBrain Freeze|r";
BOOST2_MAGEFROST_ADVANCEDCOMBAT_FROZENORB = "Use |cFFFFFFFFFrozen Orb|r";
BOOST2_MAGEFROST_ADVANCEDCOMBAT_ICELANCE = "Use |cFFFFFFFFIce Lance|r while under the effect of |cFFFFFFFFFingers of Frost|r";
BOOST2_MAGEFROST_AOE_BLIZZARD = "Use |cFFFFFFFFBlizzard|r to eliminate all the oozes at once.";
...
BOOST2_MAGEFROST_PET_WATERELEMENTAL = "Summon your |cFFFFFFFFWater Elemental|r";
...
BOOST2_ROGUESUB_ADVANCEDCOMBAT_BACKSTAB = "Use |cFFFFFFFFBackstab|r to generate |cFFFFFFFFCombo Points|r.";
BOOST2_ROGUESUB_BASICCOMBAT_BACKSTAB = "Use |cFFFFFFFFBackstab|r on the Target Dummy.\n\n|cFFFFFFFFBackstab|r generates 1 |cFFFFFFFFCombo Point|r";
BOOST2_ROGUE_ADVANCEDCOMBAT_EVISCERATE = "Use |cFFFFFFFFEviscerate|r with |cFFFFFFFF5 Combo Points|r.";
BOOST2_ROGUE_ADVANCEDCOMBAT_SHADOWSTRIKE = "Use |cFFFFFFFFShadowstrike|r to engage the Target Dummy.\n\n|cFFFFFFFFShadowstrike|r awards 2 |cFFFFFFFFCombo Points|r.";
BOOST2_ROGUE_ADVANCEDCOMBAT_SHADOWSTRIKE2 = "Use |cFFFFFFFFShadowstrike|r on your target.";
BOOST2_ROGUE_BASICCOMBAT_STEALTH = "Use |cFFFFFFFFStealth|r to go invisible.";
BOOST2_ROGUE_SURVIVABILITY_VANISH = "Use |cFFFFFFFFVanish|r to drop out of combat.";
...
ERR_CHALLENGE_MODE_RESET_KEYSTONE = "[PH] You cannot reset this challenge mode because an engergized keystone was used.";
...
OPTION_TOOLTIP_SELF_HIGHLIGHT = "Highlight your character.";
OPTION_TOOLTIP_SELF_HIGHLIGHT_IN_BG = "Highlight your character in Battlegrounds.";
OPTION_TOOLTIP_SELF_HIGHLIGHT_IN_BG_COMBAT = "Only when in combat, highlight your character in Battlegrounds.";
OPTION_TOOLTIP_SELF_HIGHLIGHT_IN_RAID = "Highlight your character in Raids.";
OPTION_TOOLTIP_SELF_HIGHLIGHT_IN_RAID_COMBAT = "Only when in combat, highlight your character in Raids.";
