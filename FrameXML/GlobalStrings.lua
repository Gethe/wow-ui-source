...
EQUIPMENT_MANAGER_COMBAT_SWAP = "Some items from set %s will not be equipped until you leave combat.";
...
SLASH_USE_TALENT_SPEC = "/usetalents";
...
TEAM_SKILL_TOOLTIP = "Team skill is used for matchmaking";
