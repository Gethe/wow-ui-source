...
ABANDON_QUEST_ABBREV = "Abandon"; -- Quit the currently selected quest
...
ACHIEVEMENTFRAME_FILTER_ALL = "All"; -- Display all achievements
ACHIEVEMENTFRAME_FILTER_COMPLETED = "Earned"; -- Display earned achievements
ACHIEVEMENTFRAME_FILTER_INCOMPLETE = "Incomplete"; -- Display unearned achievements
...
ACHIEVEMENT_META_COMPLETED_DATE = "Completed %s"; -- %s is the date an achievement was completed!
ACHIEVEMENT_SUMMARY_CATEGORY = "Summary";
ACHIEVEMENT_TITLE = "Achievement Points";
ACHIEVEMENT_TOOLTIP_COMPLETE = "Achievement earned by %1$s on %2$d/%3$02d/20%4$02d"; -- 1 - name 2 - month 3 - day 4 - year
ACHIEVEMENT_TOOLTIP_IN_PROGRESS = "Achievement in progress by %s";
ACHIEVEMENT_UNLOCKED = "Achievement Earned";
ACHIEVEMENT_UNLOCKED_CHAT_MSG = "Achievement Earned: %s"; -- Chat message that shows up when you have over the max achievement toasts trying to display
...
ACTION_SPELL_AURA_APPLIED_BUFF_FULL_TEXT = "%4$s gains %1$s %2$s."; -- %1$s %2$s strikes %4$s for %5$s.%6$s
ACTION_SPELL_AURA_APPLIED_BUFF_FULL_TEXT_NO_SOURCE = "%4$s gains %2$s."; -- %1$s %2$s strikes %4$s for %5$s.%6$s
...
ACTION_SPELL_AURA_APPLIED_DEBUFF_FULL_TEXT = "%4$s is afflicted by %1$s %2$s."; -- %1$s 
ACTION_SPELL_AURA_APPLIED_DEBUFF_FULL_TEXT_NO_SOURCE = "%4$s is afflicted by %2$s."; -- %1$s 
...
ACTION_SPELL_AURA_BROKEN_BUFF_FULL_TEXT = "%1$s broke %4$s %2$s."; -- OLD: %1$s %2$s was broken by %4$s.
...
ACTION_SPELL_AURA_BROKEN_DEBUFF_FULL_TEXT = "%1$s broke %4$s %2$s."; -- OLD: %1$s %2$s was broken by %4$s.
...
ACTION_SPELL_DAMAGE_FULL_TEXT_NO_SOURCE = "%2$s hit %4$s for %5$s.%6$s";
...
ACTION_SPELL_PERIODIC_MISSED_ABSORB_FULL_TEXT = "%1$s %2$s was absorbed by %4$s for a moment.%6$s";
ACTION_SPELL_PERIODIC_MISSED_ABSORB_FULL_TEXT_NO_SOURCE = "%2$s was absorbed by %4$s for a moment.%6$s";
...
ACTION_SPELL_PERIODIC_MISSED_IMMUNE_FULL_TEXT = "%4$s was immune to %1$s %2$s for a moment.%6$s";
ACTION_SPELL_PERIODIC_MISSED_IMMUNE_FULL_TEXT_NO_SOURCE = "%4$s was immune to %2$s for a moment.%6$s";
...
ACTIVATE = "Activate"; -- Generic text meaning "turn this on"
ADD = "Add";
...
AGI = "Agi"; -- Abbrivation for Agility
...
ARENA_OFF_SEASON_TEXT = "Arena Season %d has come to an end!|n|nDuring the week after the close of the arena season all titles and rewards will be awarded.|n|nBe sure to check with arena organizers for information about the start of Season %d!"; -- Displays on PVP panel, not Arena Masters
...
AUCTION_ITEM_INCOMING_AMOUNT = "Incoming Amount"; -- Label for the amount of money pending
AUCTION_ITEM_SOLD = "%s - Sold"; -- Used in the auction frame when an item has sold
AUCTION_ITEM_TEXT = "Drag an item here to auction it";
AUCTION_ITEM_TIME_UNTIL_DELIVERY = "%s Until Delivery"; -- Used to tell when
...
BINDING_NAME_MULTICASTACTIONBUTTON1 = "Call of Fire - Earth Totem";
BINDING_NAME_MULTICASTACTIONBUTTON10 = "Call of Air - Fire Totem";
BINDING_NAME_MULTICASTACTIONBUTTON11 = "Call of Air - Water Totem";
BINDING_NAME_MULTICASTACTIONBUTTON12 = "Call of Air - Air Totem";
BINDING_NAME_MULTICASTACTIONBUTTON2 = "Call of Fire - Fire Totem";
BINDING_NAME_MULTICASTACTIONBUTTON3 = "Call of Fire - Water Totem";
BINDING_NAME_MULTICASTACTIONBUTTON4 = "Call of Fire - Air Totem";
BINDING_NAME_MULTICASTACTIONBUTTON5 = "Call of Water - Earth Totem";
BINDING_NAME_MULTICASTACTIONBUTTON6 = "Call of Water - Fire Totem";
BINDING_NAME_MULTICASTACTIONBUTTON7 = "Call of Water - Water Totem";
BINDING_NAME_MULTICASTACTIONBUTTON8 = "Call of Water - Air Totem";
BINDING_NAME_MULTICASTACTIONBUTTON9 = "Call of Air - Earth Totem";
BINDING_NAME_MULTICASTRECALLBUTTON1 = "Call of Earth";
BINDING_NAME_MULTICASTSUMMONBUTTON1 = "Call of Fire";
BINDING_NAME_MULTICASTSUMMONBUTTON2 = "Call of Water";
BINDING_NAME_MULTICASTSUMMONBUTTON3 = "Call of Air";
...
BONUS_DAMAGE_ABBR = "B. Dmg"; -- Abbrivation for Bonus Damage
BONUS_HEALING = "Bonus Healing";
BONUS_HEALING_ABBR = "B. Heal"; -- Abbriviation for Bonus Healing
...
CALENDAR_ANNOUNCEMENT_CREATEDBY_PLAYER = "Created by %s"; -- %s=player name
...
CALENDAR_ERROR_CREATEDATE_AFTER_MAX = "You cannot create events after %2$s %4$d."; -- 1=weekdayName 2=monthName 3=day 4=year 5=month
...
CALENDAR_ERROR_EVENTS_EXCEEDED = "You have reached your limit of %d |4created event:created events."; -- %d=max number of created events
...
CALENDAR_ERROR_EVENT_THROTTLED = "The speed that events can be created is limited, please wait to create another event."; -- This is sent if the user somehow is able to create too many events per second.
...
CALENDAR_ERROR_GUILD_EVENTS_EXCEEDED = "Your guild has reached the limit of %d |4created event:created events."; -- %d=max number of created events
...
CALENDAR_ERROR_INVITES_EXCEEDED = "You cannot invite more than %d |4player:players; to this event."; -- %d=max number of invites
CALENDAR_ERROR_INVITE_THROTTLED = "The number of invites that can be sent is limited, please wait to send another invite."; -- This is sent if the user somehow is able to send too many invites per second.
...
CALENDAR_ERROR_NO_GUILD_INVITES = "Invites to guild members are not allowed."; -- Guild sign up events do not allow invites sent to guild members.
...
CALENDAR_EVENTNAME_FORMAT_END = "%s Ends"; -- %s = Event Name
CALENDAR_EVENTNAME_FORMAT_RAID_LOCKOUT = "%s Unlocks"; -- %s = Raid Name
CALENDAR_EVENTNAME_FORMAT_RAID_RESET = "%s Resets"; -- %s = Raid Name
CALENDAR_EVENTNAME_FORMAT_START = "%s Begins"; -- %s = Event Name
CALENDAR_EVENT_ALARM_MESSAGE = "%s begins in 15 minutes."; -- Alerts the player that an event they are invited to begins soon. %s = event title
CALENDAR_EVENT_CREATORNAME = "Created by %s";
CALENDAR_EVENT_DESCRIPTION = "Description";
CALENDAR_EVENT_INVITEDBY_PLAYER = "Invited by %s"; -- %s=player name
CALENDAR_EVENT_INVITEDBY_YOURSELF = "This is your event";
CALENDAR_EVENT_NAME = "Name";
CALENDAR_EVENT_PICKER_TITLE = "Select an Event";
CALENDAR_EVENT_REMOVED_MAIL_BODY = "%s cancelled %s. (%s)"; -- Body text for mail sent when an event is removed.
CALENDAR_EVENT_REMOVED_MAIL_SUBJECT = "%s cancelled."; -- Subject header for mail sent when an event is removed.
CALENDAR_FILTERS = "Filters";
CALENDAR_FILTER_BATTLEGROUND = "Battleground Holidays"; -- Description of flag in the Player Calendar UI.
CALENDAR_FILTER_DARKMOON = "Darkmoon Faire"; -- Description of flag in the Player Calendar UI.
CALENDAR_FILTER_RAID_LOCKOUTS = "Active Raid Lockouts"; -- Description of flag in the Player Calendar UI.
CALENDAR_FILTER_RAID_RESETS = "Raid Resets"; -- Description of flag in the Player Calendar UI.
CALENDAR_FILTER_WEEKLY_HOLIDAYS = "Weekly Holidays"; -- Description of flag in the Player Calendar UI.
...
CALENDAR_INVITELIST_CREATORNAME = "%s (Creator)"; -- %s = player name
...
CALENDAR_INVITE_MEMBERS = "Invite Members"; -- Text for the button that invites event invitees to a party or raid.
CALENDAR_INVITE_PLAYER = "Invite Player";
CALENDAR_INVITE_REMOVED_MAIL_BODY = "%s has removed you from %s. (%s)"; -- Body text for mail sent when an event is removed.
CALENDAR_INVITE_REMOVED_MAIL_SUBJECT = "You have been removed from %s."; -- Subject header for mail sent when an event is removed.
...
CALENDAR_RAID_LOCKOUT_DESCRIPTION = "Your %1$s instance unlocks at %2$s."; -- 1=name 2=formatted time
CALENDAR_RAID_RESET_DESCRIPTION = "%1$s resets at %2$s."; -- 1=name 2=formatted time
...
CALENDAR_SIGNEDUP_FOR_GUILDEVENT_WITH_STATUS = "Signed up (%s)"; -- %s=invite status (only if your status is not Signed Up e.g. Confirmed, Out, Standby)
CALENDAR_SIGNUP = "Sign Up "; -- Button and context menu text for Guild Sign Up events.
...
CALENDAR_STATUS_NOT_SIGNEDUP = "Not Signed Up"; -- A player can see the event in his calendar but is not on the invite list for it.
CALENDAR_STATUS_OUT = "Out";
CALENDAR_STATUS_SIGNEDUP = "Signed Up"; -- A player has signed up for an event.
...
CALENDAR_TOOLTIP_INVITE_RESPONDED = "Responded on:"; -- Tooltip over a calendar event invitee which is followed by the date and time the invitee responded to the event.
...
CALENDAR_VIEW_EVENTTITLE_LOCKED = "|cff7f7f7f%s|r |cffffd200(Locked)|r"; -- %s is the name of the event. Locked means you cannot RSVP to the event.
...
CHAT_GUILD_GET = "|Hchannel:Guild|h[Guild]|h %s:\32"; -- Guild message from player %s
...
CHAT_OFFICER_GET = "|Hchannel:o|h[Officer]|h %s:\32"; -- Officer chat from player %s. Replace o with whatever slash command starts officer chat
...
CHAT_PARTY_GET = "|Hchannel:Party|h[Party]|h %s:\32"; -- Party message from player %s
...
CHAT_YOU_JOINED_NOTICE = "Joined Channel: |Hchannel:%d|h[%s]|h"; -- You joined
CHAT_YOU_LEFT_NOTICE = "Left Channel: |Hchannel:%d|h[%s]|h"; -- You left
...
COLORBLIND_NAMEWRAPPER_FRIENDLY = "%s - Friendly"; -- Wraps in-game names and titles of friendly units when colorblind mode is enabled
...
COMBAT_TEXT_BLOCK = "Block"; -- Block an attack
COMBAT_TEXT_COMBO_POINTS = "<%d Combo |4Point:Points;>";
COMBAT_TEXT_DEFLECT = "Deflect";
COMBAT_TEXT_DODGE = "Dodge"; -- Dodge an attack
COMBAT_TEXT_EVADE = "Evade"; -- Evade, first letter capitalized
COMBAT_TEXT_FLOAT_MODE_LABEL = "Combat Text Float Mode";
COMBAT_TEXT_HONOR_GAINED = "Honor %s";
COMBAT_TEXT_IMMUNE = "Immune"; -- Immune to a spell
COMBAT_TEXT_LABEL = "Floating Combat Text";
COMBAT_TEXT_MISS = "Miss"; -- Miss on an attack
COMBAT_TEXT_NONE = "None";
COMBAT_TEXT_PARRY = "Parry"; -- Parry an attack
COMBAT_TEXT_REFLECT = "Reflect";
COMBAT_TEXT_RESIST = "Resist"; -- Resisted a spell
...
COMPARE_ACHIEVEMENTS = "Compare Achievements"; -- Used in the target dropdown menu for comparing achievements
...
CONFIRM_LEARN_PREVIEW_TALENTS = "Are you sure you want to learn these talents?"; -- TEMP TEXT- do not translate
CONFIRM_LEAVE_QUEUE = "Are you sure you would like to leave the meeting stone queue?";
CONFIRM_LFG_REMOVE_LAST_ROLE = "Removing your last role will cause you to leave all Looking For Group queues. Do you want to remove your last role?";
...
CONFIRM_RESET_INTERFACE_SETTINGS = "Do you want to reset all user interface and addon settings to their defaults, or only the settings for this category or addon?"; -- Message presented to users when they press the Defaults button in the interface options window
...
CRIT_ABBR = "Crit"; -- Abbriviation for Critcal (as in Critical Hit)
...
DAMAGER = "Damage"; -- Someone who deals damage is the...
...
DEBUFF_SYMBOL_CURSE = "Cu"; -- Up to two characters, overlayed on debuffs in colorblind mode
DEBUFF_SYMBOL_DISEASE = "Di"; -- Up to two characters, overlayed on debuffs in colorblind mode
DEBUFF_SYMBOL_MAGIC = "Ma"; -- Up to two characters, overlayed on debuffs in colorblind mode
DEBUFF_SYMBOL_POISON = "Po"; -- Up to two characters, overlayed on debuffs in colorblind mode
...
DEFENSE = "Defense";
DEFENSE_ABBR = "Def"; -- Abbrivation for Defense
...
DMG = "Dmg"; -- Abbriviation for Damage
DND = "DND";
...
DUNGEON_DIFFICULTY_5PLAYER = "5 Player"; -- This will replace string 16202.
DUNGEON_DIFFICULTY_5PLAYER_HEROIC = "5 Player (Heroic)"; -- This will replace string 16203.
DUNGEON_FLOOR_COTSTRATHOLME0 = "Outside Stratholme";
...
DURABILITY_ABBR = "Dura"; -- Abbrivation for Durability
...
ENABLE_DSP_EFFECTS = "Death Knight Voices"; -- Sound Option
...
ENABLE_SOFTWARE_HRTF = "Headphone mode"; -- Sound Option
...
ENCHANT_ITEM_MIN_SKILL = "Enchantment Requires %s (%d)"; -- Required skill rank to use the item
ENCHANT_ITEM_REQ_LEVEL = "Enchantment Requires Level %d"; -- Required player level to use the item
ENCHANT_ITEM_REQ_SKILL = "Enchantment Requires %s"; -- Required skill to use the item
...
ENCRYPTED = "Encrypted"; -- Used in tooltips for encrypted items
...
EQUIPSET_EQUIP = "Equip"; -- Button to equip the selected equipment set.
...
ERR_INVITED_ALREADY_IN_GROUP_SS = "|Hplayer:%s|h[%s]|h invited you to a group, but you could not accept because you are already in a group."; -- The name is passed in twice to accomodate player name links - "|Hplayer:%s|h[%s]|h" should not be localized.
...
ERR_ITEM_MAX_LIMIT_CATEGORY_SOCKETED_EXCEEDED_IS = "You can only equip %d items in the %s category";
...
ERR_LEARN_COMPANION_S = "You have added the pet %s to your collection."; -- %s is the companion name
...
ERR_MULTI_CAST_ACTION_TOTEM_S = "Only %s spells can go in that slot."; -- Displayed when you put a non-totem spell in a multi-cast totem action slot.
...
ERR_OUT_OF_POWER_DISPLAY = "Not enough %s"; -- Ex: "Not enough Ammo"
...
ERR_PET_LEARN_ABILITY_S = "Your pet has learned a new ability: %s."; -- %s is the ability name
ERR_PET_LEARN_SPELL_S = "Your pet has learned a new spell: %s."; -- %s is the spell name
...
ERR_PURCHASE_LEVEL_TOO_LOW = "You must reach level %d to purchase that item."; -- %d is the level number.
...
EXPERTISE_ABBR = "Expr"; -- Abbrivation for Expertise
EXTENDED = "|cff00ff00Extended|r"; -- Raid lock has been extended
...
FEATURES_LABEL = "Features|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
FLOOR = "Areas"; -- Dungeon Map Level
FLOOR_NUMBER = "Area %d"; -- Dungeon Map Level
...
FROM = "From:";
FUEL = "Fuel";
FULLDATE = "%1$s, %2$s %3$d %4$d"; -- 1=weekdayName 2=monthName 3=day 4=year 5=month
...
GAMMA = "Gamma";
GEARSETS_POPUP_TEXT = "Enter Set Name (Max 16 Characters):"; -- Text for the gear manager popup
...
GENERAL_SPELLS = "General"; -- Name for the general spell tab
...
GLYPHS = "Glyphs";
GLYPH_EMPTY = "Empty"; -- Glyph State
GLYPH_EMPTY_DESC = "Use a Glyph from your inventory to inscribe your spellbook.";
GLYPH_FILLED = "Filled"; -- Glyph state
GLYPH_INACTIVE = "Empty"; -- Glyph slot state
GLYPH_LOCKED = "Locked"; -- Glyph State
...
GM_RESPONSE_MORE_HELP = "Need More Help"; -- Button text that indicates the player has needs to open another ticket after receiving a GM response to a ticket.
...
GM_RESPONSE_RESOLVE = "Message Read"; -- Button text that indicates the player has finished reading a GM response to a ticket.
...
GOLD_AMOUNT_SYMBOL = "g"; -- For colorblind mode, replaces the icons
...
HELPFRAME_OPENTICKET_FOLLOWUPTEXT = "Describe Your Follow-Up Issue:"; -- Header for the Open Ticket window if a player chooses that he needs more help from a GM response.
...
IGNORE = "Ignore";
IGNORED = "Ignored";
IGNORE_DIALOG = "Ignore"; -- "Ignore" referring to dialog boxes rather than to players
IGNORE_ERRORS = "Ignore"; -- Ignore Lua errors for StaticPopup
...
INBOX = "Inbox";
INBOX_TOO_MUCH_MAIL = "Not all of your mail could be delivered.|nPlease delete some mail to make room.";
...
INSTANCE_DIFFICULTY_FORMAT = "(%s)"; -- Used to create, for example, "(10 Player)"
INSTANCE_ID = "Instance ID: %d";
INSTANCE_LEAVE = "Leave Instance";
INSTANCE_LOCK_TIMER = "You have entered an instance already in progress! You will be saved to %1$s %2$s in %3$s!"; -- 1=instance name 2="(difficulty name)" (DUNGEON_DIFFICULTY or RAID_DIFFICULTY) 3=time remaining
INSTANCE_LOCK_TIMER_PREVIOUSLY_SAVED = "You have entered an |cffffd200extended|r instance. You will be saved to %1$s %2$s in %3$s!"; -- 1=instance name 2="(difficulty name)" (DUNGEON_DIFFICULTY or RAID_DIFFICULTY) 3=time remaining
...
INT = "Int"; -- Abbrivation for Intellect
...
ITEMS = "|4Item:Items;"; -- Generic "items"
...
ITEM_LEVEL = "Item Level %d"; -- The actual level of the item
...
ITEM_QUALITY7_DESC = "Heirloom"; -- Item quality for "Heirloom" items
...
ITEM_REQ_ARENA_RATING_3V3 = "Requires personal and team arena rating of %d|nin 3v3 or 5v5 brackets"; -- %d is the rating number required
ITEM_REQ_ARENA_RATING_5V5 = "Requires personal and team arena rating of %d|nin 5v5 brackets"; -- %d is the rating number required
...
LATEST_UNLOCKED_ACHIEVEMENTS = "Recent Achievements"; -- Title for the summary page of the achievements frame
LATEST_UPDATED_STATS = "Latest Updated Statistics"; -- Title for the summary page of the achievement frame
LAUGH_WORD1 = "lol";
LAUGH_WORD2 = "rofl";
LAUGH_WORD3 = "hehe";
LAUGH_WORD4 = "haha";
...
LOCK_EXPIRE = "Lock Expire"; -- Raid lock expiration
...
MAIL_COD_ERROR_COLORBLIND = "C.O.D. must be <= %1$d%2$s"; -- %1: Amount, %2: gold symbol
MAIL_LABEL = "Mail";
...
MANA_REGEN_ABBR = "Regen"; -- Abbriviation for Regeneration
...
MASTERY_POINTS_SPENT = "%1$s Talents: %2$s"; -- 1=name of talent tree 2=talent points
...
MINS_ABBR = "Mins"; -- Abbrivation for Minutes (no %d)
...
MULTI_CAST_TOOLTIP_NO_TOTEM = "No Totem"; -- Tooltip displayed when you mouse over the No Totem button in the Totem Bar's totem slot menu.
...
NEW_ACHIEVEMENT_EARNED = "You have earned the achievement '%s'."; -- This will be the message when you get a new achievement.
...
NO_ROLE_SELECTED = "You must select one or more roles before you can join Looking For Group or Looking For More.";
...
OBJECTIVES_TRACKER_LABEL = "Objectives"; -- label for the top of the achievment/quest tracker
OBJECTIVES_VIEW_ACHIEVEMENT = "Open Achievement";
OBJECTIVES_VIEW_IN_ACHIEVEMENTS = "Open Achievements";
OBJECTIVES_VIEW_IN_QUESTLOG = "Open Quest Log";
...
OUT_OF_POWER_DISPLAY = "Not enough %s"; -- Ex: "Not enough Ammo"
...
PAPERDOLLFRAME_TOOLTIP_FORMAT = "%s"; -- Allows for localization formatting of the tooltip headers on the paper doll stat windows.
...
PLAYER_LIST_DELIMITER = ", "; -- Used to separate lists of player names in ERR_PLAYERLIST_LEFT_BATTLE. This string is edited in FrameXML\Localization.lua in some languages due to bug  158181
...
POWER_ABBR = "PWR"; -- Abbrivation for Power (as in Attack Power)
POWER_DISPLAY_COST = "%d %s"; -- Ex: "30 Ammo"
POWER_DISPLAY_COST_PER_TIME = "%d %s, plus %d per sec"; -- Ex: "30 Ammo, plus 10 per sec"
...
POWER_TYPE_PYRITE = "Pyrite"; -- Used in Ulduar Raid Encounter
POWER_TYPE_STEAM = "Steam Pressure"; -- Used in Ulduar Raid Encounter
PREFERENCES = "Preferences";
PREV = "Prev"; -- Abbreviation for "previous"
PREVIEW_TALENT_CHANGES = "Preview Talent Changes|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t"; -- UIOptionsFrame check button for whether or not to allow the Talent Calculator feature on the Talent UI
...
QUEST_DETAILS = "Quest Details"; -- Screen that shows details for a selected quest
...
QUEST_PLAYERS_KILLED = "Players slain: %d/%d"; -- Lists the players killed for the selected quest
QUEST_PLAYERS_KILLED_NOPROGRESS = "Players x %d"; -- Lists the players killed for the selected quest
...
RAID_DIFFICULTY_10PLAYER = "10 Player"; -- This will replace string 19985.
RAID_DIFFICULTY_10PLAYER_HEROIC = "10 Player (Heroic)"; -- This will replace string 19987.
RAID_DIFFICULTY_20PLAYER = "20 Player";
RAID_DIFFICULTY_25PLAYER = "25 Player"; -- This will replace string 19986.
RAID_DIFFICULTY_25PLAYER_HEROIC = "25 Player (Heroic)"; -- This will replace string 19988.
...
RAID_INSTANCE_EXPIRES = "Expires in %1$s"; -- 1 - expiry time
RAID_INSTANCE_EXPIRES_EXPIRED = "Expired";
RAID_INSTANCE_EXPIRES_EXTENDED = "Expires in %1$s (extended)"; -- 1 - expiry time
...
REFUND_TIME_REMAINING = "You may sell this item to a vendor within %s for a full refund."; -- Time remaining to get a refund on an item. Example: "You may sell this item to a vendor within 1 hour 30 minutes for a full refund."
RELICSLOT = "Relic";
REMOVE = "Remove";
...
RESILIENCE_ABBR = "Resil"; -- Abbrivation for Resiliance
...
ROLE = "Role"; -- E.g. tanking, healing, dps
ROLE_DESCRIPTION1 = "Indicates that you are willing to take on the role of dealing damage to enemies."; -- Damage description
ROLE_DESCRIPTION2 = "Indicates that you are willing to protect allies from harm by ensuring that enemies are attacking you instead of them."; -- Tank description
ROLE_DESCRIPTION3 = "Indicates that you are willing to heal your allies when they take damage."; -- Healer description
...
RUNIC_POWER = "Runic Power"; -- Generic "runic power"
...
SHARDS = "Shards"; -- Short hand for Soul Shards
...
SHOW_CLASS_COLOR_IN_V_KEY = "Class Colors in Nameplates"; -- option to display class colors in the Nameplates (v-key)
...
SHOW_ITEM_LEVEL = "Show Item Level|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SHOW_ON_BACKPACK = "Show on Backpack"; -- Used in the token UI options to show a token type on the backpack
...
SHOW_QUEST_OBJECTIVES_ON_MAP_TEXT = "Show Quest Objectives On Map|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SLASH_DUMP1 = "/dump"; -- Debug command for printing Lua expressions to the chat frame
SLASH_DUMP2 = "/dump"; -- Debug command for printing Lua expressions to the chat frame
...
SLASH_EQUIP3 = "/equip";
SLASH_EQUIP4 = "/eq";
SLASH_EQUIP_SET1 = "/equipset"; -- Gear Sets!
SLASH_EQUIP_SET2 = "/equipset"; -- Gear Sets!
SLASH_EQUIP_TO_SLOT1 = "/equipslot";
SLASH_EQUIP_TO_SLOT2 = "/equipslot";
SLASH_EVENTTRACE1 = "/eventtrace"; -- Displays a window containing game events for debugging addons
SLASH_EVENTTRACE2 = "/eventtrace"; -- Displays a window containing game events for debugging addons
...
SLASH_FOLLOW6 = "/fol";
SLASH_FOLLOW7 = "/f";
SLASH_FRAMESTACK1 = "/framestack"; -- Lua debug command for displaying frames underneath the cursor in the user interface.
...
SLASH_RELOAD1 = "/reload"; -- Debug slash command for reloading the user interface
SLASH_RELOAD2 = "/reload"; -- Debug slash command for reloading the user interface
...
SLASH_STOPWATCH_PARAM_PLAY1 = "play"; -- Used as a parameter to /stopwatch to make it play.
SLASH_STOPWATCH_PARAM_PLAY2 = "play";
SLASH_STOPWATCH_PARAM_STOP1 = "stop"; -- Used as a parameter to /stopwatch to make it stop.
SLASH_STOPWATCH_PARAM_STOP2 = "clear"; -- Used as a parameter to /stopwatch to make it stop.
SLASH_STOPWATCH_PARAM_STOP3 = "reset"; -- Used as a parameter to /stopwatch to make it stop.
...
SOCKET_ITEM_MIN_SKILL = "Socket Requires %s (%d)"; -- Required skill rank to use the item
SOCKET_ITEM_REQ_LEVEL = "Socket Requires Level %d"; -- Required player level to use the socket
SOCKET_ITEM_REQ_SKILL = "Socket Requires %s"; -- Required skill to use the item
...
SPEED_ABBR = "SPD"; -- Abbrivation for Speed
...
SPELL_FAILED_CUSTOM_ERROR_10 = "You cannot summon another gargoyle yet."; -- Fires whenever the player has the summoned ghoul debuff on.
SPELL_FAILED_CUSTOM_ERROR_11 = "Requires Corpse Dust if the target is not dead and humanoid."; -- Fires whenever the player has the summoned ghoul debuff on.
SPELL_FAILED_CUSTOM_ERROR_12 = "Can only be placed near Shatterhorn"; -- Warns players that they're not close enough to Shatterhorn or that he hasn't spawned yet.
...
SPELL_FAILED_CUSTOM_ERROR_18 = "Must be used near an oil slick."; -- Informs player that they're too far from an oil slick or they have the wrong target.
...
SPELL_FAILED_CUSTOM_ERROR_52 = "The target must be bound to you."; -- This is meant in terms of "enthrallment", e.g. the ghoul is not bound to you (Death Knight Error message)
...
SPELL_FAILED_CUSTOM_ERROR_65 = "Only GMs may use that. Your account has been reported for investigation."; -- There's no actual reporting feature. It's there to scare the user. Yes, I am that evil.
SPELL_FAILED_CUSTOM_ERROR_66 = "You must reach level 58 to use this portal."; -- Used for the portals to Hellfire Pen
SPELL_FAILED_CUSTOM_ERROR_67 = "You already have the maximum amount of honor."; -- Triggered when using a consumeable that grants honor and you are already at the honor cap.
SPELL_FAILED_CUSTOM_ERROR_7 = "You must target a weakened chill nymph."; -- You must target a weakened chill nymph.
SPELL_FAILED_CUSTOM_ERROR_75 = "You must have a demonic circle active."; -- When you try to use Demonic Circle: Teleport with no demonic circle down.
SPELL_FAILED_CUSTOM_ERROR_76 = "You already have maximum rage";
SPELL_FAILED_CUSTOM_ERROR_8 = "The Imbued Scourge Shroud will only work when equipped in the Temple City of En'kilah."; -- For the Shroud of the Scourge quest item in Borean Tundra.
...
SPELL_FAILED_NEED_MORE_ITEMS = "Requires %d %s."; -- %d is the number of %s's required to prospect or mill this type of material.
...
SPELL_USE_ALL_POWER_DISPLAY = "Uses 100% %s"; -- Ex: "Uses 100% Ammo"
SPELL_USE_ALL_RAGE = "Uses 100% rage";
SPI = "Spi"; -- Abbrivation for Spirit
...
STA = "Sta"; -- Abbrivation for Stamina
STABLED_PETS = "Stabled Pets:";
STABLES = "Stables";
STABLE_PET_INFO_TEXT = "%1$s Level %2$d %3$s|n%4$s"; -- 1=name 2=level 3=family 4=talent tree
STABLE_PET_INFO_TOOLTIP_TEXT = "Level %1$d %2$s|n%3$s"; -- 1=level 2=family 3=talent tree
...
STR = "Str"; -- Abbrivation for Strength
...
STRING_SCHOOL_SHADOWSTORM = "Shadowstorm";
...
TALENT_SPECTAB_TOOLTIP_POINTS_SPENT = "%1$s%2$s: %3$s%4$d points|r"; -- 1=tab name color code 2=tab name 3=points spent color code 4=points spent
TALENT_SPEC_ACTIVATE = "Activate These Talents";
TALENT_SPEC_PET_PRIMARY = "Pet Talents";
TALENT_SPEC_PRIMARY = "Primary Talents"; -- Name of your primary talent spec
TALENT_SPEC_PRIMARY_GLYPH = "Primary Glyphs"; -- Name of your primary talent spec's glyphs
TALENT_SPEC_SECONDARY = "Secondary Talents"; -- Name of your secondary talent spec
TALENT_SPEC_SECONDARY_GLYPH = "Secondary Glyphs"; -- Name of your secondary talent spec's glyphs
TALENT_TOOLTIP_ADDPREVIEWPOINT = "Left click to add a point"; -- Tooltip on a talent button to add a preview point to the talent
TALENT_TOOLTIP_LEARNTALENTGROUP = "Click to finalize your preview talent points."; -- TEMP TEXT - DO NOT TRANSLATE YET
TALENT_TOOLTIP_REMOVEPREVIEWPOINT = "Right click to remove a point"; -- Tooltip on a talent button to remove a preview point from the talent
TALENT_TOOLTIP_RESETTALENTGROUP = "Click to reset your preview talent points."; -- TEMP TEXT - DO NOT TRANSLATE YET
TALENT_TRAINER = "Talent Trainer"; -- Talent Trainer title
TAMEABLE = "Tameable";
TAMEABLE_EXOTIC = "Tameable (Exotic)";
TANK = "Tank"; -- The party role
TARGET = "Target";
...
TIME_UNIT_DELIMITER = " "; -- This is the symbol between two units of time. For example "5 Hours-> <-16 Minutes". (Usually a space)
...
TRADESKILL_SERVICE_PASSIVE = "Passive"; -- Passive abilities
...
TUTORIAL31 = "You now have a hearthstone.  Hearthstones can be used to transport you from your current location to the last Inn that you acquired the hearthstone from.  You can only use your hearthstone once every 30 minutes.";
...
TUTORIAL47 = "You have gained access to the totem bar! You will gain an action button on this bar whenever you gain access to a new totem element. This bar can hold one totem spell per totem element and it includes a special button to let you cast all of your totem bar spells at once.";
...
TUTORIAL52 = "Congratulations, you have received your first companion. This little fellow will follow you during all of your adventures in Azeroth and beyond. You can see all of your companions on the character pane under the pets tab.";
...
TUTORIAL54 = "You have attracted the attention of a hostile creature. A red glow means the creature is attacking you. A yellow glow means you are in danger of being attacked. An orange glow means the creature is attacking you, but may soon change targets.";
...
TUTORIAL_TITLE52 = "Cosmetic Pets";
TUTORIAL_TITLE53 = "Mounts";
TUTORIAL_TITLE54 = "Threat Warnings";
TUTORIAL_TITLE55 = "Totem Bar";
...
UNABLE_TO_REFUND_ITEM = "Sorry, unable to refund that item."; -- Message displayed when in-game item refund fails.
...
UNITNAME_SUMMON_TITLE10 = "%s's Mount"; -- For when we want to lie about what vehicles are. :)
UNITNAME_SUMMON_TITLE11 = "%s's Lightwell"; -- For Lightwell! duh
...
UNITNAME_SUMMON_TITLE7 = "%s's Construct"; -- For Gargoyles
UNITNAME_SUMMON_TITLE8 = "%s's Opponent"; -- Death Knight race!
UNITNAME_SUMMON_TITLE9 = "%s's Vehicle"; -- Mechanical Summoned Vehicles
...
UNIT_SKINNABLE_BOLTS = "Requires Engineering"; -- The unit is a dead creature which can be skinned for its engineering parts
...
UNMUTE = "Unmute";
UNSPENT_TALENT_POINTS = "Unspent Talents: %s"; -- %s=points
...
USE_COLON = "Use:";
USE_COLORBLIND_MODE = "Colorblind Mode"; -- UI option to enable additional features for those with colorblindness
USE_ENGLISH_AUDIO = "Use English Audio";
USE_EQUIPMENT_MANAGER = "Use Equipment Manager|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
VEHICLE_LEAVE = "Leave"; -- Makes the player leave the current vehicle.
VEHICLE_STEAM = "Steam"; -- Used for the steam engine
...
VIDEO_QUALITY_S = "Video Quality: %s"; -- Used with VIDEO_QUALITY_LABEL1-5 for the video quality slider.
...
WORLD_PVP_ENTER = "You have been called to join the Wintergrasp battle!|nJoin now?";
