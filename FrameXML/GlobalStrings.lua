...
SPELL_FAILED_CUSTOM_ERROR_281 = "Your Wardrobe already contains these appearances";
...
TRANSMOGRIFY_INVALID_CANNOT_USE = "[PH] You don't meet the transmog requirements for the item.";
...
TRANSMOGRIFY_INVALID_MISMATCH = "This armor type isn't compatible with this transmog.";
...
TRANSMOGRIFY_STYLE_UNCOLLECTED = "You haven't collected this transmog yet.";
...
TRANSMOG_REQUIRED_ABILITY = "%s required to use this transmog.";
TRANSMOG_REQUIRED_FACTION = "%s - %s reputation required to use this transmog.";
TRANSMOG_REQUIRED_LEVEL = "Level %d required to use this transmog.";
TRANSMOG_REQUIRED_SKILL = "%s (%d) required to use this transmog.";
