...
AJ_ZONE_CONTINUE = "Continue questing in %s to gain experience and gear appropriate to your character's level.";
...
GARRISON_SHIPYARD_DANGEROUS_MISSION_LABEL = "Dangerous Misson";
GARRISON_SHIPYARD_DANGEROUS_MISSION_TOOLTIP_TEXT = "If you fail this mission, each boat has a 50%% chance to be permanently destroyed on the mission.";
GARRISON_SHIPYARD_DANGEROUS_MISSION_TOOLTIP_TITLE = "Boat Safety";
GARRISON_SHIPYARD_DANGEROUS_MISSION_WARNING = "|n %s  |cffff2020WARNING!|r  %s |n|nYou are about to embark on a dangerous mission. If you fail, each of your ships on the mission has a 50%% chance to be destroyed.";
...
GARRISON_SHIPYARD_MISSION_REPORT = "Shipyard\nMission Report";
