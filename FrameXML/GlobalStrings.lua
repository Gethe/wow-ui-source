...
ERR_CANT_USE_ITEM_IN_ARENA = "You can't use that item in an arena or rated battleground.";
...
ERR_REFUND_RESULT_EXCEED_MAX_CURRENCY = "Sorry, unable to refund that item. Refunding that item would exceed that currency's cap. ";
...
SPELL_FAILED_NOT_IN_ARENA = "You can't do that in an arena or rated battleground.";
