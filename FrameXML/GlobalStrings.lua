...
BINDING_NAME_TOGGLELFGPARENT = "Toggle Dungeons Frame";
...
BUFFOPTIONS_LABEL = "Buffs and Debuffs|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
CALENDAR_FILTER_BATTLEGROUND = "Battleground Holidays";
...
CHAT_OFFICER_GET = "|Hchannel:o|h[Officer]|h %s:\32";
...
CONSOLIDATE_BUFFS_TEXT = "Consolidate Buffs|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
ERR_BATTLEGROUND_JOIN_TIMED_OUT = "Battleground queue timed out";
...
ERR_ITEM_MAX_LIMIT_CATEGORY_EQUIPPED_EXCEEDED_IS = "You can only equip %d items in the %s category";
...
ERR_LFG_PROPOSAL_FAILED = "Someone has declined the dungeon invite. You have been added to the front of the dungeon queue.";
...
ERR_PARTY_LFG_BOOT_COOLDOWN = "You must wait before initiating another player boot.";
ERR_PARTY_LFG_BOOT_IN_PROGRESS = "Another boot vote is already in progress.";
ERR_PARTY_LFG_BOOT_LIMIT = "You can not initiate any more party boots.";
ERR_PARTY_LFG_BOOT_TOO_FEW_PLAYERS = "There are not enough players in the group to initate a vote.";
ERR_PARTY_LFG_BOOT_VOTE_FAILED = "The vote to uninvite %s has failed.";
ERR_PARTY_LFG_BOOT_VOTE_SUCCEEDED = "The vote to uninvite %s has passed.";
...
GREED = "Greed - You'll take the item, but only if nobody else really wants it.";
...
LFD_RANDOM_EXPLANATION = "Using the Dungeons tool to do a Random Dungeon will earn you extra rewards.";
...
LFG_STATISTIC_AVERAGE_WAIT = "The average wait time for %1$s is %2$s";
...
NEAR = "Near";
NECKSLOT = "Neck";
NEED = "Need - You really want the item.";
...
PARTY_LFG_INVITE_RAID_LOCKED = "The player you invited is locked to another instance.";
...
ROLL_DISENCHANT = "Disenchant - You want to Greed the item, but you want it disenchanted if you win the roll.";
...
SHOW_CASTABLE_DEBUFFS_TEXT = "Castable Debuffs|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SLASH_DUMP1 = "/dump";
SLASH_DUMP2 = "/dump";
SLASH_DUNGEONS1 = "/dungeons";
SLASH_DUNGEONS2 = "/dungeons";
SLASH_EMOTE1 = "/e";
SLASH_EMOTE2 = "/em";
SLASH_EMOTE3 = "/emote";
SLASH_EMOTE4 = "/me";
...
TUTORIAL1 = "Get quests by talking to questgivers. Questgivers have exclamation points over their heads. To talk to them, move close and Right Click on them.";
TUTORIAL2 = "Use the ASD and W keys to move your character.";
TUTORIAL3 = "You can turn your character by clicking the Right Mouse Button and moving the mouse. You can look around by clicking the Left Mouse Button and moving the mouse.";
TUTORIAL4 = "Right Click on friendly characters to talk to them. You might need to move closer to them before you can Right Click.";
TUTORIAL5 = "To fight enemies, first use Left Click to target them. Then click on one of the abilities on the action bar across the bottom of your screen. You should use ranged abilities while the target is still far away. Other abilities require you to be close to your target, particularly if your class specializes in melee weapons.";
TUTORIAL6 = "Many of your abilities are weapon attacks or combat spells. Depending on your class you might have defensive abilities or even healing spells on your action bar.";
TUTORIAL7 = "If you defeat an enemy and see sparkles on its corpse, that means it has loot. Right Click on a creature's corpse to loot it. This will open a loot window. Then Right Click on any items in that window to move them to your backpack.";
...
TUTORIAL9 = "Some items can be used. Right Click on an item to use it. You can drag an item onto your action bar if you want to use it without opening your backpack.";
TUTORIAL10 = "You received a bag. Now you will be able to carry more items. Move the bag to an empty bag space next to your backpack. Click on a bag to open it.";
TUTORIAL11 = "You can eat food to gain health faster. Right Click on food to eat it.";
TUTORIAL12 = "You can drink to regain your mana faster. Right Click on a beverage to drink it. You don't need to drink if your class does not use mana.";
...
TUTORIAL14 = "You can go to your class trainer to learn new skills. Trainers are found in many towns or cities and always in your starting area. You may have to search around a little to find your trainer.";
...
TUTORIAL18 = "You can invite another player to your group by Right Clicking their portrait and selecting the Invite option from the popup menu.";
...
TUTORIAL21 = "You can open your quest log by clicking on the golden cup in the middle of the bar across the bottom of the screen.";
TUTORIAL22 = "If there is another player you have enjoyed working with, add them to your friends list! Click on the social button and add them to your list of friends. You can only add friends from your own realm.";
...
TUTORIAL30 = "You are now resting, indicated by your portrait glowing yellow. Time spent resting or logged out gives you a temporary bonus to experience from killing monsters. You can quickly return to inns by using your heathstone.";
...
TUTORIAL34 = "You have completed your first quest! To collect your reward, you need to turn in the quest to a specific questgiver. Usually this is the same questgiver who gave you the quest. You can see nearby questgivers on your minimap.";
...
TUTORIAL36 = "The durability of one of your items is getting low. The paper doll below your minimap indicates the damaged item in yellow. Find a vendor in town to repair the item before it breaks.";
TUTORIAL37 = "One of your items has broken! The paper doll below your minimap indicates the broken item in red. You can get the item repaired by a vendor in town. Until you do, you will gain no benefit from the item.";
...
TUTORIAL44 = "You have obtained a ranged weapon. To use it, equip it, and then open up your spellbook and drag the Shoot or Throw ability into your action bar. Only hunters, warriors and rogues may use ranged weapons. Mages, priests and warlocks may use wands.";
...
TUTORIAL50 = "You now have a keyring to hold your keys.This keyring appears to the left of your bags on your action bar. The keyring can only store permanent keys.";
TUTORIAL51 = "You can enter dungeons or find groups for dungeons by using the Dungeons tool. The Dungeons tool is accessed from the eye button in the middle of your action bar.";
...
TUTORIAL53 = "Congratulations, you have learned how to summon your first mount. This mighty steed will carry you throughout your adventures in Azeroth and beyond. To see all of your mounts, look at the character pane under the pets tab. You can drag your favorite mount onto your action bar to summon it more easily.";
...
TUTORIAL55 = "Congratulations! You just gained a level and became more powerful. You can visit your class trainer and see if he or she has new abilities that you can learn.";
TUTORIAL56 = "In the upper left corner of your screen is your health bar in green. When your health bar reaches zero, you will die, so be careful. Below your health bar is a second bar representing the resource your class uses to power your special abilities, such as rage, energy or mana. Both bars will refill slowly over time.";
...
TUTORIAL58 = "Your bags are full so you won't be able to pick up any more loot. To free up some bag space, visit vendor characters and sell them some of your junk. There are usually vendors in every city, town or outpost.";
TUTORIAL59 = "To free up bag space or make some money you can sell some of the items you have collected. Locate a vendor and Right Click them. Then open your bags and Right Click on any items you want to sell. Any vendor will buy any kind of item from you.";
TUTORIAL60 = "Remember, your character has special abilities on the action bar on the lower part of your screen. Using those abilities will kill an enemy much faster than just swinging your weapon.";
...
UNIT_NAMEPLATES = "Unit Nameplates|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
VOLUME = "Volume";
VOTE_BOOT_PLAYER = "A vote has been initiated to remove %1$s from the group. Do you want to uninvite %1$s?";
