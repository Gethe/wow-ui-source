...
CALENDAR_CREATE_GUILDEVENT_HELP = "Invite all guild members to this event who meet the following conditions:";
CALENDAR_CREATE_GUILDEVENT_MINRANK = "Minimum Rank";
CALENDAR_CREATE_GUILDEVENT_TITLE = "Guild Filter";
CALENDAR_CREATE_GUILDWIDE_EVENT = "Create Guild-Wide Event";
...
CALENDAR_EVENT_DESCRIPTION = "Event description";
...
CALENDAR_VIEW_EVENTTITLE_LOCKED = "%s (Locked)"; -- %s is the name of the event. Locked means you cannot RSVP to the event.
...
CHAT_GUILD_GET = "|Hchannel:Guild|h[Guild] %s:\32"; -- Guild message from player %s
...
CHAT_SUSPENDED_NOTICE = "Channel: |Hchannel:%d|h[%s]|h ";
...
ERR_CALENDAR_EVENT_ALERT_S = "%s begins in 15 minutes."; -- Alert the player that an event they are invited to begins soon.
...
ITEM_MOD_ARMOR_PENETRATION = "Your attacks ignore %d of your opponent's armor.";
