...
BN_BLOCK_FAILED_TOO_MANY_RID = "You have already blocked the maximum number of Real ID players.";
...
BN_WHISPER_MODE = "New Real ID Whispers";
...
CHALLENGES_LASTRUN_TIME = "Last Run Time";
CHALLENGES_NO_MEDAL = "- No Medal -";
CHALLENGES_NO_TIME = "--:--:--";
CHALLENGES_RECORD_TIME = "Record Time";
...
OPTION_BN_WHISPER_MODE_INLINE = "Real ID Whispers will be displayed in your regular chat tabs. They may be moved to a new window by right-clicking on the player's name in chat.";
OPTION_BN_WHISPER_MODE_POPOUT = "New Real ID Whispers will be displayed in a new tab.";
OPTION_BN_WHISPER_MODE_POPOUT_AND_INLINE = "New Real ID Whispers will be displayed in a new tab and in your regular chat tabs.";
...
PALADIN_PROT_CORE_ABILITY_6 = "Use when you have 3 Holy Power for damage and defense.";
...
PRIEST_DISC_CORE_ABILITY_5 = "A large damage absorb.";
...
SPELL_FAILED_CUSTOM_ERROR_145 = "Wait until you're under the Onyx Serpent's shadow.";
