...
ERR_REACHED_MAIL_CAP = "You have reached the unique sending cap for in-game mails";
...
ERR_TOO_MANY_SPECIAL_BAGS = "You cannot equip more than one special bag";
...
HERTZ = "Hz";
HIDE = "Hide";
HIDE_PARTY_INTERFACE_TEXT = "Hide Party Interface";
...
REPUTATION_STATUS_AT_WAR = "You cannot make peace with this group until you have a better reputation with them.";
