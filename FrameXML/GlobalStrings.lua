...
ARCHAEOLOGY_SHOW_DIG_SITES = "Show Dig Sites";
...
ARENA_MASTER_NO_SEASON_TEXT = "Arena battles and Rated Battlegrounds are only available during an active player versus player combat season.  Season nine will begin on the second week after contestants are able to reach level 85, so be prepared at that time to take your shot at glory!";
...
ARENA_TEAMS_INVALID_WARNING = "Arena Teams are available at level 85.\nYou are not currently on any Arena Teams";
...
BATTLEFIELD_IN_QUEUE_RATED = "You are in the queue for a Rated %s\nAverage wait time: %s\nTime in queue: %s";
...
COMBAT_TEXT_SHOW_AURAS_TEXT = "Auras Gained/Lossed";
...
DUNGEON_FLOOR_SHADOWFANGKEEP6 = "Arugal's Chamber";
...
DUNGEON_FLOOR_THETEMPLEOFATALHAKKAR1 = "TheTemple of Atal' Hakkar";
...
ERR_ALTERED_FORM_CANT_TRANSFORM_RIGHT_NOW = "You cannot transform right now";
...
ERR_REFORGE_SRC_STAT_NOT_FOUND = "Stat not found";
...
ERR_SOCKETING_COGWHEEL_GEM_ONLY_IN_COGWHEELSLOT = "Cogwheel gems can only be placed in cogwheel gem slots";
...
ERR_SOCKETING_REQUIRES_COGWHEEL_GEM = "That slot requires a coghweel gem";
...
GUILD_ACHIEVEMENTS_ELIGIBLE = "At least %1$d out of %2$d players in your group are members of %3$s.  Guild achievements are able to be completed.";
...
HELPFRAME_STUCK_GRAVEYARD = "If your Heathstone is on cooldown and you don't want to wait for it, you have the option for your character to die and be teleported to the nearest graveyard.  You can then either resurrect at the Spirit Healer, suffering durability loss, or attempt to retrieve your corpse.";
...
PET_TYPE_PET = "Pet";
PET_UNSPENT_TALENT_POINTS = "Your pet has %s unspent talent points";
PET_WAIT = "Stay";
...
PLAYER_UNSPENT_TALENT_POINTS = "You have %s unspent talent points";
...
PVP_ARENA_EXPLANATION = "Winning an arena battle will cause you to earn Conquest Points and will increase your arena team's rating.  You must be on an arena team to battle in the arena.";
...
PVP_RATED_BATTLEGROUND_EXPLANATION = "Winning a rated battleground will cause you to earn Conquest Points and will increase your rating.  A higher rating allows you to earn more Conquest Points per week.";
PVP_RATING = "Rating:";
PVP_RECORD = "Record:";
...
SLASH_TRADE3 = "/tr";
SLASH_TRADE4 = "/trade";
SLASH_TRANSFORM1 = "/transform";
SLASH_TRANSFORM2 = "/transform";
...
STAT_DODGE = "Dodge";
STAT_DPS_SHORT = "DPS";
STAT_ENERGY_TOOLTIP = "Your maximum energy.  Energy is consumed when using abilities and is restored automatically over time.";
STAT_EXPERTISE = "Expertise";
STAT_FOCUS_TOOLTIP = "Your maximum focus.  Focus is consumed when using abilities and is restored automatically over time.";
STAT_FORMAT = "%s:";
STAT_HASTE = "Haste";
...
STAT_HEALTH_TOOLTIP = "Your maximum amount of health.  If your health reaches zero, you will die.";
...
STAT_MANA_TOOLTIP = "Your maximum mana.  Mana allows you to cast spells.";
...
STAT_PARRY = "Parry";
STAT_RAGE_TOOLTIP = "Your maximum rage.  Rage is consumed when using abilities and is restored by attacking enemies or being damaged in combat.";
STAT_RESILIENCE = "Resilience";
STAT_RUNIC_POWER_TOOLTIP = "Your maximum Runic Power.";
...
TUTORIAL1 = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. |cffffd200Right Click|r on them to get a quest.";
...
TUTORIAL1_DWARF = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Joren Ironstock|r.|n|nTo talk to  |cffffd200Joren Ironstock|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_GNOME = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Nevin Twistwrench|r.|n|nTo talk to  |cffffd200Nevin Twistwrench|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_HUMAN = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Marshal McBride|r.|n|nTo talk to  |cffffd200Marshal McBride|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_NIGHTELF = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Conservator Ilthalaine|r.|n|nTo talk to  |cffffd200Conservator Ilthalaine|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_ORC = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Kaltunk|r.|n|nTo talk to  |cffffd200Kaltunk|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_SCOURGE = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Agatha|r.|n|nTo talk to  |cffffd200Agatha|r you need to |cffffd200Right Click|r on her.";
TUTORIAL1_TAUREN = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Chief Hawkwind|r.|n|nTo talk to  |cffffd200Chief Hawkwind|r you need to |cffffd200Right Click|r on him.";
TUTORIAL1_TROLL = "Quest givers have exclamation points (\124TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0\124t) over thier heads. You can get a quest by talking to |cffffd200Jin'thala|r.|n|nTo talk to  |cffffd200Jin'thala|r you need to |cffffd200Right Click|r on him.";
...
TUTORIAL52 = "Congratulations, you have received your first companion. This little fellow will follow you during all of your adventures in Azeroth and beyond.|n|nYou can see all of your companions by clicking the |cffffd200Spellbool Button|r and then looking for the  |cffffd200Companions|r tab.";
...
TUTORIAL61_DRUID = "a druid, you can |cffffd200shapeshift|r into different forms, each with unique abilities and their own resource. Your first form, Cat, increases your melee damage.";
...
TUTORIAL61_SHAMAN = "have learned your first |cffffd200totem|r. Different kinds of totems provide different kinds of benefits. Ultimately, you will be able to use four different totems at one time.";
TUTORIAL61_SPELLID_DRUID = "768";
TUTORIAL61_SPELLID_HUNTER = "1579";
TUTORIAL61_SPELLID_PALADIN = "85673";
TUTORIAL61_SPELLID_ROGUE = "2098";
TUTORIAL61_SPELLID_SHAMAN = "8075";
TUTORIAL61_SPELLID_WARLOCK = "93376";
...
WARGAME_TOOLTIP = "War Games allow you to challenge teams of the same faction to a showdown in a battleground of your choice.  To start a War Game you must be the party leader, select a battleground, target an opposing party leader and click the War Game button.";
...
WORLD_MARKER1 = "|cff0070ddBlue|r World Marker";
WORLD_MARKER2 = "|cff1eff00Green|r World Marker";
WORLD_MARKER3 = "|cffa335eePurple|r World Marker";
WORLD_MARKER4 = "|cffff2020Red|r World Marker";
WORLD_MARKER5 = "|cffccccccWhite|r World Marker";
...
WORLD_PVP_PENDING = "%s is full.|n You are queued but have not yet been called to battle. You will be ported out in a few moments.";
WORLD_PVP_PENDING_REMOTE = "%s is full.|n You are queued but have not yet been called to battle.";
WORLD_PVP_QUEUED = "%s is full.|nYou are queued for battle. Please wait.";
