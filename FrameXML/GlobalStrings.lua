...
CR_AMPLIFY_TOOLTIP = "Increases Critical Strike damage, Haste, Mastery, Readiness, and Multistrike  by %.2f%%.";
CR_AVOIDANCE_TOOLTIP = "Reduces damage taken from area of effect spells by %.2f%%.";
CR_BLOCK_TOOLTIP = "Your block stops %d%% of incoming damage.";
CR_CLEAVE_TOOLTIP = "Increases area of effect damage and healing done and grants %.2f%% chance to for single-target abilities to hit a second nearby target.";
...
CR_LIFESTEAL_TOOLTIP = "Returns %.2f%% of all damage and healing you deal as healing to you.";
CR_MULTISTRIKE_TOOLTIP = "Grants a %.2f%% chance to deliver extra attacks or heals for %.2f%% of initial value on each target. \nMultistrike: %s (%.2f%% multistrike)";
CR_PARRY_TOOLTIP = "Parry of %d adds %.2f%% Parry\n|cff888888(Before diminishing returns)|r";
CR_RANGED_EXPERTISE_TOOLTIP = "Reduces chance to be dodged by %s\nExpertise %s (+%.2F%% expertise)";
CR_READINESS_TOOLTIP = "Increases the cooldown recovery rate of several of your major cooldowns by %.2f%%.";
CR_READINESS_TOOLTIP_NO_TALENT_SPEC = "You must select a class specialization in order to activate Readiness.";
CR_SPEED_TOOLTIP = "Increases run speed by %.2f%%.";
CR_STURDINESS_TOOLTIP = "Reduces durability loss from death on your items by %.2f%%.";
CTRL_KEY = "CTRL key";
CTRL_KEY_TEXT = "CTRL";
CURRENCY = "Currency";
...
DATAMINER_RED_HERRING = "There is no cow level.";
...
ERR_SET_LOOT_PUSH = "Looting set to Personal.";
...
GARRISON_DURATION_DAYS_HOURS = "%d |4day:days; %d |4hour:hours;";
GARRISON_DURATION_HOURS = "%d |4hour:hours;";
GARRISON_DURATION_HOURS_MINUTES = "%d |4hour:hours; %d |4minute:minutes;";
GARRISON_DURATION_MINUTES = "%d |4minute:minutes;";
...
LEVEL_UP_DRAENOR_TALENT = "Draenor Talent Unlocked!";
LEVEL_UP_DRAENOR_TALENT2 = "You have learned a new Draenor talent:";
...
NEWBIE_TOOLTIP_UNIT_PUSH = "FIX ME!! (DO NOT LOCALIZE!!)";
...
SPELL_FAILED_CUSTOM_ERROR_205 = "Must be closer to one of Gelbin's objectives to deploy!";
...
SPELL_FAILED_REPLACE_ITEM_BONUS_TREE = "That item cannot be modified.";
...
VIDEO_OPTIONS_FXAA_HIGH = "FXAA High";
VIDEO_OPTIONS_FXAA_LOW = "FXAA Low";
