...
ITEM_MOD_PVP_POWER = "Increases PvP power by %d.";
...
SHADOW_ORBS_TOOLTIP = "Used to summon Shadowy Apparitions and empower Psychic Horror.";
...
WARRIOR_FURY_CORE_ABILITY_4 = "Use whenever you have 60 Rage.";
