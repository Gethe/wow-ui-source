...
ERR_GUILD_NAME_NAME_RUSSIAN_E_NOT_ALLOWED = "Russian Yo character is not allowed. Create a new name"; -- This error only displays in Russian, so the english version doesn't matter. RUSSION LOCALIZATION - should rewrite as appropriate
