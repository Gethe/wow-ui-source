...
ARENA_MASTER_TEXT = "Let the games begin!  The door is open to all who wish to find glory in the arena, and the Steamwheedle Cartel is prepared to accept your entry into the games.  If victory is your destiny, then register a team with an Arena Promoter, or join one that has already been registered!";
...
AUTO_ADD_DISABLED_TOOLTIP = "You cannot automatically add more members to your group if you are already looking for a group to join.";
AUTO_ADD_MEMBERS = "Auto Add Members"; -- Label to automatically add members to your group in the LFM Frame
AUTO_ADD_TOOLTIP = "Enabling this will allow the system to automatically add members to your existing group. This feature only works for dungeons.";
...
AUTO_JOIN_TOOLTIP = "Enabling this will allow you to be automatically added to a group that matches your search criteria.  This feature only works for dungeons.";
...
BENCHMARK_TAXI_MODE_OFF = "Taxi benchmark mode OFF.";
BENCHMARK_TAXI_MODE_ON = "Taxi benchmark mode ON.";
BENCHMARK_TAXI_RESULTS = "Taxi benchmark results:";
...
ENABLE_BGSOUND = "Enable Sound in Background";
...
ERROR_SLASH_TEAM_DEMOTE = "Appropriate format is /teamdemote [2v2, 3v3, 5v5] [player name]";
...
ERR_ARENA_TEAM_CREATE_S = "%s created";
ERR_ARENA_TEAM_DISBANDED_S = "%s has disbanded %s";
ERR_ARENA_TEAM_FOUNDER_S = "Congratulations, you are a founding member of %s!";
...
ERR_ARENA_TEAM_NOT_ALLIED = "You cannot invite players from the opposing alliance into your arena team";
...
ERR_INVITED_TO_GUILD_SS = "%s invites you to join %s."; -- %s's are the inviter's name and the guild name respectively
...
KBASE_ERROR_LOAD_FAILURE = "The Knowledge Base is currently unavailable.  Please refer to http://www.blizzard.com/support/wowindex/ for help with support issues, or submit a petition using the button below.";
...
LOOKING_FOR_GROUP_TEXT = "Let other players know what dungeon, raid, or quest you are interested in.";
LOOKING_FOR_MORE = "Looking For More";
LOOKING_FOR_MORE_TEXT = "Find additional group members for a dungeon, raid, or quest.";
...
LOOT_ROLL_GREED = "%s has selected Greed for: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_GREED_SELF = "You have selected Greed for: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_NEED = "%s has selected Need for: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_NEED_SELF = "You have selected Need for: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_PASSED = "%s passed on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_PASSED_SELF = "You passed on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_ROLLED = "%s rolls a %d on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_ROLLED_GREED = "Greed Roll - %d for %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s by %s";
LOOT_ROLL_ROLLED_GREED_SELF = "You roll a %d (Greed) on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_ROLLED_NEED = "Need Roll - %d for %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s by %s";
LOOT_ROLL_ROLLED_NEED_SELF = "You roll a %d (Need) on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_ROLLED_SELF = "You roll a %d on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_START = "Rolling started on: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_WON = "%s won: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_WON_NO_SPAM_GREED = "%1$s won: %3$s|Hitem:%4$d:%5$d:0:0:0:0:%6$d:%7$d|h[%8$s]|h%9$s |cff818181(Greed - %2$d)|r";
LOOT_ROLL_WON_NO_SPAM_NEED = "%1$s won: %3$s|Hitem:%4$d:%5$d:0:0:0:0:%6$d:%7$d|h[%8$s]|h%9$s |cff818181(Need - %2$d)|r";
LOOT_ROLL_YOU_WON = "You won: %s|Hitem:%d:%d:0:0:0:0:%d:%d|h[%s]|h%s";
LOOT_ROLL_YOU_WON_NO_SPAM_GREED = "You won: %2$s|Hitem:%3$d:%4$d:0:0:0:0:%5$d:%6$d|h[%7$s]|h%8$s |cff818181(Greed - %1$d)|r";
LOOT_ROLL_YOU_WON_NO_SPAM_NEED = "You won: %2$s|Hitem:%3$d:%4$d:0:0:0:0:%5$d:%6$d|h[%7$s]|h%8$s |cff818181(Need - %1$d)|r";
...
NEWBIE_TOOLTIP_LFGPARENT = "A tool to help you find a group to join or find additional players to complete your existing group.";
...
OPTION_TOOLTIP_SHOW_TARGET_CASTBAR_IN_V_KEY = "If the Combat Name Plate is displayed for your current target, show the enemy cast bar with the target's health bar in the game field."; -- CVar text for the current target castbar
...
SHOW_TARGET_CASTBAR = "Display Enemy Castbar - Portrait"; -- CVar text for the current target castbar
SHOW_TARGET_CASTBAR_IN_V_KEY = "Display Enemy Castbar - Combat Name Plate"; -- CVar text for the current target castbar
...
TOOLTIP_RAID_SHIFT_TIP = "SHIFT - Drag for Single";
