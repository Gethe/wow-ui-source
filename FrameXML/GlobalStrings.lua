...
OPTION_TOOLTIP_SHOW_TIME_MANAGER = "Displays the time manager button on the minimap.";
...
SHOW_TIME_MANAGER = "Show Time Manager"; -- UIOptionsFrame check button for whether or not to show the time manager
...
SPELL_FAILED_CUSTOM_ERROR_21 = "That can only be used on a Jormungar Spawn in Ice Heart Cavern.";
