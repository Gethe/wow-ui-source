...
CALENDAR_ERORR_ALREADY_INVITED_TO_EVENT_S = "%s has already been invited."; -- This is placeholder text, but it needs to be presentable because it's going in for 3.0.1 beta.
CALENDAR_ERROR = "%s";
...
LATEST_UNLOCKED_ACHIEVEMENTS = "Latest Unlocked Achievements"; -- Title for the summary page of the achievements frame
...
NO_BIDS = "No Bids";
NO_COMPLETED_ACHIEVEMENTS = "You have no completed achievements";
