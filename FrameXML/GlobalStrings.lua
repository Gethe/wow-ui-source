...
ACTION_SPELL_AURA_DISPELLED = "dispeled";
ACTION_SPELL_AURA_DISPELLED_BUFF = "dispeled";
...
ACTION_SPELL_CAST_START_FULL_TEXT = "$source begins casting $spell.";
