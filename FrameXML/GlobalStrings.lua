...
BATTLENET_FRIEND_INFO = "This is a person you know and trust in real life. You can chat with this person across WoW servers and across Blizzard games.";
...
BLUE_GEM = "Blue";
BNET_INVITE_SENT_TIME = "Sent %2$d/%1$02d/%3$02d";
BNET_LAST_ONLINE = "last online %s ago";
BN_CONVERSATION = "Battle.net Conversation";
...
CHAT_MSG_BN_CONVERSATION = "Battle.net Conversation";
...
FRIENDS_FRIENDS_WAITING = "Waiting on Battle.net...";
FRIENDS_LEVEL_TEMPLATE = "Level %d %s";
FRIENDS_LIST = "Friends List";
FRIENDS_LIST_AWAY = "Away";
FRIENDS_LIST_BUSY = "Busy";
FRIENDS_LIST_ENTER_TEXT = "Broadcast to Real ID friends";
...
FRIEND_REQUEST_SENT = "Your friend request has been sent to";
FRIEND_REQUEST_SENT_INFO = "They will be added to your friends list when they accept your friend request.";
FROM = "From:";
FUEL = "Fuel";
...
PROFESSIONS_ARCHAEOLOGY_MISSING = "Visit a trainer to learn archaeology.  Dig around in rocks and find stuff. Oh! Piece of candy!";
...
PROFESSIONS_FISHING_MISSING = "Visit a trainer to learn fishing.  Fish, drink beer and hang out near water.  Hell ya!";
