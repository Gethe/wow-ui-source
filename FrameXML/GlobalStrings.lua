...
ACTION_DAMAGE_SHIELD_MISSED_BLOCK_FULL_TEXT = "$source $spell was blocked by $dest.$result";
ACTION_DAMAGE_SHIELD_MISSED_BLOCK_FULL_TEXT_NO_SOURCE = "$spell was blocked by $dest.$result";
...
ACTION_DAMAGE_SHIELD_MISSED_RESIST_FULL_TEXT = "$source $spell was fully resisted by $dest.$result";
ACTION_DAMAGE_SHIELD_MISSED_RESIST_FULL_TEXT_NO_SOURCE = "$spell was fully resisted by $dest.$result";
...
ACTION_RANGE_MISSED_ABSORB_FULL_TEXT = "$source shot was absorbed by $dest.$result";
ACTION_RANGE_MISSED_ABSORB_POSSESSIVE = "1";
ACTION_RANGE_MISSED_BLOCK = "Blocked";
ACTION_RANGE_MISSED_BLOCK_FULL_TEXT = "$source shot was blocked by $dest.$result";
...
ACTION_RANGE_MISSED_RESIST_FULL_TEXT = "$source shot was fully resisted by $dest.$result";
...
ACTION_SPELL_MISSED_ABSORB_FULL_TEXT = "$source $spell was absorbed by $dest.$result";
ACTION_SPELL_MISSED_ABSORB_FULL_TEXT_NO_SOURCE = "$spell was absorbed by $dest.$result";
ACTION_SPELL_MISSED_ABSORB_POSSESSIVE = "1";
ACTION_SPELL_MISSED_BLOCK = "Blocked";
ACTION_SPELL_MISSED_BLOCK_FULL_TEXT = "$source $spell was blocked by $dest.$result";
ACTION_SPELL_MISSED_BLOCK_FULL_TEXT_NO_SOURCE = "$spell was blocked by $dest.$result";
...
ACTION_SPELL_MISSED_RESIST_FULL_TEXT = "$source $spell was fully resisted by $dest.$result";
ACTION_SPELL_MISSED_RESIST_FULL_TEXT_NO_SOURCE = "$spell was fully resisted by $dest.$result";
...
ACTION_SWING_MISSED_ABSORB_FULL_TEXT = "$source attack was absorbed by $dest.$result";
ACTION_SWING_MISSED_ABSORB_POSSESSIVE = "1";
ACTION_SWING_MISSED_BLOCK = "Blocked";
ACTION_SWING_MISSED_BLOCK_FULL_TEXT = "$source attack was blocked by $dest.$result";
...
ACTION_SWING_MISSED_RESIST_FULL_TEXT = "$source attack was fully resisted by $dest.$result";
...
ERR_CALENDAR_PERMISSIONS = "You don't have permission to do that.";
...
ERR_NO_SPLIT_WHILE_MILLING = "Milling prevents that action";
...
HELPFRAME_GMTALK_ISSUE1 = "When it comes to quests, Non-Player Characters (NPCs), item information, location information, or anything that would provide information about something that the player could possibly find out through exploration and/or interaction with the world, including interaction with other players.";
...
HELPFRAME_WELCOME_TEXT1 = "?"; -- Only translate for regions without a Knowledge Base. Only China doesn't have a KB right now (Apr 29 2008).
HELPFRAME_WELCOME_TITLE = "?"; -- Only translate for regions without a Knowledge Base. Only China doesn't have a KB right now (Apr 29 2008).
...
ITEM_UNIQUE_EQUIPPABLE_MULTIPLE = "Unique-Equipped  (%d)"; -- Only one allowed to be equipped at a time.
ITEM_UNIQUE_EQUIPPED_MULTIPLE = "Unique Equipped: %s (%d)";
...
MAIL_AUTO_LOOT_DEFAULT_TEXT = "Auto Loot Mail";
MAIL_AUTO_LOOT_KEY_TEXT = "Auto Loot Mail Key";
...
OPTION_TOOLTIP_MAIL_AUTO_LOOT_ALT_KEY = "Use the \"ALT\" key to Loot when \"Auto Loot Mail\" is checked, and to Auto Loot when it is not.";
OPTION_TOOLTIP_MAIL_AUTO_LOOT_CTRL_KEY = "Use the \"CTRL\" key to Loot when \"Auto Loot Mail\" is checked, and to Auto Loot when it is not.";
OPTION_TOOLTIP_MAIL_AUTO_LOOT_DEFAULT = "Sets Auto Looting as the default action when clicking on an item in your Inbox. (Looting when this is checked, or Auto Looting when it is not, is performed by holding the Loot Key / Auto Loot Key)";
OPTION_TOOLTIP_MAIL_AUTO_LOOT_KEY_TEXT = "Key to use to auto loot an item in your mailbox";
OPTION_TOOLTIP_MAIL_AUTO_LOOT_NONE_KEY = "Do not apply a key.";
OPTION_TOOLTIP_MAIL_AUTO_LOOT_SHIFT_KEY = "Use the \"SHIFT\" key to Loot when \"Auto Loot Mail\" is checked, and to Auto Loot when it is not.";
...
OPTION_TOOLTIP_SHOW_TIME_MANAGER = "Displays the clock button on the minimap.";
...
QUICKBUTTON_NAME_EVERYTHING_TOOLTIP = "Show all chat messages.";
...
SHOW_TIME_MANAGER = "Show Clock"; -- UIOptionsFrame check button for whether or not to show the time manager
...
SPELL_FAILED_CUSTOM_ERROR_14 = "You must be close to a marked tree.";
...
SPELL_FAILED_NOT_ENOUGH_HEALTH = "Not enough health";
...
SPELL_RANGE_FRIENDLY = "Friendly: %s yd range";
...
STRING_POWER_RUNIC_POWER = "Runic Power";
...
TIMEMANAGER_AM = "AM";
TIMEMANAGER_CLOCK_TOOLTIP_LOCALTIME = "Local time:";
TIMEMANAGER_CLOCK_TOOLTIP_REALMTIME = "Realm time:";
TIMEMANAGER_CLOCK_TOOLTIP_TITLE = "Time Info";
...
UNITNAME_SUMMON_TITLE5_DELETED = "%s's Companion";
