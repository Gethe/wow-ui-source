...
BINDING_NAME_TOGGLECOLLECTIONSHEIRLOOM = "Toggle Heirlooms Journal";
...
OPTION_TOOLTIP_SOCIAL_ENABLE_TWITTER_FUNCTIONALITY = "Check to enable integration of WoW with Twitter. Post to Twitter using /share";
...
SOCIAL_TWITTER_COMPOSE_NEW_TWEET = "Compose a new tweet";
...
SOCIAL_TWITTER_POST_TITLE = "Tweet";
SOCIAL_TWITTER_SIGN_IN = "Sign In";
SOCIAL_TWITTER_STATUS_CONNECTED = "Connected:\n%s";
SOCIAL_TWITTER_STATUS_NOT_CONNECTED = "Not Connected";
SOCIAL_TWITTER_THROTTLE_TOOLTIP = "The number of tweets that can be sent is limited, please wait to send another tweet.";
SOCIAL_TWITTER_TWEET_FAILED = "Tweet Failed";
SOCIAL_TWITTER_TWEET_NOT_LINKED = "Tweet Failed: account not linked";
SOCIAL_TWITTER_TWEET_SENDING = "Sending tweet. This may take a few seconds.";
SOCIAL_TWITTER_TWEET_SENT = "Tweet Sent";
...
TRIAL_ACCOUNT_TRADESKILL_RESTRICTED = "Not available for trial accounts";
...
VIDEO_OPTIONS_DEPTH_EFFECTS_LOW = "Particle depth fading and low-resolution refraction.";
