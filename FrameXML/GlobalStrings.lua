...
ACHIEVEMENT_UNLOCED = "Achievement Unlocked";
...
ACTION_SPELL_AURA_DISPELLED = "dispelled";
ACTION_SPELL_AURA_DISPELLED_BUFF = "dispelled";
...
ACTION_SPELL_AURA_DISPELLED_BUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_DISPELLED_DEBUFF = "cleansed";
...
ACTION_SPELL_AURA_DISPELLED_DEBUFF_POSSESSIVE = "1";
ACTION_SPELL_AURA_DISPELLED_POSSESSIVE = "1";
...
SPELL_FAILED_CUSTOM_ERROR_8 = "The Shroud of the Scourge will only work when equipped in the Temple City of En'kilah."; -- For the Shroud of the Scourge quest item in Borean Tundra.
