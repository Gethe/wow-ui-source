...
OPTION_TOOLTIP_WOW_MOUSE = "Enable this option if you have a mouse with more than 5 buttons and you want to be able to assign actions to the extra buttons.";
...
WOW_MOUSE = "Multi-Button Mouse";
WOW_MOUSE_NOT_FOUND = "Unable to find multi-button mouse. Enable the Multi-Button Mouse option in Interface Options when you have one connected.";
WRISTSLOT = "Wrist";
