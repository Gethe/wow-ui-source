...
ACTIONBARS_LABEL = "ActionBars|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
ANTIALIASING_SSAA = "SSAA 2x";
ANTIALIASING_SSAA_CMAA = "SSAA 2x + CMAA";
...
CHAT_RESTRICTED_VETERAN = "A Veteran Edition account may only send whispers to characters that have you on their friends list.  \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
CHAT_TRIAL_RESTRICTED_NOTICE_VETERAN = "|Hchannel:%d|h[%s]|h Veteran Edition accounts cannot send messages to this channel. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
CONTINUE = "Continue";
CONTINUED = "...";
CONTROLS_LABEL = "Controls|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
COSTS_LABEL = "Cost:";
COUNTDOWN_FOR_COOLDOWNS_TEXT = "Show Numbers for Cooldowns|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
CR_AMPLIFY_TOOLTIP = "Increases Critical Strike damage, Haste, Mastery, Readiness, and Multistrike.\n\nAmplify %s (+%.2f%% Amplify)";
...
CR_CLEAVE_TOOLTIP = "Increases area of effect damage and healing done and grants a chance to for single-target abilities to hit a second nearby target.\n\nCleave %s (+%.2f%% Cleave)";
...
CR_READINESS_TOOLTIP = "Readiness %s (+%.2f%% Readiness)";
CR_READINESS_TOOLTIP_NO_TALENT_SPEC = "You must select a class specialization in order to activate Readiness.";
...
ERR_CHAT_RAID_RESTRICTED_VETERAN = "Veteran Edition accounts cannot send messages to raid channel. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
ERR_CHAT_RESTRICTED_VETERAN = "Veteran Edition accounts cannot send unlimited tells. You must wait before you can send tells to more players.  \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
ERR_INVITE_RESTRICTED_VETERAN = "Veteran Edition accounts cannot invite characters into groups. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
ERR_PETITION_RESTRICTED_ACCOUNT_VETERAN = "Veteran Edition accounts may not sign guild charters. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
ERR_RESTRICTED_ACCOUNT = "Starter and Veteran Edition accounts cannot perform that action";
...
ERR_YELL_RESTRICTED_VETERAN = "Veteran Edition accounts cannot yell. \124cffffd000\124HurlIndex:2\124h[Click To Upgrade]\124h\124r";
...
FLOATING_COMBATTEXT_LABEL = "Floating Combat Text|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
FLOATING_COMBAT_PETBATTLE_LABEL = "Floating Combat Text for Pet Battles|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
ITEM_MOD_CR_AMPLIFY_SHORT = "Amplify";
...
ITEM_MOD_CR_UNUSED_0_SHORT = "Amplify";
...
ITEM_MOD_CR_UNUSED_2_SHORT = "Readiness";
...
ITEM_MOD_CR_UNUSED_8_SHORT = "Cleave";
...
ITEM_SET_BONUS_NO_VALID_SPEC = "Activate a spec to display its set bonuses";
ITEM_SET_NAME = "%s (%d/%d)";
...
ITEM_UPGRADE_DESCRIPTION = "Use your Lesser Charms of Good Fortune, Honor Points, and Conquest Points to upgrade a weapon or piece of armor that is upgradable.";
...
LEVEL_CAP_REACHED_VETERAN = "You have reached the maximum possible level on a Veteran Edition account. \124cffffd000\124HurlIndex:2\124h[Click Here]\124h\124r to upgrade your account!";
...
LFG_LIST_BAD_LEADER_NAME = "Inappropriate Leader Name";
...
MONEY_CAP_REACHED_VETERAN = "You already have the maximum amount of money on a Veteran Edition account. \124cffffd000\124HurlIndex:2\124h[Click Here]\124h\124r to upgrade your account!";
MONEY_COLON = "Money:";
...
NAME = "Name";
NAMES_LABEL = "Names|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
OBJECT_NPC_OUTLINE = "Outline Mode|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
OPTION_TOOLTIP_ADVANCED_PPAA = "Sets the Postprocess Anti-Aliasing mode.";
...
POSTPROCESS_ANTI_ALIASING = "Postprocess Anti-Aliasing";
POSTPROCESS_ANTI_ALIASING_ABREV = "PPAA";
...
REVERSE_CLEAN_UP_BAGS_TEXT = "Reverse Clean Up Bags|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
REVERSE_NEW_LOOT_TEXT = "Loot to Leftmost Bag|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
REVERT = "Revert";
REWARDS = "Rewards";
...
SPELL_FAILED_VETERAN_TRIAL_ABOVE_SKILL_RANK_MAX = "Not available for Veteran accounts";
...
TOKEN_COMPLETE_GAME_TIME_DESCRIPTION = "%d days of game time will be added to your World of Warcraft account.  You will receive a confirmation email shortly.";
TOKEN_COMPLETE_TITLE = "Complete!";
TOKEN_CONFIRMATION_TITLE = "Confirmation";
TOKEN_CONFIRM_CREATE_AUCTION = "Buyout Price: |cffffffff%s|r|nEstimated Time to Sell: |cffffffff%s|r|n|n|cffffffffOnce this auction is created it can't be cancelled and the Token can't be refunded.|r";
TOKEN_CONFIRM_GAME_TIME_DESCRIPTION = "%d days of game time will be added to your World of Warcraft account.  This game time is nonrefundable.";
TOKEN_CREATE_AUCTION_TITLE = "Create Auction";
TOKEN_CURRENT_BUYOUT_PRICE = "Buyout:   |cffffffff%s|r";
TOKEN_FILTER_LABEL = "Game Time";
TOKEN_LOG_DATE_LABEL = "Date";
TOKEN_LOG_ITEM_LABEL = "Item";
TOKEN_LOG_PRICE_LABEL = "Price";
TOKEN_LOG_TITLE = "WoW Token Transaction Log";
TOKEN_LOG_TRANSACTION_LABEL = "Transaction";
...
TOKEN_REDEEM_GAME_TIME_BUTTON_LABEL = "%d Days of Game Time";
TOKEN_REDEEM_GAME_TIME_DESCRIPTION = "Adds %d days of game time to this World of Warcraft account.";
...
TOKEN_TRANSACTION_LABEL_LISTED = "|cffffff00Listed|r";
TOKEN_TRANSACTION_LABEL_PURCHASED = "|cff20ff20Purchased|r";
TOKEN_TRANSACTION_LABEL_SOLD = "|cff20ff20Sold|r";
...
TRACK_QUEST_SORTING = "Newly Tracked Quest Sorting|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
TRIAL_ACCOUNT_TRADESKILL_RESTRICTED = "Not available for Veteran accounts";
...
UNIT_NAME_HIDE_MINUS = "Hide Minor NPC Names|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
