...
BATTLE_PET_MESSAGE_TRAP_COOLDOWN_DOWN = "Cooldown Decreased!";
BATTLE_PET_MESSAGE_TRAP_COOLDOWN_RESET = "Cooldowns Reset!";
BATTLE_PET_MESSAGE_TRAP_COOLDOWN_UP = "Cooldown Increased!";
BATTLE_PET_MESSAGE_TRAP_MISSED = "Trap Missed!";
BATTLE_PET_MESSAGE_TRAP_SPELL_LOCK = "Spell Locked!";
...
DK_FROST_CORE_ABILITY_4 = "Use when you have 20 Runic Power.";
...
PROFESSIONS_USED_IN_COOKING = "\"Used In Cooking.\"";
