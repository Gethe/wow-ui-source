...
BONUS_SKILLPOINTS = "%s skill points:";
...
INSTANCE_UNAVAILABLE_OTHER_AREA_NOT_EXPLORED = "%s must discover this dungeon's entrance.";
...
INSTANCE_UNAVAILABLE_SELF_AREA_NOT_EXPLORED = "You must discover this dungeon's entrance.";
...
LEVEL_UP_DUAL_SPEC_LINK = " |cffFF4E00|Htalent:|h[Dual Talent Specialization]|h|r";
LEVEL_UP_FEATURE = "Feature Unlocked!";
LEVEL_UP_FEATURE2 = "New feature unlocked";
LEVEL_UP_GLYPH1_LINK = "New |cffFF4E00|Hglyph:|h[Major Glyph]|h|r Available!";
LEVEL_UP_GLYPH2_LINK = "New |cffFF4E00|Hglyph:|h[Minor Glyph]|h|r Available!";
...
LEVEL_UP_TALENTPOINT_LINK = "New |cffFF4E00|Htalent:|h[Talent Point]|h|r Available!";
LEVEL_UP_TALENTS_LINK = " |cffFF4E00|Htalent:|h[Talents]|h|r";
...
SPELL_FAILED_CUSTOM_ERROR_101 = "You already have a Race Boat.";
