...
BATTLENET_FRIEND = "Battle.net Friend";
...
BATTLETAG_INLINE_TOAST_FRIEND_ADDED = "\124TInterface\\FriendsFrame\\UI-Toast-ToastIcons.tga:16:16:0:0:128:64:98:127:2:29\124t%s is now a BattleTag friend.";
BATTLETAG_INLINE_TOAST_FRIEND_REMOVED = "\124TInterface\\FriendsFrame\\UI-Toast-ToastIcons.tga:16:16:0:0:128:64:2:29:34:61\124t%s is no longer a BattleTag friend.";
...
BN_WHISPER = "Real ID and BattleTag Whispers";
BN_WHISPER_MODE = "New Real ID and BattleTag Whispers";
...
BURNING_EMBERS_COST = "1 Burning Ember";
BURNING_EMBERS_COST_PER_TIME = "%d Burning Embers, plus %d per sec";
...
CHARACTER_FRIEND = "Character Friend";
...
CHI = "Energy";
CHI_COST = "%d Energy";
CHI_COST_PER_TIME = "%d Energy, plus %d per sec";
CHOOSE = "Choose";
...
CONFIRM_GLYPH_PLACEMENT = "Are you sure you want to inscribe this glyph?  The existing glyph will be overwritten.\n\n%sCost: %d %s|r";
...
CONFIRM_TALENT_WIPE = "Do you want to unlearn all of your talents?";
...
CONVERSATION_MODE = "New Real ID Conversations";
...
COOLDOWN_EXPIRES_AT_MIDNIGHT = "Cooldown resets at midnight";
...
DK_FROST_CORE_ABILITY_4 = "Use when you have 35 Runic Power.";
...
ERR_OUT_OF_LIGHT_FORCE = "Not enough Chi";
...
ERR_PETBATTLE_INVALID_LOADOUT = "Invalid pet battle team.";
...
ERR_SOCKETING_HYDRAULIC_GEM_ONLY_IN_HYDRAULICSLOT = "Hydraulic gems can only be placed in hydraulic gem slots";
...
ERR_SOCKETING_REQUIRES_HYDRAULIC_GEM = "That slot requires a hydraulic gem";
...
GEM_TEXT_HYDRAULIC = "Only fits in a Hydraulic socket.";
...
GUILD_REPUTATION_WARNING = "You will lose your guild reputation with %s";
GUILD_REPUTATION_WARNING_GENERIC = "You will lose your guild reputation with your previous guild.";
...
ITEM_MOD_ARMOR_PENETRATION_RATING = "Increases your armor penetration by %d.";
ITEM_MOD_ARMOR_PENETRATION_RATING_SHORT = "Armor Penetration";
ITEM_MOD_ATTACK_POWER = "Increases attack power by %d.";
ITEM_MOD_BLOCK_RATING = "Increases your shield block by %d.";
ITEM_MOD_BLOCK_RATING_SHORT = "Block";
ITEM_MOD_BLOCK_VALUE = "Increases the block value of your shield by %d.";
ITEM_MOD_BLOCK_VALUE_SHORT = "Block Value";
ITEM_MOD_CRIT_MELEE_RATING = "Improves melee critical strike by %d.";
ITEM_MOD_CRIT_MELEE_RATING_SHORT = "Critical Strike (Melee)";
ITEM_MOD_CRIT_RANGED_RATING = "Improves ranged critical strike by %d.";
ITEM_MOD_CRIT_RANGED_RATING_SHORT = "Critical Strike (Ranged)";
ITEM_MOD_CRIT_RATING = "Increases your critical strike by %d.";
ITEM_MOD_CRIT_RATING_SHORT = "Critical Strike";
ITEM_MOD_CRIT_SPELL_RATING = "Improves spell critical strike by %d.";
ITEM_MOD_CRIT_SPELL_RATING_SHORT = "Critical Strike (Spell)";
ITEM_MOD_CRIT_TAKEN_MELEE_RATING = "Improves melee critical avoidance by %d.";
ITEM_MOD_CRIT_TAKEN_MELEE_RATING_SHORT = "Critical Strike Avoidance (Melee)";
ITEM_MOD_CRIT_TAKEN_RANGED_RATING = "Improves ranged critical avoidance by %d.";
ITEM_MOD_CRIT_TAKEN_RANGED_RATING_SHORT = "Critical Strike Avoidance (Ranged)";
ITEM_MOD_CRIT_TAKEN_RATING = "Improves critical avoidance by %d.";
ITEM_MOD_CRIT_TAKEN_RATING_SHORT = "Critical Strike Avoidance";
ITEM_MOD_CRIT_TAKEN_SPELL_RATING = "Improves spell critical avoidance by %d.";
ITEM_MOD_CRIT_TAKEN_SPELL_RATING_SHORT = "Critical Strike Avoidance (Spell)";
ITEM_MOD_DAMAGE_PER_SECOND_SHORT = "Damage Per Second";
ITEM_MOD_DEFENSE_SKILL_RATING = "Increases defense by %d.";
ITEM_MOD_DEFENSE_SKILL_RATING_SHORT = "Defense";
ITEM_MOD_DODGE_RATING = "Increases your dodge by %d.";
ITEM_MOD_DODGE_RATING_SHORT = "Dodge";
ITEM_MOD_EXPERTISE_RATING = "Increases your expertise by %d.";
...
ITEM_MOD_HASTE_MELEE_RATING = "Improves melee haste by %d.";
ITEM_MOD_HASTE_MELEE_RATING_SHORT = "Haste (Melee)";
ITEM_MOD_HASTE_RANGED_RATING = "Improves ranged haste by %d.";
ITEM_MOD_HASTE_RANGED_RATING_SHORT = "Haste (Ranged)";
ITEM_MOD_HASTE_RATING = "Increases your haste by %d.";
ITEM_MOD_HASTE_RATING_SHORT = "Haste";
ITEM_MOD_HASTE_SPELL_RATING = "Improves spell haste by %d.";
...
ITEM_MOD_HIT_MELEE_RATING = "Improves melee hit by %d.";
ITEM_MOD_HIT_MELEE_RATING_SHORT = "Hit (Melee)";
ITEM_MOD_HIT_RANGED_RATING = "Improves ranged hit by %d.";
ITEM_MOD_HIT_RANGED_RATING_SHORT = "Hit (Ranged)";
ITEM_MOD_HIT_RATING = "Increases your hit by %d.";
ITEM_MOD_HIT_RATING_SHORT = "Hit";
ITEM_MOD_HIT_SPELL_RATING = "Improves spell hit by %d.";
ITEM_MOD_HIT_SPELL_RATING_SHORT = "Hit (Spell)";
ITEM_MOD_HIT_TAKEN_MELEE_RATING = "Improves melee hit avoidance by %d.";
ITEM_MOD_HIT_TAKEN_MELEE_RATING_SHORT = "Hit Avoidance (Melee)";
ITEM_MOD_HIT_TAKEN_RANGED_RATING = "Improves ranged hit avoidance by %d.";
ITEM_MOD_HIT_TAKEN_RANGED_RATING_SHORT = "Hit Avoidance (Ranged)";
ITEM_MOD_HIT_TAKEN_RATING = "Improves hit avoidance by %d.";
ITEM_MOD_HIT_TAKEN_RATING_SHORT = "Hit Avoidance";
ITEM_MOD_HIT_TAKEN_SPELL_RATING = "Improves spell hit avoidance by %d.";
...
ITEM_MOD_MASTERY_RATING = "Increases your mastery by %d.";
...
ITEM_MOD_PARRY_RATING = "Increases your parry by %d.";
...
ITEM_MOD_PVP_POWER = "Increases your PvP power by %d.";
ITEM_MOD_PVP_POWER_SHORT = "PvP Power";
ITEM_MOD_RANGED_ATTACK_POWER = "Increases ranged attack power by %d.";
ITEM_MOD_RANGED_ATTACK_POWER_SHORT = "Ranged Attack Power";
ITEM_MOD_RESILIENCE_RATING = "Increases your PvP resilience by %d.";
...
LIGHT_FORCE_COST = "%d Chi";
LIGHT_FORCE_COST_PER_TIME = "%d Chi, plus %d per sec";
...
MANA_REGEN_FROM_SPIRIT = "Increases Mana Regeneration while in combat by %d per 5 Seconds";
...
MONK_WIND_CORE_ABILITY_2 = "Use when you have 1 Chi.";
MONK_WIND_CORE_ABILITY_3 = "Use instead of Tiger Palm when your target is below 50% health.";
MONK_WIND_CORE_ABILITY_4 = "Use when you have 2 Chi.";
MONK_WIND_CORE_ABILITY_5 = "Use when you are injured and you have 2 Chi.";
...
OPTION_CONVERSATION_MODE_POPOUT_AND_INLINE = "New Real ID Conversations will be displayed in a new tab and in your regular chat.";
...
PET_BATTLE_AURA_TURNS_REMAINING = "%d Turns";
...
PVP_POWER_TOOLTIP = "Increases damage done to players and their pets or minions, and increases healing done in PvP zones by %.2f%%.";
PVP_RANK_0_0 = "Scout";
...
SLASH_RAIDBROWSER10 = "/otherraids";
...
TALENT_FRAME_HELP_2 = "You willl unlock more talent rows as you gain levels.\n\n|cFFFF0000You can always unlearn them at your class trainer.|r";
...
TRANSMOGRIFY_BIND_CONFIRMATION = "Using this item for transmogrify will bind it to you and make it non-refundable.";
...
TUTORIAL5_MAGE = "To fight your enemies, click on |cffffd200Fireball|r on your  |cffffd200Action Bar|r.";
...
TUTORIAL61_WARRIOR = "You have learned a new |cffffd200combat stance|r. Different stances have access to different abilities and come with different bonuses. Defensive Stance does less damage than Battle Stance, but makes you harder to kill and is especially useful while tanking.";
...
WARLOCK_AFFLICTION_CORE_ABILITY_5 = "Cast when the target is low health or to generate Soul Shards.";
