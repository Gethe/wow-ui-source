...
AUCTION_CATEGORY_ITEM_ENHANCEMENT = "Item Enhancement";
...
BOOST2_HUNTER_BESTIALWRATH = "Use |cFFFFFFFFBestial Wrath|r when available to increase your damage.\n\n";
BOOST2_HUNTER_COBRASHOT = "Use |cFFFFFFFFCobra Shot|r to spend Focus.\n\n";
BOOST2_HUNTER_DIREBEAST = "Use |cFFFFFFFFDire Beast|r when available.\n\nWatch for it to reset early.";
BOOST2_HUNTER_KILLCOMMAND = "Use |cFFFFFFFFKill Command|r when available to deal strong damage.\n\n";
...
TRANSMOG_SOURCE_1 = "Dungeon Drop";
