...
CALENDAR_SIGNEDUP_FOR_GUILDEVENT = "Signed up";
...
GM_RESPONSE_ISSUE_RESOLVED = "Issue Resolved";
GM_RESPONSE_MESSAGE_HEADER = "Response:";
GM_RESPONSE_MORE_HELP = "Need More Help";
GM_RESPONSE_POPUP_NEED_MORE_HELP_WARNING = "You must resolve your current issue before you can request additional help. Do you want to resolve your current issue?";
GM_RESPONSE_POPUP_RESOLVE_ISSUE_CONFIRM = "You will no longer be able to view your response if you resolve your issue. Are you sure you want to resolve your issue?";
...
INSTANCE_LOCK_TIMER = "You have entered an instance already in progress! You will be saved to %1$s on %2$s difficulty in %3$s!"; -- 1=instance name 2=difficulty name (DUNGEON_DIFFICULTY) 3=time remaining
...
WORLD_PVP_PENDING = "Wintergrasp is full.|nYou are not allowed to enter the battle and will be ejected soon.";
