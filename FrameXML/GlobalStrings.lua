...
GUILD_NEWS_FORMAT0 = "%s earned the achievement %s";
...
LEVEL_UP = "Congratulations, you have reached |cffFF4E00|Hlevelup:%d:|h[Level %d]|h|r!";
...
REFORGE_DESCRIPTION = "Add reforging description to REFORGE_DESCRIPTION";
...
STATS_COLLAPSE_TOOLTIP = "Hide Details";
STATS_EXPAND_TOOLTIP = "Show Details";
STATS_LABEL = "Stats:";
STATUS = "Status";
...
TALENTS_CHOOSE_SPEC_HEADER = "Choose Your %s Specialization";
...
TUTORIAL34 = "CONGRATULATIONS! You have completed your first quest!|n|cffffd200Marshal McBride|r has another quest for you.";
