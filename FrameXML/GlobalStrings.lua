...
BOOST2_PALADINRET_BASICCOMBAT_JUDGMENT = "Use |cFFFFFFFFJudgment|r on the Target Dummy.\n\n|cFFFFFFFFJudgment|r can be cast from range and generates 1 |cFFFFFFFFHoly Power|r";
...
CHALLENGE_MODE_INSERT_KEYSTONE = "Insert Challengers Keystone";
...
CONFIRM_ARTIFACT_CHOICE = "Are you sure you wish to pursue this artifact? This is a solo experience on which others will not be able to aid you, and you will not be able to pursue another artifact for some time.";
