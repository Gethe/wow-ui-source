...
CR_AVOIDANCE_TOOLTIP = "Reduces damage taken from area of effect spells.\n\nAvoidance %s (+%.2f%% Avoidance)";
...
CR_VERSATILITY_TOOLTIP = "Increases damage and healing done by %.f2%% and decreases damage taken by %.f2%%.";
CTRL_KEY = "CTRL key";
CTRL_KEY_TEXT = "CTRL";
CURRENCY = "Currency";
...
OPTION_TOOLTIP_UNIT_NAME_ENEMY_MINUS = "Show minor enemy names in the game world.";
...
STAT_ARMOR = "Armor";
STAT_ARMOR_BASE_TOOLTIP = "Base Armor Damage Reduction: %0.2f%%";
STAT_ARMOR_BONUS_ARMOR_BLADED_ARMOR_TOOLTIP = "Total Armor Damage Reduction: %0.2f%%\nIncreases Attack Power by %d.";
STAT_ARMOR_TOTAL_TOOLTIP = "Total Armor Damage Reduction: %0.2f%%";
