...
function ItemSocketingFrame_OnLoad()
	...
	ItemSocketingScrollFrameScrollBar:SetPoint("TOPLEFT", ItemSocketingScrollFrame, "TOPRIGHT", 7, -23);
	ItemSocketingDescription:SetMinimumWidth(253, 1);
end
...
function ItemSocketingFrame_Update()
	...
	local scrollBarOffset = 23;
	if ( ItemSocketingScrollFrame:GetVerticalScrollRange() ~= 0 ) then
		scrollBarOffset = 0;
	end
	ItemSocketingScrollFrame:SetWidth(269+scrollBarOffset);
	ItemSocketingDescription:SetMinimumWidth(253+scrollBarOffset, 1);
	ItemSocketingScrollFrame:UpdateScrollChildRect();
