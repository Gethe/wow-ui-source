...
BNET_ERROR_50 = "You have used up your prepaid time for this account.\nPlease visit Battle.net Account Management to purchase more time to continue playing.";
...
BNET_ERROR_OTHER = "Battle.net Error: #%d";
...
WOW_ERROR_OTHER = "World of Warcraft Error: #%d";
