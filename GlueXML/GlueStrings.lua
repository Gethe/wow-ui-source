...
CHARACTER_UPGRADE_CHARACTER_LIST_LABEL = "Level 90 Character Boost";
...
CHARACTER_UPGRADE_FLOW_LABEL = "LEVEL 90 CHARACTER BOOST";
CHARACTER_UPGRADE_FREE_CHARACTER_UPGRADE = "LEVEL 90 CHARACTER BOOST";
...
CHARACTER_UPGRADE_TOKEN_DESCRIPTION = "Can be used on one character on your Battle.net account.";
CHARACTER_UPGRADE_TOKEN_TITLE = "Character Boost";
