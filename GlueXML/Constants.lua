...
GLUE_ALLIANCE_COLOR = CreateColor(0.5, 0.5, 0.5);
GLUE_ALLIANCE_BORDER_COLOR = CreateColor(0.09, 0.09, 0.19);
GLUE_HORDE_COLOR = CreateColor(0.5, 0.2, 0.2);
GLUE_HORDE_BORDER_COLOR = CreateColor(0.19, 0.05, 0.05);
