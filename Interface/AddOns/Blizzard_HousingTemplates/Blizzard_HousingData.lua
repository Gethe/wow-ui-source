...
HousingResultToErrorText = {
	...
	[Enum.HousingResult.BlueprintTypeLocationInvalid] = ERR_HOUSING_RESULT_BLUEPRINT_TYPE_LOCATION_INVALID,
	...
	[Enum.HousingResult.GuildMoreAccountsNeeded] = ERR_HOUSING_RESULT_GUILD_MORE_ACCOUNTS_NEEDED,
	...
	[Enum.HousingResult.MaxPlacedDecorReached] = ERR_HOUSING_RESULT_MAX_DECOR_REACHED,
	[Enum.HousingResult.MaxStorageDecorReached] = ERR_HOUSING_RESULT_MAX_STORAGE_DECOR_REACHED,
