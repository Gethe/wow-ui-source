NamePlateConstants =
{
	...
	SHOW_FRIENDLY_REALM_NAME_CVAR = "nameplateShowFriendlyRealmName";
	...
	CAST_BAR_ICON_HEIGHT = 10;
	CAST_BAR_TO_HEALTH_BAR_SPACING = 2;
	HEALTH_BAR_FONT_HEIGHT = 14;
	...
	LARGE_LEVEL_INDICATOR_HEIGHT = 23;
	LEVEL_ICON_HEIGHT = 15;
	LEVEL_ICON_WIDTH = 15;
	LEVEL_INDICATOR_WIDTH = 28;
	LEVEL_FONT_HEIGHT = 10;
	NAME_PLATE_WIDTH = 190;
	SMALL_CAST_BAR_HEIGHT = 6;
	SMALL_HEALTH_BAR_HEIGHT = 13;
	SMALL_LEVEL_INDICATOR_HEIGHT = 16;
