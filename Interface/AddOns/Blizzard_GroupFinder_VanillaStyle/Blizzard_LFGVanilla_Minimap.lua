-- This LUA file implements LFGMinimapMixin for Blizzard_GroupFinder_VanillaStyle
-- Anything in Vanilla and TBC should be using this implementation
...
function LFGMinimapMixin:UpdateVisibility()
	...
	self:SetShown(canUse and LFGVANILLA_SETTING_SHOW_ON_MINIMAP);
end
