...
function PartyFrameMixin:OnLoad()
	...
	CVarCallbackRegistry:RegisterCallback("showPartyPets", self.UpdateSpacingAndLayout, self);
end
...
function PartyFrameMixin:UpdateSpacingAndLayout()
	local showPartyPets = CVarCallbackRegistry:GetCVarValueBool("showPartyPets");
