...
function SplashFrame_EscapePressed()
...
RegisterGameMenuEscHandler(GameMenuEscPriority.AddOn, SplashFrame_EscapePressed);
...
function SplashRightFeatureFrameMixin:SetStartQuestButtonDisplay(screenInfo)
	...
	local showStartButton = self.questID ~= nil and screenInfo.shouldShowQuest and self:ShouldShowQuestButton();
