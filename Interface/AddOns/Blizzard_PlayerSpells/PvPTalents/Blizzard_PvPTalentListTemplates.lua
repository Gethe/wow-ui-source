...
function PvPTalentListMixin:SetTalentFrame(talentFrame)
	...
	self:AddStaticEventMethod(talentFrame, ClassTalentsFrameMixin.Event.OpenPvPTalentList, self.OnOpenPvPTalentList);
	self:AddDynamicEventMethod(talentFrame, ClassTalentsFrameMixin.Event.ClosePvPTalentList, self.OnClosePvPTalentList);
end
...
function PvPTalentListMixin:OnHide()
	...
	if talentFrame then
		talentFrame:TriggerEvent(ClassTalentsFrameMixin.Event.PvPTalentListClosed);
	end
end
...
function PvPTalentListMixin:SelectTalent(talentID)
	...
	talentFrame:TriggerEvent(ClassTalentsFrameMixin.Event.SelectTalentIDForSlot, talentID, slotIndex);
end