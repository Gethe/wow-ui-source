...
function PvPTalentSlotTrayMixin:SetTalentFrame(talentFrame)
	...
	self:AddDynamicEventMethod(talentFrame, ClassTalentsFrameMixin.Event.PvPTalentListClosed, self.OnPvPTalentListClosed);
	self:AddDynamicEventMethod(talentFrame, ClassTalentsFrameMixin.Event.SelectTalentIDForSlot, self.OnSelectTalentIDForSlot);
end
...
function PvPTalentSlotTrayMixin:SelectSlot(slot)
	...
	talentFrame:TriggerEvent(ClassTalentsFrameMixin.Event.OpenPvPTalentList, self.selectedSlotIndex, self.Slots[self.selectedSlotIndex]);
end
...
function PvPTalentSlotTrayMixin:UnselectSlot()
	...
	talentFrame:TriggerEvent(ClassTalentsFrameMixin.Event.ClosePvPTalentList);
end
