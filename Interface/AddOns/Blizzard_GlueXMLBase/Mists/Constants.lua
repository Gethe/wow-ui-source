...
EXPANSION_GLUE_MUSIC = {
	...
	[LE_EXPANSION_MISTS_OF_PANDARIA]		= SOUNDKIT.GS_MISTS,
};
...
GLUE_NEUTRAL_COLOR = CreateColor(0.05, 0.2, 0.05);
GLUE_NEUTRAL_BORDER_COLOR = CreateColor(0.2, 0.5, 0.2);
