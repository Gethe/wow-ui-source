...
function NameChoiceMixin:OnLoad()
	if C_CharacterCreation.AreRegionalUniqueNamesEnabled() then
		...
		local point, parent, relativePoint, sourceX, sourceY = self.EditBoxSurname:GetPoint(1);
		self.EditBox:SetPoint("TOPRIGHT", parent, relativePoint, -sourceX, sourceY);

		point, parent, relativePoint, sourceX, sourceY = self.NameAvailabilityState:GetPoint(1);
...
CharacterCreateEditBoxSurnameMixin = {}
