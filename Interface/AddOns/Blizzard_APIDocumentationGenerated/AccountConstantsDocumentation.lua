	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "LoadAddLicenses", Type = "AccountTransType", EnumValue = 17 },
				{ Name = "ItemCollections", Type = "AccountTransType", EnumValue = 18 },
				{ Name = "AuctionableToken", Type = "AccountTransType", EnumValue = 19 },
				{ Name = "ConsumableToken", Type = "AccountTransType", EnumValue = 20 },
				{ Name = "VasTransaction", Type = "AccountTransType", EnumValue = 21 },
				{ Name = "Productitem", Type = "AccountTransType", EnumValue = 22 },
				{ Name = "TrialBoostHistory", Type = "AccountTransType", EnumValue = 23 },
				{ Name = "TrialBoostHistories", Type = "AccountTransType", EnumValue = 24 },
				{ Name = "QuestCriteria", Type = "AccountTransType", EnumValue = 25 },
				{ Name = "BattlenetAccount", Type = "AccountTransType", EnumValue = 26 },
				{ Name = "AccountCurrencies", Type = "AccountTransType", EnumValue = 27 },
				{ Name = "RafRecruiterAcceptances", Type = "AccountTransType", EnumValue = 28 },
				{ Name = "RafFriendMonth", Type = "AccountTransType", EnumValue = 29 },
				{ Name = "RafReward", Type = "AccountTransType", EnumValue = 30 },
				{ Name = "DynamicCriteria", Type = "AccountTransType", EnumValue = 31 },
				{ Name = "RafActivity", Type = "AccountTransType", EnumValue = 32 },
				{ Name = "CreateOrderInfo", Type = "AccountTransType", EnumValue = 33 },
				{ Name = "ProxyHonorInitialConversion", Type = "AccountTransType", EnumValue = 34 },
				{ Name = "ProxyCreateAccountHonor", Type = "AccountTransType", EnumValue = 35 },
				{ Name = "ProxyValidateAccountHonor", Type = "AccountTransType", EnumValue = 36 },
				{ Name = "ProxyGmSetHonor", Type = "AccountTransType", EnumValue = 37 },
				{ Name = "ProxyGenerateBpayID", Type = "AccountTransType", EnumValue = 38 },
				{ Name = "AccountNotifications", Type = "AccountTransType", EnumValue = 39 },
				{ Name = "PerkItemHold", Type = "AccountTransType", EnumValue = 40 },
				{ Name = "PerkPendingRewards", Type = "AccountTransType", EnumValue = 41 },
				{ Name = "PerkRecentPurchases", Type = "AccountTransType", EnumValue = 42 },
				{ Name = "PerkPastRewards", Type = "AccountTransType", EnumValue = 43 },
				{ Name = "PerkTransaction", Type = "AccountTransType", EnumValue = 44 },
				{ Name = "OutstandingRpc", Type = "AccountTransType", EnumValue = 45 },
				{ Name = "LoadWowlabs", Type = "AccountTransType", EnumValue = 46 },
				{ Name = "UpgradeAccount", Type = "AccountTransType", EnumValue = 47 },
				{ Name = "GetOrderStatusByPurchaseID", Type = "AccountTransType", EnumValue = 48 },
				{ Name = "Items", Type = "AccountTransType", EnumValue = 49 },
				{ Name = "BankTab", Type = "AccountTransType", EnumValue = 50 },
				{ Name = "Factions", Type = "AccountTransType", EnumValue = 51 },
				{ Name = "BitVectors", Type = "AccountTransType", EnumValue = 52 },
				{ Name = "CombinedQuestLog", Type = "AccountTransType", EnumValue = 53 },
				{ Name = "PlayerDataElements", Type = "AccountTransType", EnumValue = 54 },
			},
		},
		{
