	...
	{
		{
			...
			Fields =
			{
				{ Name = "AllowMissingBag", Type = "BankTabFlags", EnumValue = 1 },
			},
		},
		{
			Name = "BankType",
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "WeaponSkillRating", Type = "BonusStatIndex", EnumValue = 11 },
				...
				{ Name = "ManaRegeneration", Type = "BonusStatIndex", EnumValue = 43 },
				{ Name = "ArmorPenetrationRating", Type = "BonusStatIndex", EnumValue = 44 },
				...
				{ Name = "BlockValue", Type = "BonusStatIndex", EnumValue = 48 },
				...
				{ Name = "PhysicalDamageDone", Type = "BonusStatIndex", EnumValue = 83 },
				{ Name = "HolyDamageDone", Type = "BonusStatIndex", EnumValue = 84 },
				{ Name = "FireDamageDone", Type = "BonusStatIndex", EnumValue = 85 },
				{ Name = "NatureDamageDone", Type = "BonusStatIndex", EnumValue = 86 },
				{ Name = "FrostDamageDone", Type = "BonusStatIndex", EnumValue = 87 },
				{ Name = "ShadowDamageDone", Type = "BonusStatIndex", EnumValue = 88 },
				{ Name = "ArcaneDamageDone", Type = "BonusStatIndex", EnumValue = 89 },
				{ Name = "TwohandedAxesSkill", Type = "BonusStatIndex", EnumValue = 90 },
				{ Name = "TwohandedMacesSkill", Type = "BonusStatIndex", EnumValue = 91 },
				{ Name = "TwohandedSwordsSkill", Type = "BonusStatIndex", EnumValue = 92 },
				{ Name = "AxesSkill", Type = "BonusStatIndex", EnumValue = 93 },
				{ Name = "BowsSkill", Type = "BonusStatIndex", EnumValue = 94 },
				{ Name = "CrossbowsSkill", Type = "BonusStatIndex", EnumValue = 95 },
				{ Name = "DaggersSkill", Type = "BonusStatIndex", EnumValue = 96 },
				{ Name = "DualWieldSkill", Type = "BonusStatIndex", EnumValue = 97 },
				{ Name = "FistWeaponsSkill", Type = "BonusStatIndex", EnumValue = 98 },
				{ Name = "GunsSkill", Type = "BonusStatIndex", EnumValue = 99 },
				{ Name = "MacesSkill", Type = "BonusStatIndex", EnumValue = 100 },
				{ Name = "PolearmsSkill", Type = "BonusStatIndex", EnumValue = 101 },
				{ Name = "StavesSkill", Type = "BonusStatIndex", EnumValue = 102 },
				{ Name = "SwordsSkill", Type = "BonusStatIndex", EnumValue = 103 },
				{ Name = "ThrownSkill", Type = "BonusStatIndex", EnumValue = 104 },
				{ Name = "WandsSkill", Type = "BonusStatIndex", EnumValue = 105 },
				{ Name = "AlchemySkill", Type = "BonusStatIndex", EnumValue = 106 },
				{ Name = "BlacksmithingSkill", Type = "BonusStatIndex", EnumValue = 107 },
				{ Name = "EnchantingSkill", Type = "BonusStatIndex", EnumValue = 108 },
				{ Name = "EngineeringSkill", Type = "BonusStatIndex", EnumValue = 109 },
				{ Name = "JewelcraftingSkill", Type = "BonusStatIndex", EnumValue = 110 },
				{ Name = "LeatherworkingSkill", Type = "BonusStatIndex", EnumValue = 111 },
				{ Name = "HerbalismSkill", Type = "BonusStatIndex", EnumValue = 112 },
				{ Name = "MiningSkill", Type = "BonusStatIndex", EnumValue = 113 },
				{ Name = "SkinningSkill", Type = "BonusStatIndex", EnumValue = 114 },
				{ Name = "CookingSkill", Type = "BonusStatIndex", EnumValue = 115 },
				{ Name = "FirstAidSkill", Type = "BonusStatIndex", EnumValue = 116 },
				{ Name = "FishingSkill", Type = "BonusStatIndex", EnumValue = 117 },
				{ Name = "TailoringSkill", Type = "BonusStatIndex", EnumValue = 118 },
				{ Name = "FirePenetration", Type = "BonusStatIndex", EnumValue = 119 },
				{ Name = "NaturePenetration", Type = "BonusStatIndex", EnumValue = 120 },
				{ Name = "FrostPenetration", Type = "BonusStatIndex", EnumValue = 121 },
				{ Name = "ShadowPenetration", Type = "BonusStatIndex", EnumValue = 122 },
				{ Name = "ArcanePenetration", Type = "BonusStatIndex", EnumValue = 123 },
				{ Name = "SpellResistanceAllSchools", Type = "BonusStatIndex", EnumValue = 124 },
				{ Name = "AttackPowerVsHumanoid", Type = "BonusStatIndex", EnumValue = 125 },
				{ Name = "AttackPowerVsElemental", Type = "BonusStatIndex", EnumValue = 126 },
				{ Name = "AttackPowerVsDemon", Type = "BonusStatIndex", EnumValue = 127 },
				{ Name = "AttackPowerVsUndead", Type = "BonusStatIndex", EnumValue = 128 },
				{ Name = "AttackPowerVsDragonkin", Type = "BonusStatIndex", EnumValue = 129 },
				{ Name = "AttackPowerVsGiant", Type = "BonusStatIndex", EnumValue = 130 },
				{ Name = "AttackPowerVsBeast", Type = "BonusStatIndex", EnumValue = 131 },
				{ Name = "AttackPowerVsMechanical", Type = "BonusStatIndex", EnumValue = 132 },
				{ Name = "SpellDamageVsHumanoid", Type = "BonusStatIndex", EnumValue = 133 },
				{ Name = "SpellDamageVsElemental", Type = "BonusStatIndex", EnumValue = 134 },
				{ Name = "SpellDamageVsDemon", Type = "BonusStatIndex", EnumValue = 135 },
				{ Name = "SpellDamageVsUndead", Type = "BonusStatIndex", EnumValue = 136 },
				{ Name = "SpellDamageVsDragonkin", Type = "BonusStatIndex", EnumValue = 137 },
				{ Name = "SpellDamageVsGiant", Type = "BonusStatIndex", EnumValue = 138 },
				{ Name = "SpellDamageVsBeast", Type = "BonusStatIndex", EnumValue = 139 },
				{ Name = "SpellDamageVsMechanical", Type = "BonusStatIndex", EnumValue = 140 },
				{ Name = "Reserved_141", Type = "BonusStatIndex", EnumValue = 141 },
			},
		},
		{
			Name = "InventoryType",
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "Draught", Type = "ItemConsumableSubclass", EnumValue = 13 },
				{ Name = "Device", Type = "ItemConsumableSubclass", EnumValue = 14 },
				{ Name = "ItemenhancementTemporary", Type = "ItemConsumableSubclass", EnumValue = 15 },
			},
		},
		{
			Name = "ItemContainerSubclass",
			Type = "Enumeration",
			NumValues = 12,
			MinValue = 0,
			MaxValue = 11,
			Fields =
			{
				{ Name = "Bag", Type = "ItemContainerSubclass", EnumValue = 0 },
				{ Name = "Soul", Type = "ItemContainerSubclass", EnumValue = 1 },
				{ Name = "Herb", Type = "ItemContainerSubclass", EnumValue = 2 },
				{ Name = "Enchanting", Type = "ItemContainerSubclass", EnumValue = 3 },
				{ Name = "Engineering", Type = "ItemContainerSubclass", EnumValue = 4 },
				{ Name = "Gem", Type = "ItemContainerSubclass", EnumValue = 5 },
				{ Name = "Mining", Type = "ItemContainerSubclass", EnumValue = 6 },
				{ Name = "Leatherworking", Type = "ItemContainerSubclass", EnumValue = 7 },
				{ Name = "Inscription", Type = "ItemContainerSubclass", EnumValue = 8 },
				{ Name = "Tacklebox", Type = "ItemContainerSubclass", EnumValue = 9 },
				{ Name = "Cooking", Type = "ItemContainerSubclass", EnumValue = 10 },
				{ Name = "Reagent", Type = "ItemContainerSubclass", EnumValue = 11 },
			},
		},
		{
		...
		},
		{
			...
			Fields =
			{
				{ Name = "Unknown", Type = "ItemDiscoverySource", EnumValue = -1 },
				{ Name = "ItemCreated", Type = "ItemDiscoverySource", EnumValue = 1 },
				{ Name = "SpellVisualKit", Type = "ItemDiscoverySource", EnumValue = 2 },
				{ Name = "Quest", Type = "ItemDiscoverySource", EnumValue = 3 },
				{ Name = "LootItem", Type = "ItemDiscoverySource", EnumValue = 4 },
				{ Name = "VendorItem", Type = "ItemDiscoverySource", EnumValue = 5 },
				{ Name = "MailItem", Type = "ItemDiscoverySource", EnumValue = 6 },
				{ Name = "GameObjectKey", Type = "ItemDiscoverySource", EnumValue = 7 },
				{ Name = "PlayerCollection", Type = "ItemDiscoverySource", EnumValue = 8 },
				{ Name = "GuildReward", Type = "ItemDiscoverySource", EnumValue = 9 },
				{ Name = "SpellLearned", Type = "ItemDiscoverySource", EnumValue = 10 },
				{ Name = "SpellTrainer", Type = "ItemDiscoverySource", EnumValue = 11 },
				{ Name = "Miscellaneous", Type = "ItemDiscoverySource", EnumValue = 12 },
			},
		},
		{
			Name = "ItemEnchantType",
			Type = "Enumeration",
			NumValues = 4,
			MinValue = 0,
			MaxValue = 3,
			Fields =
			{
				{ Name = "None", Type = "ItemEnchantType", EnumValue = 0 },
				{ Name = "Permanent", Type = "ItemEnchantType", EnumValue = 1 },
				{ Name = "Temporary", Type = "ItemEnchantType", EnumValue = 2 },
				{ Name = "Imbue", Type = "ItemEnchantType", EnumValue = 3 },
			},
		},
		{
			Name = "ItemGemColor",
		...
		},
		{
			...
			Fields =
			{
				{ Name = "ObsoleteQuiver", Type = "ItemQuiverSubclass", EnumValue = 0 },
				{ Name = "ObsoleteBolts", Type = "ItemQuiverSubclass", EnumValue = 1 },
				{ Name = "Quiver", Type = "ItemQuiverSubclass", EnumValue = 2 },
				{ Name = "Ammopouch", Type = "ItemQuiverSubclass", EnumValue = 3 },
			},
		},
		{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "Ranged", Type = "WeaponSlot", EnumValue = 2 },
			},
		},
		{
			Name = "ItemConsts",
			...
			Values =
			{
				...
				{ Name = "MAXIMUM_QUEST_ITEM_LOOT_PRIORITY_VALUES", Type = "number", Value = 16 },
				{ Name = "NUM_RAND_PROP_POINTS_CATEGORIES", Type = "number", Value = 5 },
				{ Name = "NUM_PROFESSION_PROP_POINTS_CATEGORIES", Type = "number", Value = 2 },
				{ Name = "CASTER_WEAPON_DAMAGE_REDUCTION_DIVISOR_WITH_FLAG", Type = "number", Value = 3 },
				{ Name = "CASTER_WEAPON_SPELL_POWER_MULT_WITH_FLAG", Type = "number", Value = 2 },
				{ Name = "CASTER_WEAPON_SPELL_HEALING_MULT_WITH_FLAG", Type = "number", Value = 3.76 },
				{ Name = "CASTER_WEAPON_SPELL_HEALING_DAMAGE_MULT_WITH_FLAG", Type = "number", Value = 1.253 },
			},
		},
		{
