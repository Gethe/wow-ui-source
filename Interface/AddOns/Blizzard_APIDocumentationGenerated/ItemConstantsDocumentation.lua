	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "HitTakenMeleeRatingObsolete", Type = "BonusStatIndex", EnumValue = 22 },
				{ Name = "HitTakenRangedRatingObsolete", Type = "BonusStatIndex", EnumValue = 23 },
				{ Name = "HitTakenSpellRatingObsolete", Type = "BonusStatIndex", EnumValue = 24 },
				{ Name = "CritTakenMeleeRatingObsolete", Type = "BonusStatIndex", EnumValue = 25 },
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "ReagentbankObsolete", Type = "SubcontainerType", EnumValue = 22 },
