	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "EquipSlot", Type = "TooltipDataLineType", EnumValue = 21 },
				{ Name = "ItemName", Type = "TooltipDataLineType", EnumValue = 22 },
				{ Name = "Separator", Type = "TooltipDataLineType", EnumValue = 23 },
				{ Name = "ToyName", Type = "TooltipDataLineType", EnumValue = 24 },
				{ Name = "ToyText", Type = "TooltipDataLineType", EnumValue = 25 },
				{ Name = "ToyEffect", Type = "TooltipDataLineType", EnumValue = 26 },
				{ Name = "ToyDuration", Type = "TooltipDataLineType", EnumValue = 27 },
				{ Name = "ToyDescription", Type = "TooltipDataLineType", EnumValue = 28 },
				{ Name = "ToySource", Type = "TooltipDataLineType", EnumValue = 29 },
				{ Name = "GemSocketEnchantment", Type = "TooltipDataLineType", EnumValue = 30 },
				{ Name = "ItemLevel", Type = "TooltipDataLineType", EnumValue = 31 },
				{ Name = "ItemUpgradeLevel", Type = "TooltipDataLineType", EnumValue = 32 },
				{ Name = "SpellPassive", Type = "TooltipDataLineType", EnumValue = 33 },
				{ Name = "SpellDescription", Type = "TooltipDataLineType", EnumValue = 34 },
				{ Name = "ItemQuality", Type = "TooltipDataLineType", EnumValue = 35 },
				{ Name = "TradeTimeRemaining", Type = "TooltipDataLineType", EnumValue = 36 },
				{ Name = "FlavorText", Type = "TooltipDataLineType", EnumValue = 37 },
				{ Name = "ItemSpellTriggerLearn", Type = "TooltipDataLineType", EnumValue = 38 },
				{ Name = "LearnTransmogSet", Type = "TooltipDataLineType", EnumValue = 39 },
				{ Name = "LearnTransmogIllusion", Type = "TooltipDataLineType", EnumValue = 40 },
		...
		{
			Name = "TooltipDataUsageRequirementType",
			Type = "Enumeration",
			NumValues = 17,
			MinValue = 0,
			MaxValue = 16,
			Fields =
			{
				{ Name = "RaceClass", Type = "TooltipDataUsageRequirementType", EnumValue = 0 },
				{ Name = "Faction", Type = "TooltipDataUsageRequirementType", EnumValue = 1 },
				{ Name = "Skill", Type = "TooltipDataUsageRequirementType", EnumValue = 2 },
				{ Name = "PvPMedal", Type = "TooltipDataUsageRequirementType", EnumValue = 3 },
				{ Name = "Reputation", Type = "TooltipDataUsageRequirementType", EnumValue = 4 },
				{ Name = "Level", Type = "TooltipDataUsageRequirementType", EnumValue = 5 },
				{ Name = "Guild", Type = "TooltipDataUsageRequirementType", EnumValue = 6 },
				{ Name = "Achievement", Type = "TooltipDataUsageRequirementType", EnumValue = 7 },
				{ Name = "PvPRank", Type = "TooltipDataUsageRequirementType", EnumValue = 8 },
				{ Name = "EquippedItem", Type = "TooltipDataUsageRequirementType", EnumValue = 9 },
				{ Name = "ShapeshiftForm", Type = "TooltipDataUsageRequirementType", EnumValue = 10 },
				{ Name = "ArenaRating", Type = "TooltipDataUsageRequirementType", EnumValue = 11 },
				{ Name = "EarnCurrency", Type = "TooltipDataUsageRequirementType", EnumValue = 12 },
				{ Name = "Specialization", Type = "TooltipDataUsageRequirementType", EnumValue = 13 },
				{ Name = "NotAlreadyKnown", Type = "TooltipDataUsageRequirementType", EnumValue = 14 },
				{ Name = "NotInArena", Type = "TooltipDataUsageRequirementType", EnumValue = 15 },
				{ Name = "NotInRatedBg", Type = "TooltipDataUsageRequirementType", EnumValue = 16 },
			},
		},
		{
