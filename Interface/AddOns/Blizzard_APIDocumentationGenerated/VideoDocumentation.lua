	...
	{
		{
			...
			Fields =
			{
				...
				{ Name = "Dx12Win7Unsupported", Type = "GraphicsValidationResult", EnumValue = 29 },
				{ Name = "WineUnsupported", Type = "GraphicsValidationResult", EnumValue = 30 },
				{ Name = "NvapiWineUnsupported", Type = "GraphicsValidationResult", EnumValue = 31 },
				{ Name = "AppleGpuUnsupported", Type = "GraphicsValidationResult", EnumValue = 32 },
				{ Name = "AmdGpuUnsupported", Type = "GraphicsValidationResult", EnumValue = 33 },
				{ Name = "IntelGpuUnsupported", Type = "GraphicsValidationResult", EnumValue = 34 },
				{ Name = "NvidiaGpuUnsupported", Type = "GraphicsValidationResult", EnumValue = 35 },
				{ Name = "QualcommGpuUnsupported", Type = "GraphicsValidationResult", EnumValue = 36 },
				{ Name = "GpuDriver", Type = "GraphicsValidationResult", EnumValue = 37 },
				{ Name = "Unknown", Type = "GraphicsValidationResult", EnumValue = 38 },
			},
		},
		{
