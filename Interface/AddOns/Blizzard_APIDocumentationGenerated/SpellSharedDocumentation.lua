	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "endTime", Type = "number", Nilable = false, Documentation = { "If cooldown is active, time at which the cooldown will end; 0 if no cooldown; Current time if isEnabled is false." } },
