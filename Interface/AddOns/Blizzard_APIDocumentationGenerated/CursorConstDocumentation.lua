	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "UIMoveCursor", Type = "Cursormode", EnumValue = 39 },
				{ Name = "UIResizeCursor", Type = "Cursormode", EnumValue = 40 },
				{ Name = "PointErrorCursor", Type = "Cursormode", EnumValue = 41 },
				{ Name = "CastErrorCursor", Type = "Cursormode", EnumValue = 42 },
				{ Name = "BuyErrorCursor", Type = "Cursormode", EnumValue = 43 },
				{ Name = "AttackErrorCursor", Type = "Cursormode", EnumValue = 44 },
				{ Name = "InteractErrorCursor", Type = "Cursormode", EnumValue = 45 },
				{ Name = "SpeakErrorCursor", Type = "Cursormode", EnumValue = 46 },
				{ Name = "InspectErrorCursor", Type = "Cursormode", EnumValue = 47 },
				{ Name = "PickupErrorCursor", Type = "Cursormode", EnumValue = 48 },
				{ Name = "TaxiErrorCursor", Type = "Cursormode", EnumValue = 49 },
				{ Name = "TrainerErrorCursor", Type = "Cursormode", EnumValue = 50 },
				{ Name = "MineErrorCursor", Type = "Cursormode", EnumValue = 51 },
				{ Name = "SkinErrorCursor", Type = "Cursormode", EnumValue = 52 },
				{ Name = "GatherErrorCursor", Type = "Cursormode", EnumValue = 53 },
				{ Name = "LockErrorCursor", Type = "Cursormode", EnumValue = 54 },
				{ Name = "MailErrorCursor", Type = "Cursormode", EnumValue = 55 },
				{ Name = "LootAllErrorCursor", Type = "Cursormode", EnumValue = 56 },
				{ Name = "RepairErrorCursor", Type = "Cursormode", EnumValue = 57 },
				{ Name = "RepairnpcErrorCursor", Type = "Cursormode", EnumValue = 58 },
				{ Name = "ItemErrorCursor", Type = "Cursormode", EnumValue = 59 },
				{ Name = "SkinHordeErrorCursor", Type = "Cursormode", EnumValue = 60 },
				{ Name = "SkinAllianceErrorCursor", Type = "Cursormode", EnumValue = 61 },
				{ Name = "InnkeeperErrorCursor", Type = "Cursormode", EnumValue = 62 },
				{ Name = "CampaignQuestErrorCursor", Type = "Cursormode", EnumValue = 63 },
				{ Name = "CampaignQuestTurninErrorCursor", Type = "Cursormode", EnumValue = 64 },
				{ Name = "QuestErrorCursor", Type = "Cursormode", EnumValue = 65 },
				{ Name = "QuestRepeatableErrorCursor", Type = "Cursormode", EnumValue = 66 },
				{ Name = "QuestTurninErrorCursor", Type = "Cursormode", EnumValue = 67 },
				{ Name = "QuestLegendaryErrorCursor", Type = "Cursormode", EnumValue = 68 },
				{ Name = "QuestLegendaryTurninErrorCursor", Type = "Cursormode", EnumValue = 69 },
				{ Name = "QuestImportantErrorCursor", Type = "Cursormode", EnumValue = 70 },
				{ Name = "QuestImportantTurninErrorCursor", Type = "Cursormode", EnumValue = 71 },
				{ Name = "QuestMetaErrorCursor", Type = "Cursormode", EnumValue = 72 },
				{ Name = "QuestMetaTurninErrorCursor", Type = "Cursormode", EnumValue = 73 },
				{ Name = "QuestRecurringErrorCursor", Type = "Cursormode", EnumValue = 74 },
				{ Name = "QuestRecurringTurninErrorCursor", Type = "Cursormode", EnumValue = 75 },
				{ Name = "VehicleErrorCursor", Type = "Cursormode", EnumValue = 76 },
				{ Name = "MapPinErrorCursor", Type = "Cursormode", EnumValue = 77 },
				{ Name = "PingErrorCursor", Type = "Cursormode", EnumValue = 78 },
				{ Name = "CustomCursor", Type = "Cursormode", EnumValue = 79 },
			},
		},
		{
			Name = "UICursorType",
