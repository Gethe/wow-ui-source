	...
	Tables =
	{
		...
		},
		{
			...
			Values =
			{
				...
				{ Name = "NUM_PET_SLOTS_DEATHKNIGHT", Type = "number", Value = Constants.PetConsts.MAX_SUMMONABLE_PETS },
				{ Name = "DEATHKNIGHT_PET_CREATURE_ID", Type = "number", Value = 26125 },
				...
				{ Name = "PET_MAX_LEVEL_DIFFERENCE", Type = "number", Value = 5 },
			},
		},
	},
	Predicates =
