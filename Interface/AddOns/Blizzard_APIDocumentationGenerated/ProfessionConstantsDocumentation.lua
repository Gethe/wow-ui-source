	...
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "MaxOrdersReached", Type = "CraftingOrderResult", EnumValue = 25 },
				{ Name = "MissingCraftingTable", Type = "CraftingOrderResult", EnumValue = 26 },
				{ Name = "MissingItem", Type = "CraftingOrderResult", EnumValue = 27 },
				{ Name = "MissingNpc", Type = "CraftingOrderResult", EnumValue = 28 },
				{ Name = "MissingOrder", Type = "CraftingOrderResult", EnumValue = 29 },
				{ Name = "MissingRecraftItem", Type = "CraftingOrderResult", EnumValue = 30 },
				{ Name = "NotClaimed", Type = "CraftingOrderResult", EnumValue = 31 },
				{ Name = "NotCrafted", Type = "CraftingOrderResult", EnumValue = 32 },
				{ Name = "NotInGuild", Type = "CraftingOrderResult", EnumValue = 33 },
				{ Name = "NotYetImplemented", Type = "CraftingOrderResult", EnumValue = 34 },
				{ Name = "OutOfPublicOrderCapacity", Type = "CraftingOrderResult", EnumValue = 35 },
				{ Name = "ServerIsNotAvailable", Type = "CraftingOrderResult", EnumValue = 36 },
				{ Name = "ThrottleViolation", Type = "CraftingOrderResult", EnumValue = 37 },
				{ Name = "TargetCannotCraft", Type = "CraftingOrderResult", EnumValue = 38 },
				{ Name = "Timeout", Type = "CraftingOrderResult", EnumValue = 39 },
				{ Name = "TooManyItems", Type = "CraftingOrderResult", EnumValue = 40 },
				{ Name = "WrongVersion", Type = "CraftingOrderResult", EnumValue = 41 },
			},
		},
		{
