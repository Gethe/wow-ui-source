local ProfessionConstants =
{
	Tables =
	{
		...
		},
		{
			...
			Fields =
			{
				{ Name = "None", Type = "CraftingOrderItemFlags", EnumValue = 0 },
				{ Name = "NpcProvided", Type = "CraftingOrderItemFlags", EnumValue = 1 },
				{ Name = "HasEnchantmentData", Type = "CraftingOrderItemFlags", EnumValue = 2 },
			},
		},
		{
			...
			Fields =
			{
				{ Name = "Item", Type = "CraftingOrderItemType", EnumValue = 0 },
				...
				{ Name = "Deprecated", Type = "CraftingOrderItemType", EnumValue = 4 },
				{ Name = "Currency", Type = "CraftingOrderItemType", EnumValue = 5 },
			},
		},
		{
		...
		},
		{
			...
			Fields =
			{
				...
				{ Name = "MissingCurrency", Type = "CraftingOrderResult", EnumValue = 30 },
				{ Name = "MissingItem", Type = "CraftingOrderResult", EnumValue = 31 },
				{ Name = "MissingNpc", Type = "CraftingOrderResult", EnumValue = 32 },
				{ Name = "MissingOrder", Type = "CraftingOrderResult", EnumValue = 33 },
				{ Name = "MissingRecraftItem", Type = "CraftingOrderResult", EnumValue = 34 },
				{ Name = "NoAccountItems", Type = "CraftingOrderResult", EnumValue = 35 },
				{ Name = "NotClaimed", Type = "CraftingOrderResult", EnumValue = 36 },
				{ Name = "NotCrafted", Type = "CraftingOrderResult", EnumValue = 37 },
				{ Name = "NotInGuild", Type = "CraftingOrderResult", EnumValue = 38 },
				{ Name = "NotYetImplemented", Type = "CraftingOrderResult", EnumValue = 39 },
				{ Name = "OutOfPublicOrderCapacity", Type = "CraftingOrderResult", EnumValue = 40 },
				{ Name = "ServerIsNotAvailable", Type = "CraftingOrderResult", EnumValue = 41 },
				{ Name = "ThrottleViolation", Type = "CraftingOrderResult", EnumValue = 42 },
				{ Name = "TargetCannotCraft", Type = "CraftingOrderResult", EnumValue = 43 },
				{ Name = "TargetLocked", Type = "CraftingOrderResult", EnumValue = 44 },
				{ Name = "Timeout", Type = "CraftingOrderResult", EnumValue = 45 },
				{ Name = "TooManyCurrencies", Type = "CraftingOrderResult", EnumValue = 46 },
				{ Name = "TooManyItems", Type = "CraftingOrderResult", EnumValue = 47 },
				{ Name = "WrongVersion", Type = "CraftingOrderResult", EnumValue = 48 },
			},
		},
		{
		...
		},
		{
			...
			Values =
			{
				...
				{ Name = "CRAFTING_ORDER_CURRENCY_WALLET_ITEM_ID", Type = "number", Value = 262724 },
			},
		},
	},
};
