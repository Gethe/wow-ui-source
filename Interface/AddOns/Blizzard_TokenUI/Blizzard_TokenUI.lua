...
function TokenButtonLinkButton_OnClick(self, button)
	if ( IsModifiedClick("CHATLINK") ) then
		ChatFrameUtil.InsertLink(C_CurrencyInfo.GetCurrencyListLink(self:GetParent().index));
	end
end

function BackpackTokenButton_OnClick(self, button)
	if ( IsModifiedClick("CHATLINK") ) then
		ChatFrameUtil.InsertLink(C_CurrencyInfo.GetCurrencyListLink(self.index));
	end
end
