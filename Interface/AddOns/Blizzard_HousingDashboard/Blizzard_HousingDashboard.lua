local DashboardFrameLifetimeEvents = {
...
local function GetPlayerHouseList()
	return HousingDashboardFrame.playerHouseList;
end

HousingDashboardFrameMixin = {};

function HousingDashboardFrameMixin:OnLoad()
    self:SetTitle(HOUSING_DASHBOARD_FRAMETITLE);

	self:SetPortraitAtlasRaw("housefinder_main-icon");

    FrameUtil.RegisterFrameForEvents(self, DashboardFrameLifetimeEvents);
...
function HousingDashboardFrameMixin:UpdateNoHousesDashboard()
...
function HousingDashboardFrameMixin:LoadHouses()
    self.LoadingSpinner:Show();
	C_Housing.GetPlayerOwnedHouses();
end

function HousingDashboardFrameMixin:OnEvent(event, ...)
...
function HousingDashboardFrameMixin:OnHouseListUpdated(houseInfoList)
...
function HousingDashboardFrameMixin:RefreshHouseDropdown(houseInfoList)
...
function HousingDashboardFrameMixin:OnHouseFinderButtonClicked()
...
function HousingDashboardFrameMixin:OnTutorialButtonClicked()
...
function HousingDashboardContentFrameMixin:Initialize()
...
function HousingDashboardContentFrameMixin:UpdateTabs()
...
function HousingDashboardContentFrameMixin:SetToDefaultAvailableTab()
	if self:IsTabAvailable(self.houseUpgradeTabID) then
		self:SetTab(self.houseUpgradeTabID);
	end
end

function HousingDashboardContentFrameMixin:SetTab(tabID)
	TabSystemOwnerMixin.SetTab(self, tabID);
end

function HousingDashboardContentFrameMixin:IsTabAvailable(tabID)
	return true;
end
...
function InitiativeActiveNeighborhoodSwitcherMixin:OnClick()
	...
	local selectedHouseID = HousingDashboardFrame.selectedHouseID;
