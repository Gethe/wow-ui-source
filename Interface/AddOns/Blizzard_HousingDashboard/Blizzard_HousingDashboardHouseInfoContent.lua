...
function HousingDashboardHouseInfoMixin:OnLoad()
	...
	EventRegistry:RegisterCallback("HouseDropdown.HouseListLoading", self.OnHouseListLoading, self);
	EventRegistry:RegisterCallback("HouseDropdown.HouseListUpdated", self.OnHouseListUpdated, self);
...
function HousingDashboardHouseInfoMixin:OnHouseListLoading(isLoading)
	self.LoadingSpinner:SetShown(isLoading);
end
...
function HousingDashboardHouseInfoMixin:OnHouseSelected(houseInfoID)
