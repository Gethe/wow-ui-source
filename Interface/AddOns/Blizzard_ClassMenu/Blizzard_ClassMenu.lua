...
function ClassMenu.InitClassSpecDropdown(dropdown, getClassFilter, getSpecFilter, setClassAndSpecFilter, excludeAllSpecOption)
	...
	dropdown:SetSelectionText(function(selections)
		...
		local specName = GetSpecializationNameForSpecID(data.specID);
	...
	dropdown:SetupMenu(function(dropdown, rootDescription)
		...
		classSubmenu:CreateRadio(ALL_CLASSES, IsClassSelected, SetSelected, CreateData(UNSPECIFIED_CLASS_FILTER, UNSPECIFIED_SPEC_FILTER));
		...
		for index = 1, GetNumClasses() do
			...
			classSubmenu:CreateRadio(classDisplayName, IsClassSelected, SetSelected, CreateData(classID, UNSPECIFIED_SPEC_FILTER));
		end
