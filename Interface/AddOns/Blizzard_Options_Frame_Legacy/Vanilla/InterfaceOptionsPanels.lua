...
COMBAT_TEXT_FLOAT_MODE = COMBAT_TEXT_FLOAT_MODE or nil;
SHOW_MULTI_ACTIONBAR_1 = SHOW_MULTI_ACTIONBAR_1 or nil;
SHOW_MULTI_ACTIONBAR_2 = SHOW_MULTI_ACTIONBAR_2 or nil;
SHOW_MULTI_ACTIONBAR_3 = SHOW_MULTI_ACTIONBAR_3 or nil;
SHOW_MULTI_ACTIONBAR_4 = SHOW_MULTI_ACTIONBAR_4 or nil;
ALWAYS_SHOW_MULTIBARS = ALWAYS_SHOW_MULTIBARS or nil;
LOCK_ACTIONBAR = LOCK_ACTIONBAR or nil;
...
function InterfaceOptionsColorblindPanelColorFilterDropDown_OnEvent(self, event, ...)
	if ( event == "PLAYER_ENTERING_WORLD" ) then
		...
		local panel = InterfaceOptionsColorblindPanel;
		local qualityIdTable = {2,3,4,5}; -- UNCOMMON, RARE, EPIC, LEGENDARY
		local examples = panel.ColorblindFilterExamples;
