...
function ActionStatusMixin:OnLoad()
	...
	EventRegistry:RegisterCallback("UI.TopLevelParentShown", self.UpdateParent, self);
	EventRegistry:RegisterCallback("UI.TopLevelParentHidden", self.UpdateParent, self);
end
