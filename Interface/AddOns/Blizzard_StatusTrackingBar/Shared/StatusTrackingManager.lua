...
function StatusTrackingManagerMixin:GetExpectedWidth()
	return InputUtil.IsGamepadUIEnabled() and STATUS_BAR_MANAGER_WIDTH_GAMEPAD or STATUS_BAR_MANAGER_WIDTH;
end
...
function StatusTrackingBarContainerMixin:UpdateShownState()
	...
	EventRegistry:TriggerEvent("EditModeManager.UpdateBottomActionBarPositions");
end
