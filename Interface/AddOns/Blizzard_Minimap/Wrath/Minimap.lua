...
function MiniMapInstanceDifficulty_OnEvent(self)
	...
	if ( ( instanceType == "party" or instanceType == "raid" ) and difficulty ~= DIFFICULTY_ID_5PLAYER_DUNGEON_NORMAL ) then --show the banner for all raids/dungeons except 5 person normal dungeon
