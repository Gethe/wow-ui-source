...
function FramePositionDelegate:UIParentManageFramePositions()
	UIPARENT_VARIABLE_OFFSETS["rightActionBarsX"] = VerticalMultiBarsContainer and VerticalMultiBarsContainer:GetWidth() or 0; -- HACK Until the dependencies are sorted out
