...
function WardrobeItemsCollectionMixin:OverrideDefaults()
	self.slots = { "head", "shoulder", "back", "chest", "shirt", "tabard", "wrist", self.defaultSectionSpacing, "hands", "waist", "legs", "feet", self.defaultSectionSpacing, "mainhand", "secondaryhand" };
end
...
function WardrobeCollectionFrameMixin:OpenTransmogLink(link)
	if not DISALLOW_FRAME_TOGGLING and ( not CollectionsJournal:IsVisible() or not self:IsVisible() ) then
