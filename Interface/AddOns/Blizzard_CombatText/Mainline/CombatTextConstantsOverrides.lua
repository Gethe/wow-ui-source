...
CombatTextTypeInfo.PERIODIC_ENERGIZE = { r = 0.1, g = 0.1, b = 1, cvar = "floatingCombatTextPeriodicEnergyGains_v2" };
CombatTextTypeInfo.SPELL_AURA_END = { r = 0.1, g = 1, b = 0.1, cvar = "floatingCombatTextAuras_v2" };
CombatTextTypeInfo.SPELL_AURA_END_HARMFUL = { r = 1, g = 0.1, b = 0.1, cvar = "floatingCombatTextAuras_v2" };
