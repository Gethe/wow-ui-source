...
--for WowLabs
--can't be derived from UnitPopupReportButtonMixin as there is no guid to work with and UnitPopupReportButtonMixin assumes a guid.
UnitPopupGlueReportButtonMixin = CreateFromMixins(UnitPopupButtonBaseMixin);

function UnitPopupGlueReportButtonMixin:GetText()
	return BNET_REPORT;
end
