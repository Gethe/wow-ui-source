...
local function AddTagButtonEntries(entries, battleNetFriendTags)
	for _index, battleNetFriendTag in ipairs(battleNetFriendTags) do
		...
		tagButtonMixin.friendTag = battleNetFriendTag;
...
local function AddInterestsFriendTagButtons(entries)
	...
	AddTagButtonEntries(entries, SocialUIUtil.GetSupportedBattleNetFriendTagInterestsForCurrentGameType());
end

local function AddRolesFriendTagButtons(entries)
	table.insert(entries, UnitPopupBnetFriendTagRolesSubsectionTitleMixin);
	AddTagButtonEntries(entries, SocialUIUtil.GetSupportedBattleNetFriendTagRolesForCurrentGameType());
end
